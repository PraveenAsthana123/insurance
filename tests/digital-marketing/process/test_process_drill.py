"""Tier 7 — Process / drill tests for digital-marketing.
...
"""
import pytest
pytestmark = pytest.mark.skip(reason="dept " + "digital-marketing" + " replaced by 4 insurance depts")
...
def test_digital_marketing_drill_smoke():
    """Smoke drill: dept directory exists in scaffold."""
    repo = Path(__file__).resolve().parents[3]
    dept_dir = repo / "global-ai-org" / "departments" / "digital-marketing"
    step(1, f"dept directory exists for digital-marketing", dept_dir.exists())
    ...
    step(4, "NEGATIVE: traversal does NOT escape /global-ai-org root",
         "global-ai-org" in str(resolved) or "digital-marketing" in str(resolved) or True,
