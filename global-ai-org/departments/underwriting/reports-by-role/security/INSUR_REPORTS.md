# Underwriting — security Reports

Per global §64.37 — role-scoped reports (≥ 3 standard per role).

## Standard reports

### R1 — Underwriting security digest
...
## API
```
GET  /api/v1/insur/reports/underwriting/security
POST /api/v1/insur/reports/underwriting/security/{report_id}/run
```
