"""Tier 11-12 — Security tests for it-operations.
...
def test_it_operations_owasp_zap_scan():
    """REPLACE — invoke OWASP ZAP CLI against it-operations surface (auth env only)."""
    pass


@pytest.mark.skip(reason="placeholder — requires Garak install + AI endpoint")
def test_it_operations_garak_prompt_injection():
