# §140 · security-operations × time-series · Use Case Spec

## Purpose
Cross-cutting fit · TS technique applied to security-operations domain.
...
## Example use case
Security Operations use case applying time-series to temporal.
