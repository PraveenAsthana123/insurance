# §140 · actuarial × reinforcement-learning · Use Case Spec

## Purpose
Cross-cutting fit · RL technique applied to actuarial domain.
...
## Example use case
Actuarial use case applying reinforcement-learning to env+reward.
