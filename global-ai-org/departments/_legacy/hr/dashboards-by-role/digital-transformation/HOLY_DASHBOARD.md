# HOLY Beverage — Hr — Digital Transformation Dashboard

> Per global CLAUDE.md §64.37 — every (dept, role) pair MUST have a
> role-scoped dashboard. This is the dashboard for **digital-transformation** in **hr**.

## Persona

The **digital-transformation** at Hr. They use this dashboard
...
returned by backend `GET /api/v1/holy/dashboards/hr/digital-transformation/charts/<chart_id>`.
...
```
GET /api/v1/holy/dashboards/hr/digital-transformation
  → {tiles: [...], charts: [...], filters: {...}, refreshed_at}

GET /api/v1/holy/dashboards/hr/digital-transformation/charts/<chart_id>
...
- Frontend route: `/holy/hr/dashboard?role=digital-transformation`
