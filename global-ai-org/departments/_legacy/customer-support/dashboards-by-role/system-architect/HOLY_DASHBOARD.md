# HOLY Beverage — Customer Support — System Architect Dashboard

> Per global CLAUDE.md §64.37 — every (dept, role) pair MUST have a
> role-scoped dashboard. This is the dashboard for **system-architect** in **customer-support**.

## Persona

The **system-architect** at Customer Support. They use this dashboard
...
returned by backend `GET /api/v1/holy/dashboards/customer-support/system-architect/charts/<chart_id>`.
...
```
GET /api/v1/holy/dashboards/customer-support/system-architect
  → {tiles: [...], charts: [...], filters: {...}, refreshed_at}

GET /api/v1/holy/dashboards/customer-support/system-architect/charts/<chart_id>
...
- Frontend route: `/holy/customer-support/dashboard?role=system-architect`
