# HOLY Beverage — Legal — Anomaly Detection
...
## Anomaly catalog (top 20 per legal)

| # | Anomaly type | Severity | Tier | Auto-action | Backing data |
|---|---|---|---|---|---|
| 1 | _stub: anomaly for legal_ | high | tier 2 | alert + auto-investigate | contracts + matters + e-discovery |
