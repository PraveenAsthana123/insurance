# Tree-of-Thought AI · Comprehensive README · §137

**Effective**: 2026-06-11 · **Slug**: `tree-of-thought-ai` · **Kind**: `agent_engine`
...
**Business goal**: Reduce manual effort + improve accuracy for tree-of-thought ai tasks in
...
**FR-1**: System MUST accept input matching `tree-of-thought-ai` schema
...
Caller (frontend/agent)
        │
        ▼
  /api/v1/ai-types/tree-of-thought-ai/predict
        │
        ▼
...
- `predictions_tree-of-thought-ai`: id · input_jsonb · output · confidence · timestamp

**Endpoints**:
- `POST /api/v1/ai-types/tree-of-thought-ai/predict` · body: features → prediction
- `GET /api/v1/ai-types/tree-of-thought-ai/metrics` → live metrics.json
- `GET /api/v1/ai-types/tree-of-thought-ai/explain/{prediction_id}` → SHAP
...
```
[router.py] → [model_loader.py] → [/models/tree-of-thought-ai/model.joblib]
            ↘ [preprocessor.py]
...
- collection: `tree-of-thought-ai_embeddings`
...
**Fairness metrics** (from data/fairness/tree-of-thought-ai.json):
