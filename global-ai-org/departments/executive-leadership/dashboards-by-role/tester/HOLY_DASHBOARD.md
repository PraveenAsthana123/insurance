# HOLY Beverage — Executive Leadership — Tester Dashboard

> Per global CLAUDE.md §64.37 — every (dept, role) pair MUST have a
> role-scoped dashboard. This is the dashboard for **tester** in **executive-leadership**.

## Persona

The **tester** at Executive Leadership. They use this dashboard
...
returned by backend `GET /api/v1/holy/dashboards/executive-leadership/tester/charts/<chart_id>`.
...
```
GET /api/v1/holy/dashboards/executive-leadership/tester
  → {tiles: [...], charts: [...], filters: {...}, refreshed_at}

GET /api/v1/holy/dashboards/executive-leadership/tester/charts/<chart_id>
...
- Frontend route: `/holy/executive-leadership/dashboard?role=tester`
