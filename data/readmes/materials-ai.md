# Materials AI · Comprehensive README · §137

**Effective**: 2026-06-11 · **Slug**: `materials-ai` · **Kind**: `spec_only`
...
**Business goal**: Reduce manual effort + improve accuracy for materials ai tasks in
...
**FR-1**: System MUST accept input matching `materials-ai` schema
...
Caller (frontend/agent)
        │
        ▼
  /api/v1/ai-types/materials-ai/predict
        │
        ▼
...
- `predictions_materials-ai`: id · input_jsonb · output · confidence · timestamp

**Endpoints**:
- `POST /api/v1/ai-types/materials-ai/predict` · body: features → prediction
- `GET /api/v1/ai-types/materials-ai/metrics` → live metrics.json
- `GET /api/v1/ai-types/materials-ai/explain/{prediction_id}` → SHAP
...
```
[router.py] → [model_loader.py] → [/models/materials-ai/model.joblib]
            ↘ [preprocessor.py]
...
- collection: `materials-ai_embeddings`
...
**Fairness metrics** (from data/fairness/materials-ai.json):
