# HOLY Beverage — Marketing — Contact Management (customer + vendor + internal)
...
- Sync: scheduled inbound from marketing's CRM / ERP / HRIS
...
|---|---|---|
| GET /api/v1/holy/contacts/marketing/customers | list | manager / data-owner |
| GET /api/v1/holy/contacts/marketing/vendors | list | manager / procurement |
| GET /api/v1/holy/contacts/marketing/internal | list | any dept role |
| POST /api/v1/holy/contacts/marketing/customers | create | admin / manager |
| PUT /api/v1/holy/contacts/marketing/customers/{id} | update | admin / data-owner |
| DELETE /api/v1/holy/contacts/marketing/customers/{id} | soft-delete | admin |
