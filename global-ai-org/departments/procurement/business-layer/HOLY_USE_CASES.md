# HOLY Beverage — Procurement — AI Use-Case Catalog
...
> use cases for **procurement**. Implementation status tracked per current
> codebase state.
...
|---|---|---|
| ✅ Implemented | **17** of 31 | Working module exists in `backend/ml/reference/*.py` (drill-locked) |
| 🟡 Partial | **9** of 31 | Existing module applies; dept-specific stub deferred |
| ❌ Not yet | **5** of 31 | Backlogged — needs new module or external integration |
...
## 2. Procurement-Specific Use Cases

| Use Case | Category | Data Types | AI Area | Business Value | Status |
|---|---|---|---|---|---|
| Vendor Risk Intelligence | Procurement | vendor data | Risk AI | Less procurement risk | 🟡 full_lifecycle.py classification + simulation |
| Invoice Processing AI | Procurement | invoice PDF/image | OCR + NLP | Faster AP | ✅ simulation_engine REFERENCE_PROCESSES[procurement,invoice_matching] |
| Procurement Forecasting | Procurement | spend | Forecasting | Better budget | ✅ timeseries_lifecycle.py |
| Supplier Recommendation AI | Procurement | vendor performance | Recommendation | Better sourcing | ✅ recommendation_lifecycle.py applies |
