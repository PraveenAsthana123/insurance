# HOLY Beverage — Hr — System Architect Dashboard

> Per global CLAUDE.md §64.37 — every (dept, role) pair MUST have a
> role-scoped dashboard. This is the dashboard for **system-architect** in **hr**.

## Persona

The **system-architect** at Hr. They use this dashboard
...
returned by backend `GET /api/v1/holy/dashboards/hr/system-architect/charts/<chart_id>`.
...
```
GET /api/v1/holy/dashboards/hr/system-architect
  → {tiles: [...], charts: [...], filters: {...}, refreshed_at}

GET /api/v1/holy/dashboards/hr/system-architect/charts/<chart_id>
...
- Frontend route: `/holy/hr/dashboard?role=system-architect`
