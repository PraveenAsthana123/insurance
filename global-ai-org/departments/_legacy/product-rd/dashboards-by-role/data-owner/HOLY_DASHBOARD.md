# HOLY Beverage — Product Rd — Data Owner Dashboard

> Per global CLAUDE.md §64.37 — every (dept, role) pair MUST have a
> role-scoped dashboard. This is the dashboard for **data-owner** in **product-rd**.

## Persona

The **data-owner** at Product Rd. They use this dashboard
...
returned by backend `GET /api/v1/holy/dashboards/product-rd/data-owner/charts/<chart_id>`.
...
```
GET /api/v1/holy/dashboards/product-rd/data-owner
  → {tiles: [...], charts: [...], filters: {...}, refreshed_at}

GET /api/v1/holy/dashboards/product-rd/data-owner/charts/<chart_id>
...
- Frontend route: `/holy/product-rd/dashboard?role=data-owner`
