# Underwriting — manager Reports

Per global §64.37 — role-scoped reports (≥ 3 standard per role).

## Standard reports

### R1 — Underwriting manager digest
...
## API
```
GET  /api/v1/insur/reports/underwriting/manager
POST /api/v1/insur/reports/underwriting/manager/{report_id}/run
```
