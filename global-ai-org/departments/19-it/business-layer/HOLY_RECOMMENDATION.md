# HOLY_RECOMMENDATION.md · Dept 19 · it
...
Recommendation system for Dept 19 (it). All 3 classical flavors covered per §64.22.

## Item-based (collaborative filter)

**Algorithm**: Skill-based collaborative + alert MAB
...
**Algorithm**: Runbook embedding (procedure + symptom)
...
**Algorithm**: RAG over runbooks · per §79 production-grade
