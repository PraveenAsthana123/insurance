...
> Department 1 · Product Management Department · slug `market-research` · AI items: 6
...
- **One-liner**: TODO
- **Demo URL**: `http://192.168.1.88:3210/insurance/1/<domain>/market-research?tab=user-demo`
- **Recording**: TODO
...
Simulation URL: `http://192.168.1.88:3210/insurance/1/<domain>/market-research?tab=simulation`
...
Release summary: auto-gen `docs/processes/product-management-department/market-research/release-summary-vX.Y.md` covering §1 problem · §4 impact deltas · §10 phase scorecard · §11 test pass/fail · top 3 failure modes · sign-off · git SHA + image digest.
...
Gold set: `data/eval/product-management-department/market-research/gold_set.jsonl` (100-500 queries · stratified · monthly refresh).
...
→ Tab: `?tab=resai` · evidence files: `data/eval/product-management-department/market-research/resai/`
...
→ Tab: `?tab=expai` · artifacts: `data/eval/product-management-department/market-research/expai/`
...
→ Tab: `?tab=analysis` · evidence: `data/eval/product-management-department/market-research/stats/`
