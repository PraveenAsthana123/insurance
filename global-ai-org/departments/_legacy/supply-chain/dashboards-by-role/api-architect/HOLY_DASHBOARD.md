# HOLY Beverage — Supply Chain — Api Architect Dashboard

> Per global CLAUDE.md §64.37 — every (dept, role) pair MUST have a
> role-scoped dashboard. This is the dashboard for **api-architect** in **supply-chain**.

## Persona

The **api-architect** at Supply Chain. They use this dashboard
...
returned by backend `GET /api/v1/holy/dashboards/supply-chain/api-architect/charts/<chart_id>`.
...
```
GET /api/v1/holy/dashboards/supply-chain/api-architect
  → {tiles: [...], charts: [...], filters: {...}, refreshed_at}

GET /api/v1/holy/dashboards/supply-chain/api-architect/charts/<chart_id>
...
- Frontend route: `/holy/supply-chain/dashboard?role=api-architect`
