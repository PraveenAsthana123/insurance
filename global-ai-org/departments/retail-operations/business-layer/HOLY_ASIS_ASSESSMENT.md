# HOLY Beverage — Retail Operations — AS-IS Process Assessment
...
This document is the **input to the AI strategy planning** for Retail Operations.
...
|---|---|---|---|---|---|---|---|---|
| 1 | Manual planogram audit | 12 hrs/wk | High | $200K/yr | Field-ops overload | Quarterly only | Stale layouts | Photo + checklist |
| 2 | Reactive footfall analysis | 8 hrs/wk | Med | $80K/yr | Manager intuition | Lagging | Missed traffic patterns | Door counter only |
| 3 | Manual stockout detection | 16 hrs/wk | High | $500K/yr | Associate workload | End-of-day catch | −20% availability | Visual check |
| 4 | Paper-based promo execution | 6 hrs/wk | Med | $100K/yr | Compliance variance | Inconsistent | Lost promo lift | Paper signs |
| 5 | Manual shrink investigation | 10 hrs/wk | High | $300K/yr | LP overload | Reactive | Missed events | CCTV review |
...
4. **Measure** via the persona's main KPI: Revenue per square foot, shrink rate, customer satisfaction
