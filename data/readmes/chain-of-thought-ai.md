# Chain-of-Thought AI · Comprehensive README · §137

**Effective**: 2026-06-11 · **Slug**: `chain-of-thought-ai` · **Kind**: `agent_engine`
**Accuracy**: 0.9283 · **Algorithm**: GradientBoostingClassifier (per-type baseline)

---

## 1. BRD · Business Requirements Document

**Business goal**: Reduce manual effort + improve accuracy for chain-of-thought ai tasks in
...
**FR-1**: System MUST accept input matching `chain-of-thought-ai` schema
...
Caller (frontend/agent)
        │
        ▼
  /api/v1/ai-types/chain-of-thought-ai/predict
        │
        ▼
...
- `predictions_chain-of-thought-ai`: id · input_jsonb · output · confidence · timestamp

**Endpoints**:
- `POST /api/v1/ai-types/chain-of-thought-ai/predict` · body: features → prediction
- `GET /api/v1/ai-types/chain-of-thought-ai/metrics` → live metrics.json
- `GET /api/v1/ai-types/chain-of-thought-ai/explain/{prediction_id}` → SHAP
...
```
[router.py] → [model_loader.py] → [/models/chain-of-thought-ai/model.joblib]
            ↘ [preprocessor.py]
...
- collection: `chain-of-thought-ai_embeddings`
...
**Fairness metrics** (from data/fairness/chain-of-thought-ai.json):
