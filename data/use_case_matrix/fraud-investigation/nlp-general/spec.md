# §140 · fraud-investigation × nlp-general · Use Case Spec

## Purpose
PRIMARY fit · NLP technique applied to fraud-investigation domain.
...
## Example use case
Fraud Investigation use case applying nlp-general to text.
