# HOLY Beverage — Sales — Digital Transformation Dashboard

> Per global CLAUDE.md §64.37 — every (dept, role) pair MUST have a
> role-scoped dashboard. This is the dashboard for **digital-transformation** in **sales**.

## Persona

The **digital-transformation** at Sales. They use this dashboard
...
returned by backend `GET /api/v1/holy/dashboards/sales/digital-transformation/charts/<chart_id>`.
...
```
GET /api/v1/holy/dashboards/sales/digital-transformation
  → {tiles: [...], charts: [...], filters: {...}, refreshed_at}

GET /api/v1/holy/dashboards/sales/digital-transformation/charts/<chart_id>
...
- Frontend route: `/holy/sales/dashboard?role=digital-transformation`
