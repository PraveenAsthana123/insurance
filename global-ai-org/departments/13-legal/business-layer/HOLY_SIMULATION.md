# HOLY_SIMULATION.md · Dept 13 · Legal
...
## Backend API
- `POST /api/v1/holy/sim/legal/{process}/run`
- `GET /api/v1/holy/sim/legal/{process}/runs/{sim_id}/events` (SSE)
- `GET /api/v1/holy/sim/legal/{process}/runs/{sim_id}/manifest`
- `GET /api/v1/holy/sim/legal/{process}/runs/{sim_id}/replay`
