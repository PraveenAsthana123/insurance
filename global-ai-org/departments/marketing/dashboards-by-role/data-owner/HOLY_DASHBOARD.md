# HOLY Beverage — Marketing — Data Owner Dashboard

> Per global CLAUDE.md §64.37 — every (dept, role) pair MUST have a
> role-scoped dashboard. This is the dashboard for **data-owner** in **marketing**.

## Persona

The **data-owner** at Marketing. They use this dashboard
...
returned by backend `GET /api/v1/holy/dashboards/marketing/data-owner/charts/<chart_id>`.
...
```
GET /api/v1/holy/dashboards/marketing/data-owner
  → {tiles: [...], charts: [...], filters: {...}, refreshed_at}

GET /api/v1/holy/dashboards/marketing/data-owner/charts/<chart_id>
...
- Frontend route: `/holy/marketing/dashboard?role=data-owner`
