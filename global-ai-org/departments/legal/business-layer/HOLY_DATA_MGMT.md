# HOLY Beverage — Legal — Input Data Mgmt + Before/After Viz
...
For every process AND sub-process in this dept (legal), populate the 6
surfaces below. contracts + matters + e-discovery is the primary data class for legal.
...
Plots land in: `data/eval/legal/<pipeline>/<run_id>/plots/before_*.png`
...
Plots land in: `data/eval/legal/<pipeline>/<run_id>/plots/after_*.png`
