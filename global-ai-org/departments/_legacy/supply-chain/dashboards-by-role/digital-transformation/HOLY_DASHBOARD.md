# HOLY Beverage — Supply Chain — Digital Transformation Dashboard

> Per global CLAUDE.md §64.37 — every (dept, role) pair MUST have a
> role-scoped dashboard. This is the dashboard for **digital-transformation** in **supply-chain**.

## Persona

The **digital-transformation** at Supply Chain. They use this dashboard
...
returned by backend `GET /api/v1/holy/dashboards/supply-chain/digital-transformation/charts/<chart_id>`.
...
```
GET /api/v1/holy/dashboards/supply-chain/digital-transformation
  → {tiles: [...], charts: [...], filters: {...}, refreshed_at}

GET /api/v1/holy/dashboards/supply-chain/digital-transformation/charts/<chart_id>
...
- Frontend route: `/holy/supply-chain/dashboard?role=digital-transformation`
