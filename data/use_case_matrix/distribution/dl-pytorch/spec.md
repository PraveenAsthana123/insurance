# §140 · distribution × dl-pytorch · Use Case Spec

## Purpose
Cross-cutting fit · DL technique applied to distribution domain.
...
## Example use case
Distribution use case applying dl-pytorch to tabular/imgs.
