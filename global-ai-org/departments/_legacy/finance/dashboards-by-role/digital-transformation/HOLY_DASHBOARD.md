# HOLY Beverage — Finance — Digital Transformation Dashboard

> Per global CLAUDE.md §64.37 — every (dept, role) pair MUST have a
> role-scoped dashboard. This is the dashboard for **digital-transformation** in **finance**.

## Persona

The **digital-transformation** at Finance. They use this dashboard
...
returned by backend `GET /api/v1/holy/dashboards/finance/digital-transformation/charts/<chart_id>`.
...
```
GET /api/v1/holy/dashboards/finance/digital-transformation
  → {tiles: [...], charts: [...], filters: {...}, refreshed_at}

GET /api/v1/holy/dashboards/finance/digital-transformation/charts/<chart_id>
...
- Frontend route: `/holy/finance/dashboard?role=digital-transformation`
