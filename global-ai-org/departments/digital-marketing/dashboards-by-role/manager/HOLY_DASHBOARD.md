# HOLY Beverage — Digital Marketing — Manager Dashboard

> Per global CLAUDE.md §64.37 — every (dept, role) pair MUST have a
> role-scoped dashboard. This is the dashboard for **manager** in **digital-marketing**.

## Persona

The **manager** at Digital Marketing. They use this dashboard
...
returned by backend `GET /api/v1/holy/dashboards/digital-marketing/manager/charts/<chart_id>`.
...
```
GET /api/v1/holy/dashboards/digital-marketing/manager
  → {tiles: [...], charts: [...], filters: {...}, refreshed_at}

GET /api/v1/holy/dashboards/digital-marketing/manager/charts/<chart_id>
...
- Frontend route: `/holy/digital-marketing/dashboard?role=manager`
