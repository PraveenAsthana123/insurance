# HOLY Beverage — Customer Support — Devops Dashboard

> Per global CLAUDE.md §64.37 — every (dept, role) pair MUST have a
> role-scoped dashboard. This is the dashboard for **devops** in **customer-support**.

## Persona

The **devops** at Customer Support. They use this dashboard
...
returned by backend `GET /api/v1/holy/dashboards/customer-support/devops/charts/<chart_id>`.
...
```
GET /api/v1/holy/dashboards/customer-support/devops
  → {tiles: [...], charts: [...], filters: {...}, refreshed_at}

GET /api/v1/holy/dashboards/customer-support/devops/charts/<chart_id>
...
- Frontend route: `/holy/customer-support/dashboard?role=devops`
