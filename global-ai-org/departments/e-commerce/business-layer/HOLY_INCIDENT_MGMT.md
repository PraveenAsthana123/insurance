# HOLY Beverage — E Commerce — Incident Management (L1/L2/L3 + RAG)
...
|---|---|---|---|---|
| 1 | _stub: replace with real L1 issue for e-commerce_ | runbook URL | < 1 min | < 5 min |
...
- RAG corpus: `data/e-commerce/runbooks/` + `data/e-commerce/past-incidents/`
