# HOLY Beverage — Customer Experience — Contact Management (customer + vendor + internal)
...
- Sync: scheduled inbound from customer-experience's CRM / ERP / HRIS
...
|---|---|---|
| GET /api/v1/holy/contacts/customer-experience/customers | list | manager / data-owner |
| GET /api/v1/holy/contacts/customer-experience/vendors | list | manager / procurement |
| GET /api/v1/holy/contacts/customer-experience/internal | list | any dept role |
| POST /api/v1/holy/contacts/customer-experience/customers | create | admin / manager |
| PUT /api/v1/holy/contacts/customer-experience/customers/{id} | update | admin / data-owner |
| DELETE /api/v1/holy/contacts/customer-experience/customers/{id} | soft-delete | admin |
