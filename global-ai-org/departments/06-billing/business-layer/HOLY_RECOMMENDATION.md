# HOLY_RECOMMENDATION.md · Dept 6 · billing
...
Recommendation system for Dept 6 (billing). All 3 classical flavors covered per §64.22.

## Item-based (collaborative filter)

**Algorithm**: Session-aware sequence model (payment flow LSTM)
...
**Algorithm**: Payment-method attribute match + bank profile embed
...
**Algorithm**: Hybrid · multi-armed bandit (Thompson) over CF + content
