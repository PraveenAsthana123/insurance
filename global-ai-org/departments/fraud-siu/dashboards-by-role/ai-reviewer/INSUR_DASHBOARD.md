# Fraud / Special Investigations Unit (SIU) — ai-reviewer Dashboard

Per global §64.37 — role-scoped dashboard.

## Persona
**ai-reviewer** in Fraud / Special Investigations Unit (SIU).

## Focus
Model accuracy drift, fairness, override rate
...
## API
```
GET /api/v1/insur/dashboards/fraud-siu/ai-reviewer
```
