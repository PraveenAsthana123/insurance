# HOLY Beverage — Customer Support — Digital Transformation Dashboard

> Per global CLAUDE.md §64.37 — every (dept, role) pair MUST have a
> role-scoped dashboard. This is the dashboard for **digital-transformation** in **customer-support**.

## Persona

The **digital-transformation** at Customer Support. They use this dashboard
...
returned by backend `GET /api/v1/holy/dashboards/customer-support/digital-transformation/charts/<chart_id>`.
...
```
GET /api/v1/holy/dashboards/customer-support/digital-transformation
  → {tiles: [...], charts: [...], filters: {...}, refreshed_at}

GET /api/v1/holy/dashboards/customer-support/digital-transformation/charts/<chart_id>
...
- Frontend route: `/holy/customer-support/dashboard?role=digital-transformation`
