# HOLY Beverage — Engineering — Master Data

> Per operator 2026-05-24 — every dept publishes its master + reference
> data here. Focus: **service-catalog + dependency-graph + on-call-roster**.
...
This dept (**engineering**) operates against the slice of the structure
...
| Endpoint | Returns |
|---|---|
| `GET /api/v1/holy/master-data/engineering` | Schema catalog + per-entity owner |
| `GET /api/v1/holy/master-data/engineering/customer?limit=20` | Customer master sample |
| `GET /api/v1/holy/master-data/engineering/vendor?limit=20` | Vendor master sample |
| `GET /api/v1/holy/master-data/engineering/product?limit=20` | Product master sample |
| `GET /api/v1/holy/master-data/engineering/org-structure` | Org tree slice for this dept |
...
1. (+) `/api/v1/holy/master-data/engineering` returns 200 + entity catalog
