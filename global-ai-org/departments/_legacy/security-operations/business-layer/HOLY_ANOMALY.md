# HOLY Beverage — Security Operations — Anomaly Detection
...
## Anomaly catalog (top 20 per security-operations)

| # | Anomaly type | Severity | Tier | Auto-action | Backing data |
|---|---|---|---|---|---|
| 1 | _stub: anomaly for security-operations_ | high | tier 2 | alert + auto-investigate | SIEM + EDR + IAM + threat intel |
