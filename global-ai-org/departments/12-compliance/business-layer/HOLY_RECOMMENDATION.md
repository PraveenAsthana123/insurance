# HOLY_RECOMMENDATION.md · Dept 12 · compliance
...
Recommendation system for Dept 12 (compliance). All 3 classical flavors covered per §64.22.
...
**Algorithm**: Regulation embedding (E5/BGE) + cross-encoder rerank
...
**Algorithm**: Cross-encoder rerank · jurisdiction + topic blend
