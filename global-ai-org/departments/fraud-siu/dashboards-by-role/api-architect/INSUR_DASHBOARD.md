# Fraud / Special Investigations Unit (SIU) — api-architect Dashboard

Per global §64.37 — role-scoped dashboard.

## Persona
**api-architect** in Fraud / Special Investigations Unit (SIU).

## Focus
API latency p95, error rate, version adoption
...
## API
```
GET /api/v1/insur/dashboards/fraud-siu/api-architect
```
