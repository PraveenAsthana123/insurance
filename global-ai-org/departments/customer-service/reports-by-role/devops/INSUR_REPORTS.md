# Customer Service / Contact Center — devops Reports

Per global §64.37 — role-scoped reports (≥ 3 standard per role).

## Standard reports

### R1 — Customer Service / Contact Center devops digest
...
## API
```
GET  /api/v1/insur/reports/customer-service/devops
POST /api/v1/insur/reports/customer-service/devops/{report_id}/run
```
