# Fraud / Special Investigations Unit (SIU) — database-architect Dashboard

Per global §64.37 — role-scoped dashboard.

## Persona
**database-architect** in Fraud / Special Investigations Unit (SIU).
...
## API
```
GET /api/v1/insur/dashboards/fraud-siu/database-architect
```
