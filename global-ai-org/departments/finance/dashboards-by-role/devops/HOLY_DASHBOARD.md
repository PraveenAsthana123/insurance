# HOLY Beverage — Finance — Devops Dashboard

> Per global CLAUDE.md §64.37 — every (dept, role) pair MUST have a
> role-scoped dashboard. This is the dashboard for **devops** in **finance**.

## Persona

The **devops** at Finance. They use this dashboard
...
returned by backend `GET /api/v1/holy/dashboards/finance/devops/charts/<chart_id>`.
...
```
GET /api/v1/holy/dashboards/finance/devops
  → {tiles: [...], charts: [...], filters: {...}, refreshed_at}

GET /api/v1/holy/dashboards/finance/devops/charts/<chart_id>
...
- Frontend route: `/holy/finance/dashboard?role=devops`
