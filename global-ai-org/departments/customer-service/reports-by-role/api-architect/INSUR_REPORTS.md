# Customer Service / Contact Center — api-architect Reports

Per global §64.37 — role-scoped reports (≥ 3 standard per role).

## Standard reports

### R1 — Customer Service / Contact Center api-architect digest
...
## API
```
GET  /api/v1/insur/reports/customer-service/api-architect
POST /api/v1/insur/reports/customer-service/api-architect/{report_id}/run
```
