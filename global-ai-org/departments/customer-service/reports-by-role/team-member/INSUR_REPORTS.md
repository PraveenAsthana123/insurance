# Customer Service / Contact Center — team-member Reports

Per global §64.37 — role-scoped reports (≥ 3 standard per role).

## Standard reports

### R1 — Customer Service / Contact Center team-member digest
...
## API
```
GET  /api/v1/insur/reports/customer-service/team-member
POST /api/v1/insur/reports/customer-service/team-member/{report_id}/run
```
