# HOLY Beverage — Hr — Input Data Mgmt + Before/After Viz
...
For every process AND sub-process in this dept (hr), populate the 6
surfaces below. HRIS + ATS + surveys is the primary data class for hr.
...
Plots land in: `data/eval/hr/<pipeline>/<run_id>/plots/before_*.png`
...
Plots land in: `data/eval/hr/<pipeline>/<run_id>/plots/after_*.png`
