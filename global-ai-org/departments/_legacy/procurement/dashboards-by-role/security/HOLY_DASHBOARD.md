# HOLY Beverage — Procurement — Security Dashboard

> Per global CLAUDE.md §64.37 — every (dept, role) pair MUST have a
> role-scoped dashboard. This is the dashboard for **security** in **procurement**.

## Persona

The **security** at Procurement. They use this dashboard
...
returned by backend `GET /api/v1/holy/dashboards/procurement/security/charts/<chart_id>`.
...
```
GET /api/v1/holy/dashboards/procurement/security
  → {tiles: [...], charts: [...], filters: {...}, refreshed_at}

GET /api/v1/holy/dashboards/procurement/security/charts/<chart_id>
...
- Frontend route: `/holy/procurement/dashboard?role=security`
