# HOLY Beverage — Sales — Security Dashboard

> Per global CLAUDE.md §64.37 — every (dept, role) pair MUST have a
> role-scoped dashboard. This is the dashboard for **security** in **sales**.

## Persona

The **security** at Sales. They use this dashboard
...
returned by backend `GET /api/v1/holy/dashboards/sales/security/charts/<chart_id>`.
...
```
GET /api/v1/holy/dashboards/sales/security
  → {tiles: [...], charts: [...], filters: {...}, refreshed_at}

GET /api/v1/holy/dashboards/sales/security/charts/<chart_id>
...
- Frontend route: `/holy/sales/dashboard?role=security`
