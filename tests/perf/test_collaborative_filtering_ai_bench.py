"""§138 · Collaborative Filtering AI performance benchmark · pytest-benchmark."""
import joblib
import numpy as np
import pytest

MODEL_PATH = "/mnt/deepa/insur_project/models/collaborative-filtering-ai/model.joblib"
