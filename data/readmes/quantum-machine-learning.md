# Quantum Machine Learning · Comprehensive README · §137

**Effective**: 2026-06-11 · **Slug**: `quantum-machine-learning` · **Kind**: `spec_only`
**Accuracy**: 0.9483 · **Algorithm**: GradientBoostingClassifier (per-type baseline)

---

## 1. BRD · Business Requirements Document

**Business goal**: Reduce manual effort + improve accuracy for quantum machine learning tasks in
...
**FR-1**: System MUST accept input matching `quantum-machine-learning` schema
...
Caller (frontend/agent)
        │
        ▼
  /api/v1/ai-types/quantum-machine-learning/predict
        │
        ▼
...
- `predictions_quantum-machine-learning`: id · input_jsonb · output · confidence · timestamp

**Endpoints**:
- `POST /api/v1/ai-types/quantum-machine-learning/predict` · body: features → prediction
- `GET /api/v1/ai-types/quantum-machine-learning/metrics` → live metrics.json
- `GET /api/v1/ai-types/quantum-machine-learning/explain/{prediction_id}` → SHAP
...
```
[router.py] → [model_loader.py] → [/models/quantum-machine-learning/model.joblib]
            ↘ [preprocessor.py]
...
- collection: `quantum-machine-learning_embeddings`
...
**Fairness metrics** (from data/fairness/quantum-machine-learning.json):
