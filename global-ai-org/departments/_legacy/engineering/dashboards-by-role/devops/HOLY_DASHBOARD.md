# HOLY Beverage — Engineering — Devops Dashboard

> Per global CLAUDE.md §64.37 — every (dept, role) pair MUST have a
> role-scoped dashboard. This is the dashboard for **devops** in **engineering**.

## Persona

The **devops** at Engineering. They use this dashboard
...
returned by backend `GET /api/v1/holy/dashboards/engineering/devops/charts/<chart_id>`.
...
```
GET /api/v1/holy/dashboards/engineering/devops
  → {tiles: [...], charts: [...], filters: {...}, refreshed_at}

GET /api/v1/holy/dashboards/engineering/devops/charts/<chart_id>
...
- Frontend route: `/holy/engineering/dashboard?role=devops`
