# HOLY Beverage — Supply Chain — Database Architect Dashboard

> Per global CLAUDE.md §64.37 — every (dept, role) pair MUST have a
> role-scoped dashboard. This is the dashboard for **database-architect** in **supply-chain**.

## Persona

The **database-architect** at Supply Chain. They use this dashboard
...
returned by backend `GET /api/v1/holy/dashboards/supply-chain/database-architect/charts/<chart_id>`.
...
```
GET /api/v1/holy/dashboards/supply-chain/database-architect
  → {tiles: [...], charts: [...], filters: {...}, refreshed_at}

GET /api/v1/holy/dashboards/supply-chain/database-architect/charts/<chart_id>
...
- Frontend route: `/holy/supply-chain/dashboard?role=database-architect`
