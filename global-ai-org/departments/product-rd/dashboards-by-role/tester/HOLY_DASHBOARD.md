# HOLY Beverage — Product Rd — Tester Dashboard

> Per global CLAUDE.md §64.37 — every (dept, role) pair MUST have a
> role-scoped dashboard. This is the dashboard for **tester** in **product-rd**.

## Persona

The **tester** at Product Rd. They use this dashboard
...
returned by backend `GET /api/v1/holy/dashboards/product-rd/tester/charts/<chart_id>`.
...
```
GET /api/v1/holy/dashboards/product-rd/tester
  → {tiles: [...], charts: [...], filters: {...}, refreshed_at}

GET /api/v1/holy/dashboards/product-rd/tester/charts/<chart_id>
...
- Frontend route: `/holy/product-rd/dashboard?role=tester`
