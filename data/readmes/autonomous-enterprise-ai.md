# Autonomous Enterprise AI · Comprehensive README · §137

**Effective**: 2026-06-11 · **Slug**: `autonomous-enterprise-ai` · **Kind**: `agent_engine`
**Accuracy**: 0.94 · **Algorithm**: GradientBoostingClassifier (per-type baseline)

---

## 1. BRD · Business Requirements Document

**Business goal**: Reduce manual effort + improve accuracy for autonomous enterprise ai tasks in
...
**FR-1**: System MUST accept input matching `autonomous-enterprise-ai` schema
...
Caller (frontend/agent)
        │
        ▼
  /api/v1/ai-types/autonomous-enterprise-ai/predict
        │
        ▼
...
- `predictions_autonomous-enterprise-ai`: id · input_jsonb · output · confidence · timestamp

**Endpoints**:
- `POST /api/v1/ai-types/autonomous-enterprise-ai/predict` · body: features → prediction
- `GET /api/v1/ai-types/autonomous-enterprise-ai/metrics` → live metrics.json
- `GET /api/v1/ai-types/autonomous-enterprise-ai/explain/{prediction_id}` → SHAP
...
```
[router.py] → [model_loader.py] → [/models/autonomous-enterprise-ai/model.joblib]
            ↘ [preprocessor.py]
...
- collection: `autonomous-enterprise-ai_embeddings`
...
**Fairness metrics** (from data/fairness/autonomous-enterprise-ai.json):
