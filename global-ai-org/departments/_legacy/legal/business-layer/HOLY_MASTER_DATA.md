# HOLY Beverage — Legal — Master Data

> Per operator 2026-05-24 — every dept publishes its master + reference
> data here. Focus: **contract-master + entity-master + jurisdiction + clause-library**.
...
This dept (**legal**) operates against the slice of the structure
...
| Endpoint | Returns |
|---|---|
| `GET /api/v1/holy/master-data/legal` | Schema catalog + per-entity owner |
| `GET /api/v1/holy/master-data/legal/customer?limit=20` | Customer master sample |
| `GET /api/v1/holy/master-data/legal/vendor?limit=20` | Vendor master sample |
| `GET /api/v1/holy/master-data/legal/product?limit=20` | Product master sample |
| `GET /api/v1/holy/master-data/legal/org-structure` | Org tree slice for this dept |
...
1. (+) `/api/v1/holy/master-data/legal` returns 200 + entity catalog
