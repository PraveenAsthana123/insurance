# HOLY Beverage — E Commerce — Ai Strategy Dashboard

> Per global CLAUDE.md §64.37 — every (dept, role) pair MUST have a
> role-scoped dashboard. This is the dashboard for **ai-strategy** in **e-commerce**.

## Persona

The **ai-strategy** at E Commerce. They use this dashboard
...
returned by backend `GET /api/v1/holy/dashboards/e-commerce/ai-strategy/charts/<chart_id>`.
...
```
GET /api/v1/holy/dashboards/e-commerce/ai-strategy
  → {tiles: [...], charts: [...], filters: {...}, refreshed_at}

GET /api/v1/holy/dashboards/e-commerce/ai-strategy/charts/<chart_id>
...
- Frontend route: `/holy/e-commerce/dashboard?role=ai-strategy`
