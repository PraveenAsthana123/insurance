# HOLY Beverage — Digital Marketing — BRD (Business Requirements Document)

> Per global §47 + §59 + §64 — every functional commitment in HOLY_FRD.md
> traces back to a goal in this document. Owner: **CMO + Growth Lead**.

## 1. Executive summary

**Strategic goal:** Shift from last-click to AI-attribution; close the loop on every dollar

**Primary KPI(s):** CAC ↓ 25%, attribution accuracy ↑ 40%
...
|---|---|---|---|---|
| Operational efficiency | CAC ↓ 25% | per AS-IS | per AS-IS | 6 months |
...
|---|---|---|
| BRD draft | CMO + Growth Lead | _pending_ |
