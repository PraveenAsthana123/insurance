# HOLY Beverage — Executive Leadership — AI Use-Case Catalog
...
> use cases for **executive-leadership**. Implementation status tracked per current
> codebase state.
...
## 2. Executive Leadership-Specific Use Cases

| Use Case | Category | Data Types | AI Area | Business Value | Status |
|---|---|---|---|---|---|
| AI Decision Intelligence | Leadership | consolidated KPIs | Decision AI | Better strategy | 🟡 RoleDashboard + simulation_engine |
| Strategic AI Advisor | Leadership | market intel + KPIs | Multi-criteria AI | Strategic intelligence | 🟡 council_agent.py applies |
| Scenario Simulation | Leadership | scenarios | Simulation | Better planning | ✅ simulation_engine.py |
| Board-Ready Narration | Leadership | KPIs | NLG + RAG | Faster board prep | ❌ deferred |
