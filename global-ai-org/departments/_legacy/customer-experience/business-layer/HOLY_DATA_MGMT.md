# HOLY Beverage — Customer Experience — Input Data Mgmt + Before/After Viz
...
For every process AND sub-process in this dept (customer-experience), populate the 6
surfaces below. tickets + voice + chat is the primary data class for customer-experience.
...
Plots land in: `data/eval/customer-experience/<pipeline>/<run_id>/plots/before_*.png`
...
Plots land in: `data/eval/customer-experience/<pipeline>/<run_id>/plots/after_*.png`
