# §140 · fraud-investigation × gan · Use Case Spec

## Purpose
PRIMARY fit · Gen technique applied to fraud-investigation domain.
...
## Example use case
Generate synthetic fraud patterns for training adversarial.
