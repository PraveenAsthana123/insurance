# HOLY Beverage — Digital Marketing — Anomaly Detection
...
## Anomaly catalog (top 20 per digital-marketing)

| # | Anomaly type | Severity | Tier | Auto-action | Backing data |
|---|---|---|---|---|---|
| 1 | _stub: anomaly for digital-marketing_ | high | tier 2 | alert + auto-investigate | clickstream + CRM |
