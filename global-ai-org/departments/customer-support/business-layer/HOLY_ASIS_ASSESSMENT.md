# HOLY Beverage — Customer Support — AS-IS Process Assessment
...
This document is the **input to the AI strategy planning** for Customer Support.
...
|---|---|---|---|---|---|---|---|---|
| 1 | Manual ticket categorization | 8 hrs/wk | Med | $200K/yr | Agent overhead | Inconsistent | −20% routing | Zendesk only |
| 2 | Manual KB authoring | 24 hrs/wk | Med | $150K/yr | SME bottleneck | Slow | Stale KB | Confluence |
| 3 | Reactive escalation | 6 hrs/wk | High | $300K/yr | T2 firefighting | Late detection | Lost SLA | Email chain |
| 4 | Manual chat queueing | 4 hrs/wk | Med | $100K/yr | Agent idle vs slammed | FIFO | Bad assign | Round-robin |
| 5 | Manual CSAT survey analysis | 12 hrs/wk | Med | $80K/yr | Analyst overload | Sampling | Stale insights | Excel |
...
4. **Measure** via the persona's main KPI: Median time-to-resolution, CSAT, self-service deflection rate
