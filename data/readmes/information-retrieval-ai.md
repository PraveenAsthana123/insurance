# Information Retrieval AI · Comprehensive README · §137

**Effective**: 2026-06-11 · **Slug**: `information-retrieval-ai` · **Kind**: `nlp_baseline`
**Accuracy**: 1.0 · **Algorithm**: TF-IDF + LogisticRegression

---

## 1. BRD · Business Requirements Document

**Business goal**: Reduce manual effort + improve accuracy for information retrieval ai tasks in
...
**FR-1**: System MUST accept input matching `information-retrieval-ai` schema
...
Caller (frontend/agent)
        │
        ▼
  /api/v1/ai-types/information-retrieval-ai/predict
        │
        ▼
...
- `predictions_information-retrieval-ai`: id · input_jsonb · output · confidence · timestamp

**Endpoints**:
- `POST /api/v1/ai-types/information-retrieval-ai/predict` · body: features → prediction
- `GET /api/v1/ai-types/information-retrieval-ai/metrics` → live metrics.json
- `GET /api/v1/ai-types/information-retrieval-ai/explain/{prediction_id}` → SHAP
...
```
[router.py] → [model_loader.py] → [/models/information-retrieval-ai/model.joblib]
            ↘ [preprocessor.py]
...
**Used**: yes (nlp_baseline)

**Schema** (Qdrant collection · §123 stack):
- collection: `information-retrieval-ai_embeddings`
...
**Fairness metrics** (from data/fairness/information-retrieval-ai.json):
