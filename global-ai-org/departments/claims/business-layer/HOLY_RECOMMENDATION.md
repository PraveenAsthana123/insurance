# HOLY_RECOMMENDATION.md · Dept 7 · claims
...
Recommendation system for Dept 7 (claims). All 3 classical flavors covered per §64.22.

## Item-based (collaborative filter)

**Algorithm**: Item-item matrix factorization (claim × shop)
...
**Algorithm**: CLIP photo similarity + region/severity attribute
...
**Algorithm**: LightGBM rerank · 3-signal blend (CF + photo sim + SLA)
