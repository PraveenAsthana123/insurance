# §140 · it-operations × dl-pytorch · Use Case Spec

## Purpose
Cross-cutting fit · DL technique applied to it-operations domain.
...
## Example use case
It Operations use case applying dl-pytorch to tabular/imgs.
