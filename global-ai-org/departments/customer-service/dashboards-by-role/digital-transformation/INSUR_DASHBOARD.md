# Customer Service / Contact Center — digital-transformation Dashboard

Per global §64.37 — role-scoped dashboard.

## Persona
**digital-transformation** in Customer Service / Contact Center.
...
## API
```
GET /api/v1/insur/dashboards/customer-service/digital-transformation
```
