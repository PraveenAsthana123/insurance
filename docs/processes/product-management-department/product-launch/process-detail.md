...
> Department 1 · Product Management Department · slug `product-launch` · AI items: 5
...
- **One-liner**: TODO
- **Demo URL**: `http://192.168.1.88:3210/insurance/1/<domain>/product-launch?tab=user-demo`
- **Recording**: TODO
...
Simulation URL: `http://192.168.1.88:3210/insurance/1/<domain>/product-launch?tab=simulation`
...
Release summary: auto-gen `docs/processes/product-management-department/product-launch/release-summary-vX.Y.md` covering §1 problem · §4 impact deltas · §10 phase scorecard · §11 test pass/fail · top 3 failure modes · sign-off · git SHA + image digest.
...
Gold set: `data/eval/product-management-department/product-launch/gold_set.jsonl` (100-500 queries · stratified · monthly refresh).
...
→ Tab: `?tab=resai` · evidence files: `data/eval/product-management-department/product-launch/resai/`
...
→ Tab: `?tab=expai` · artifacts: `data/eval/product-management-department/product-launch/expai/`
...
→ Tab: `?tab=analysis` · evidence: `data/eval/product-management-department/product-launch/stats/`
