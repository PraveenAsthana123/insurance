# §140 · marketing × hitl-workflow · Use Case Spec

## Purpose
PRIMARY fit · Ops technique applied to marketing domain.
...
## Example use case
Marketing use case applying hitl-workflow to review queue.
