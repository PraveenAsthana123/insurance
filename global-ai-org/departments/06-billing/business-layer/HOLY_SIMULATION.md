# HOLY_SIMULATION.md · Dept 6 · Billing & Collections
...
## Backend API
- `POST /api/v1/holy/sim/billing/{process}/run`
- `GET /api/v1/holy/sim/billing/{process}/runs/{sim_id}/events` (SSE)
- `GET /api/v1/holy/sim/billing/{process}/runs/{sim_id}/manifest`
- `GET /api/v1/holy/sim/billing/{process}/runs/{sim_id}/replay`
