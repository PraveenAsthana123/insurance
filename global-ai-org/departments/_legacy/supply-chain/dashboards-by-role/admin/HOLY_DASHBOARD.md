# HOLY Beverage — Supply Chain — Admin Dashboard

> Per global CLAUDE.md §64.37 — every (dept, role) pair MUST have a
> role-scoped dashboard. This is the dashboard for **admin** in **supply-chain**.

## Persona

The **admin** at Supply Chain. They use this dashboard
...
returned by backend `GET /api/v1/holy/dashboards/supply-chain/admin/charts/<chart_id>`.
...
```
GET /api/v1/holy/dashboards/supply-chain/admin
  → {tiles: [...], charts: [...], filters: {...}, refreshed_at}

GET /api/v1/holy/dashboards/supply-chain/admin/charts/<chart_id>
...
- Frontend route: `/holy/supply-chain/dashboard?role=admin`
