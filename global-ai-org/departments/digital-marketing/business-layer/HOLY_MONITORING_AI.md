# HOLY Beverage — Digital Marketing — Monitoring AI
...
> Persona: **Marketing Manager**. Focus: **campaign-attribution AI + creative-recommender drift**.
...
Tab: `/holy/digital-marketing/monitoring`
...
| Endpoint | Returns |
|---|---|
| `GET /api/v1/holy/monitoring/digital-marketing` | Per-job last-run summary + health status |
| `GET /api/v1/holy/monitoring/digital-marketing/jobs/<job>/runs?limit=20` | Recent runs with manifest summaries |
| `GET /api/v1/holy/monitoring/digital-marketing/jobs/<job>/runs/<run_id>` | Full manifest of a single run |
...
| Job error rate spike | > 10% errors over 1h window | Slack #digital-marketing-ops |
| Drift PSI > 0.2 | accuracy gate breach | Slack #digital-marketing-ai-reviewer |
...
1. (+) `/api/v1/holy/monitoring/digital-marketing` returns 200 + job list
