# HOLY Beverage — Customer Experience — Admin Dashboard

> Per global CLAUDE.md §64.37 — every (dept, role) pair MUST have a
> role-scoped dashboard. This is the dashboard for **admin** in **customer-experience**.

## Persona

The **admin** at Customer Experience. They use this dashboard
...
returned by backend `GET /api/v1/holy/dashboards/customer-experience/admin/charts/<chart_id>`.
...
```
GET /api/v1/holy/dashboards/customer-experience/admin
  → {tiles: [...], charts: [...], filters: {...}, refreshed_at}

GET /api/v1/holy/dashboards/customer-experience/admin/charts/<chart_id>
...
- Frontend route: `/holy/customer-experience/dashboard?role=admin`
