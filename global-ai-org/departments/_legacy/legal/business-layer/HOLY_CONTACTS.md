# HOLY Beverage — Legal — Contact Management (customer + vendor + internal)
...
- Sync: scheduled inbound from legal's CRM / ERP / HRIS
...
|---|---|---|
| GET /api/v1/holy/contacts/legal/customers | list | manager / data-owner |
| GET /api/v1/holy/contacts/legal/vendors | list | manager / procurement |
| GET /api/v1/holy/contacts/legal/internal | list | any dept role |
| POST /api/v1/holy/contacts/legal/customers | create | admin / manager |
| PUT /api/v1/holy/contacts/legal/customers/{id} | update | admin / data-owner |
| DELETE /api/v1/holy/contacts/legal/customers/{id} | soft-delete | admin |
