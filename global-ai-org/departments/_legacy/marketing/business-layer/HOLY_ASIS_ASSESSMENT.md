# HOLY Beverage — Marketing — AS-IS Process Assessment
...
This document is the **input to the AI strategy planning** for Marketing.
...
|---|---|---|---|---|---|---|---|---|
| 1 | Manual campaign briefing | 12 hrs/wk | Med | $200K/yr | Brand mgr overload | Bottleneck | Slow start | Email + docs |
| 2 | Manual attribution analysis | 40 hrs/wk | High | $500K/yr | Analyst burnout | Last-click only | Bad spend decisions | GA only |
| 3 | Reactive crisis response | 8 hrs/wk | High | $1M/yr brand risk | Comms team burnout | Sentiment lag | Damage | Social listening |
| 4 | Manual influencer vetting | 16 hrs/wk | Med | $300K/yr | Influencer team overload | Slow | Missed talent | Manual review |
| 5 | Manual creative QC | 6 hrs/wk | Med | $150K/yr | Brand-safety review | Sampling | Bad approvals | Manual review |
...
4. **Measure** via the persona's main KPI: Attributable revenue, waste-spend %, brand NPS, MQL→SQL conversion
