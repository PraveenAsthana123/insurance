# HOLY Beverage — Customer Support — Information Security Dashboard

> Per global CLAUDE.md §64.37 — every (dept, role) pair MUST have a
> role-scoped dashboard. This is the dashboard for **information-security** in **customer-support**.

## Persona

The **information-security** at Customer Support. They use this dashboard
...
returned by backend `GET /api/v1/holy/dashboards/customer-support/information-security/charts/<chart_id>`.
...
```
GET /api/v1/holy/dashboards/customer-support/information-security
  → {tiles: [...], charts: [...], filters: {...}, refreshed_at}

GET /api/v1/holy/dashboards/customer-support/information-security/charts/<chart_id>
...
- Frontend route: `/holy/customer-support/dashboard?role=information-security`
