# HOLY Beverage — Executive Leadership — Contact Center Automation
...
**Manager** + **CX role** (dept = executive-leadership). For non-CX depts this covers
...
|---|---|---|---|---|
| 1 | _stub: replace with real intent for executive-leadership_ | _ | yes/no | DistilBERT |
| … | (20 total minimum) | | | |
...
- LLM model: `gemma3:4b` (default for executive-leadership) — adjust per latency/cost SLO
- RAG corpus: `data/executive-leadership/kb/` + `data/executive-leadership/sops/`
