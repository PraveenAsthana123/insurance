# HOLY_RECOMMENDATION.md · Dept 10 · actuarial
...
Recommendation system for Dept 10 (actuarial). All 3 classical flavors covered per §64.22.

## Item-based (collaborative filter)

**Algorithm**: Bayesian recommendation with posterior uncertainty
...
**Algorithm**: Profile attribute match (claim profile embed)
...
**Algorithm**: Bayesian blend · CF posterior + content prior
