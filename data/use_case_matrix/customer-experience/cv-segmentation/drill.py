"""§140 · customer-experience × cv-segmentation drill · ≥1 pos + ≥1 neg."""
import json
from pathlib import Path

R = Path("/mnt/deepa/insur_project")
CELL = R / "data/use_case_matrix/customer-experience/cv-segmentation"
...
def test_manifest_has_dept_and_technique():
    ...
    assert m["technique"] == "cv-segmentation"
