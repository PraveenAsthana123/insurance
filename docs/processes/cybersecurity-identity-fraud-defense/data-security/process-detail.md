...
> Department 20 · Cybersecurity, Identity & Fraud Defense · slug `data-security` · AI items: 3
...
- **One-liner**: TODO
- **Demo URL**: `http://192.168.1.88:3210/insurance/20/<domain>/data-security?tab=user-demo`
- **Recording**: TODO
...
Simulation URL: `http://192.168.1.88:3210/insurance/20/<domain>/data-security?tab=simulation`
...
Release summary: auto-gen `docs/processes/cybersecurity-identity-fraud-defense/data-security/release-summary-vX.Y.md` covering §1 problem · §4 impact deltas · §10 phase scorecard · §11 test pass/fail · top 3 failure modes · sign-off · git SHA + image digest.
...
Gold set: `data/eval/cybersecurity-identity-fraud-defense/data-security/gold_set.jsonl` (100-500 queries · stratified · monthly refresh).
...
→ Tab: `?tab=resai` · evidence files: `data/eval/cybersecurity-identity-fraud-defense/data-security/resai/`
...
→ Tab: `?tab=expai` · artifacts: `data/eval/cybersecurity-identity-fraud-defense/data-security/expai/`
...
→ Tab: `?tab=analysis` · evidence: `data/eval/cybersecurity-identity-fraud-defense/data-security/stats/`
