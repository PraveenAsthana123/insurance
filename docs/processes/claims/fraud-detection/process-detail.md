...
> Department 7 · Claims · slug `fraud-detection` · AI items: 6
...
- **One-liner**: TODO
- **Demo URL**: `http://192.168.1.88:3210/insurance/7/<domain>/fraud-detection?tab=user-demo`
- **Recording**: TODO
...
Simulation URL: `http://192.168.1.88:3210/insurance/7/<domain>/fraud-detection?tab=simulation`
...
Release summary: auto-gen `docs/processes/claims/fraud-detection/release-summary-vX.Y.md` covering §1 problem · §4 impact deltas · §10 phase scorecard · §11 test pass/fail · top 3 failure modes · sign-off · git SHA + image digest.
...
Gold set: `data/eval/claims/fraud-detection/gold_set.jsonl` (100-500 queries · stratified · monthly refresh).
...
→ Tab: `?tab=resai` · evidence files: `data/eval/claims/fraud-detection/resai/`
...
→ Tab: `?tab=expai` · artifacts: `data/eval/claims/fraud-detection/expai/`
...
→ Tab: `?tab=analysis` · evidence: `data/eval/claims/fraud-detection/stats/`
