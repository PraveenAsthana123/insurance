# HOLY Beverage — Product Rd — Contact Center Automation
...
**Manager** + **CX role** (dept = product-rd). For non-CX depts this covers
...
|---|---|---|---|---|
| 1 | _stub: replace with real intent for product-rd_ | _ | yes/no | DistilBERT |
| … | (20 total minimum) | | | |
...
- LLM model: `gemma3:4b` (default for product-rd) — adjust per latency/cost SLO
- RAG corpus: `data/product-rd/kb/` + `data/product-rd/sops/`
