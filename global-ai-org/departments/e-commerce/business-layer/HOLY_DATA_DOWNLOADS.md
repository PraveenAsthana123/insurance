# HOLY Beverage — E Commerce — Data Downloads
...
|---|---|---|---|---|---|
| 1 | `e_commerce_primary_sample` | E Commerce primary use-case sample | tabular | 5 | 5 |
...
### 3.x `e_commerce_primary_sample`

- **Title:** E Commerce primary use-case sample
- **Lifecycle:** tabular
...
| Endpoint | Returns |
|---|---|
| `GET /api/v1/holy/downloads/e-commerce` | Catalog (datasets + URLs) |
| `GET /api/v1/holy/downloads/e-commerce/<dataset_id>.csv` | CSV file |
| `GET /api/v1/holy/downloads/e-commerce/<dataset_id>.json` | JSON file |
| `GET /api/v1/holy/downloads/e-commerce/<dataset_id>.before.svg` | Pre-process viz |
| `GET /api/v1/holy/downloads/e-commerce/<dataset_id>.after.svg` | Post-process viz |
