# HOLY Beverage — Sales — System Architect Dashboard

> Per global CLAUDE.md §64.37 — every (dept, role) pair MUST have a
> role-scoped dashboard. This is the dashboard for **system-architect** in **sales**.

## Persona

The **system-architect** at Sales. They use this dashboard
...
returned by backend `GET /api/v1/holy/dashboards/sales/system-architect/charts/<chart_id>`.
...
```
GET /api/v1/holy/dashboards/sales/system-architect
  → {tiles: [...], charts: [...], filters: {...}, refreshed_at}

GET /api/v1/holy/dashboards/sales/system-architect/charts/<chart_id>
...
- Frontend route: `/holy/sales/dashboard?role=system-architect`
