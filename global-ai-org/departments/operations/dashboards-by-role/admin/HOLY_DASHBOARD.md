# HOLY Beverage — Operations — Admin Dashboard

> Per global CLAUDE.md §64.37 — every (dept, role) pair MUST have a
> role-scoped dashboard. This is the dashboard for **admin** in **operations**.

## Persona

The **admin** at Operations. They use this dashboard
...
returned by backend `GET /api/v1/holy/dashboards/operations/admin/charts/<chart_id>`.
...
```
GET /api/v1/holy/dashboards/operations/admin
  → {tiles: [...], charts: [...], filters: {...}, refreshed_at}

GET /api/v1/holy/dashboards/operations/admin/charts/<chart_id>
...
- Frontend route: `/holy/operations/dashboard?role=admin`
