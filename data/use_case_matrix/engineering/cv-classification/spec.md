# §140 · engineering × cv-classification · Use Case Spec

## Purpose
Cross-cutting fit · CV technique applied to engineering domain.
...
## Example use case
Engineering use case applying cv-classification to images.
