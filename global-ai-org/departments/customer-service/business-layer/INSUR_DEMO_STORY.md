...
| --- | --- | --- | --- |
| 1 | Open /insur/customer-service/dashboard?role=manager | Manager dashboard with 6-flavor scorecard | Every sub-process governed across 6 AI flavors per §64.36 |
