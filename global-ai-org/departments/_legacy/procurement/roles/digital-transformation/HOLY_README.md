# Procurement — Digital Transformation (HOLY)
...
## How this role uses HOLY's Procurement platform

- **Navigates** via `HOLY_NAV.json` (left-sidebar process picker; see `/holy/procurement` in frontend)
...
NLP, OCR, Scoring ML, Optimization AI, Risk ML

## Tech stack this role touches

- SAP Ariba + Coupa
- Python + spaCy + Tesseract
- OpenAI for contract analysis
- Snowflake for spend analytics
