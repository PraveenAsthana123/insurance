...
| `docs/UI_LINK_PERFORMANCE_TOOL_AUDIT_2026-06-12.md` | UI main/sub-menu, B2C/B2B/B2E link, tab, load, visualization, simulation, trace, testing-tool, and report audit. |
| `docs/BANK_UI_UX_SHELL_AUDIT_2026-06-12.md` | Bank UI/UX shell audit for main menu, sub-menu, responsive workspace, focus navigation, and mobile/tablet overflow fixes. |
