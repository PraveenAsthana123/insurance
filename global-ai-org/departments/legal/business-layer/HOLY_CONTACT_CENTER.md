# HOLY Beverage — Legal — Contact Center Automation
...
**Manager** + **CX role** (dept = legal). For non-CX depts this covers
...
|---|---|---|---|---|
| 1 | _stub: replace with real intent for legal_ | _ | yes/no | DistilBERT |
| … | (20 total minimum) | | | |
...
- LLM model: `gemma3:4b` (default for legal) — adjust per latency/cost SLO
- RAG corpus: `data/legal/kb/` + `data/legal/sops/`
