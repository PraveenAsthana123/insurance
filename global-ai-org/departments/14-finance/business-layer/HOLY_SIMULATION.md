# HOLY_SIMULATION.md · Dept 14 · Finance & Accounting
...
## Backend API
- `POST /api/v1/holy/sim/finance/{process}/run`
- `GET /api/v1/holy/sim/finance/{process}/runs/{sim_id}/events` (SSE)
- `GET /api/v1/holy/sim/finance/{process}/runs/{sim_id}/manifest`
- `GET /api/v1/holy/sim/finance/{process}/runs/{sim_id}/replay`
