# HOLY Beverage — Legal — Api Architect Dashboard

> Per global CLAUDE.md §64.37 — every (dept, role) pair MUST have a
> role-scoped dashboard. This is the dashboard for **api-architect** in **legal**.

## Persona

The **api-architect** at Legal. They use this dashboard
...
returned by backend `GET /api/v1/holy/dashboards/legal/api-architect/charts/<chart_id>`.
...
```
GET /api/v1/holy/dashboards/legal/api-architect
  → {tiles: [...], charts: [...], filters: {...}, refreshed_at}

GET /api/v1/holy/dashboards/legal/api-architect/charts/<chart_id>
...
- Frontend route: `/holy/legal/dashboard?role=api-architect`
