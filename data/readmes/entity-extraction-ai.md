# Entity Extraction AI · Comprehensive README · §137

**Effective**: 2026-06-11 · **Slug**: `entity-extraction-ai` · **Kind**: `nlp_baseline`
...
**Business goal**: Reduce manual effort + improve accuracy for entity extraction ai tasks in
...
**FR-1**: System MUST accept input matching `entity-extraction-ai` schema
...
Caller (frontend/agent)
        │
        ▼
  /api/v1/ai-types/entity-extraction-ai/predict
        │
        ▼
...
- `predictions_entity-extraction-ai`: id · input_jsonb · output · confidence · timestamp

**Endpoints**:
- `POST /api/v1/ai-types/entity-extraction-ai/predict` · body: features → prediction
- `GET /api/v1/ai-types/entity-extraction-ai/metrics` → live metrics.json
- `GET /api/v1/ai-types/entity-extraction-ai/explain/{prediction_id}` → SHAP
...
```
[router.py] → [model_loader.py] → [/models/entity-extraction-ai/model.joblib]
            ↘ [preprocessor.py]
...
- collection: `entity-extraction-ai_embeddings`
...
**Fairness metrics** (from data/fairness/entity-extraction-ai.json):
