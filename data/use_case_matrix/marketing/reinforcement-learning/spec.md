# §140 · marketing × reinforcement-learning · Use Case Spec

## Purpose
Cross-cutting fit · RL technique applied to marketing domain.
...
## Example use case
Marketing use case applying reinforcement-learning to env+reward.
