# HOLY Beverage — Customer Support — Team Member Dashboard

> Per global CLAUDE.md §64.37 — every (dept, role) pair MUST have a
> role-scoped dashboard. This is the dashboard for **team-member** in **customer-support**.

## Persona

The **team-member** at Customer Support. They use this dashboard
...
returned by backend `GET /api/v1/holy/dashboards/customer-support/team-member/charts/<chart_id>`.
...
```
GET /api/v1/holy/dashboards/customer-support/team-member
  → {tiles: [...], charts: [...], filters: {...}, refreshed_at}

GET /api/v1/holy/dashboards/customer-support/team-member/charts/<chart_id>
...
- Frontend route: `/holy/customer-support/dashboard?role=team-member`
