# HOLY Beverage — Sales — Input Data Mgmt + Before/After Viz
...
For every process AND sub-process in this dept (sales), populate the 6
surfaces below. CRM + deals + activity is the primary data class for sales.
...
Plots land in: `data/eval/sales/<pipeline>/<run_id>/plots/before_*.png`
...
Plots land in: `data/eval/sales/<pipeline>/<run_id>/plots/after_*.png`
