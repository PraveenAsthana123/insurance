# HOLY Beverage — Product Rd — Digital Transformation Dashboard

> Per global CLAUDE.md §64.37 — every (dept, role) pair MUST have a
> role-scoped dashboard. This is the dashboard for **digital-transformation** in **product-rd**.

## Persona

The **digital-transformation** at Product Rd. They use this dashboard
...
returned by backend `GET /api/v1/holy/dashboards/product-rd/digital-transformation/charts/<chart_id>`.
...
```
GET /api/v1/holy/dashboards/product-rd/digital-transformation
  → {tiles: [...], charts: [...], filters: {...}, refreshed_at}

GET /api/v1/holy/dashboards/product-rd/digital-transformation/charts/<chart_id>
...
- Frontend route: `/holy/product-rd/dashboard?role=digital-transformation`
