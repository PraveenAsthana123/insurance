# HOLY Beverage — Sales — AI Use-Case Catalog
...
> use cases for **sales**. Implementation status tracked per current
> codebase state.
...
## 2. Sales-Specific Use Cases

| Use Case | Category | Data Types | AI Area | Business Value | Status |
|---|---|---|---|---|---|
| Sales Forecasting AI | Sales AI | revenue | Forecasting | Better planning | ✅ timeseries_lifecycle.py + full_lifecycle.py |
| Lead Scoring AI | Sales AI | CRM records | Classification ML | Faster recruitment | ✅ simulation_engine.py REFERENCE_PROCESSES[sales,lead_scoring] |
| AI Proposal Generator | Sales AI | DOCX/PDF/pricing | GenAI | Faster close | ❌ deferred |
| Conversation Intelligence | Sales AI | audio/transcript | NLP + Speech | Better coaching | 🟡 nlp_lifecycle.py covers text portion |
| Sales Copilot | Sales AI | CRM notes/emails | Conversational | Productivity | 🟡 council_agent.py is the closest analog |
