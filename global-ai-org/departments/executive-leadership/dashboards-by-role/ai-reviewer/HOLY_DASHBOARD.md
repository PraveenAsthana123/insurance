# HOLY Beverage — Executive Leadership — Ai Reviewer Dashboard

> Per global CLAUDE.md §64.37 — every (dept, role) pair MUST have a
> role-scoped dashboard. This is the dashboard for **ai-reviewer** in **executive-leadership**.

## Persona

The **ai-reviewer** at Executive Leadership. They use this dashboard
...
returned by backend `GET /api/v1/holy/dashboards/executive-leadership/ai-reviewer/charts/<chart_id>`.
...
```
GET /api/v1/holy/dashboards/executive-leadership/ai-reviewer
  → {tiles: [...], charts: [...], filters: {...}, refreshed_at}

GET /api/v1/holy/dashboards/executive-leadership/ai-reviewer/charts/<chart_id>
...
- Frontend route: `/holy/executive-leadership/dashboard?role=ai-reviewer`
