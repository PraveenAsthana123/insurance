# Executive Leadership — Database Architect (HOLY)

**Source:** operator brief 2026-05-21.

## Role focus in this department

data modeling, performance, retention, lineage

## What this role owns

schemas, indexes, partitioning, data contracts, lineage
...
- `../dashboards-by-role/database-architect/` — role-scoped dashboards (when authored)
- `../reports-by-role/database-architect/` — role-scoped reports (when authored)
