# HOLY Beverage — Customer Experience — Data Downloads
...
|---|---|---|---|---|---|
| 1 | `customer_experience_primary_sample` | Customer Experience primary use-case sample | tabular | 5 | 5 |
...
### 3.x `customer_experience_primary_sample`

- **Title:** Customer Experience primary use-case sample
- **Lifecycle:** tabular
...
| Endpoint | Returns |
|---|---|
| `GET /api/v1/holy/downloads/customer-experience` | Catalog (datasets + URLs) |
| `GET /api/v1/holy/downloads/customer-experience/<dataset_id>.csv` | CSV file |
| `GET /api/v1/holy/downloads/customer-experience/<dataset_id>.json` | JSON file |
| `GET /api/v1/holy/downloads/customer-experience/<dataset_id>.before.svg` | Pre-process viz |
| `GET /api/v1/holy/downloads/customer-experience/<dataset_id>.after.svg` | Post-process viz |
