# HOLY Beverage — Marketing — Anomaly Detection
...
## Anomaly catalog (top 20 per marketing)

| # | Anomaly type | Severity | Tier | Auto-action | Backing data |
|---|---|---|---|---|---|
| 1 | _stub: anomaly for marketing_ | high | tier 2 | alert + auto-investigate | campaigns + creative + attribution |
