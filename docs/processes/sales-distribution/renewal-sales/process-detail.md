...
> Department 3 · Sales & Distribution · slug `renewal-sales` · AI items: 4
...
- **One-liner**: TODO
- **Demo URL**: `http://192.168.1.88:3210/insurance/3/<domain>/renewal-sales?tab=user-demo`
- **Recording**: TODO
...
Simulation URL: `http://192.168.1.88:3210/insurance/3/<domain>/renewal-sales?tab=simulation`
...
Release summary: auto-gen `docs/processes/sales-distribution/renewal-sales/release-summary-vX.Y.md` covering §1 problem · §4 impact deltas · §10 phase scorecard · §11 test pass/fail · top 3 failure modes · sign-off · git SHA + image digest.
...
Gold set: `data/eval/sales-distribution/renewal-sales/gold_set.jsonl` (100-500 queries · stratified · monthly refresh).
...
→ Tab: `?tab=resai` · evidence files: `data/eval/sales-distribution/renewal-sales/resai/`
...
→ Tab: `?tab=expai` · artifacts: `data/eval/sales-distribution/renewal-sales/expai/`
...
→ Tab: `?tab=analysis` · evidence: `data/eval/sales-distribution/renewal-sales/stats/`
