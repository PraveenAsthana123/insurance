...
> Department 14 · Finance & Accounting · slug `financial-reporting` · AI items: 4
...
- **One-liner**: TODO
- **Demo URL**: `http://192.168.1.88:3210/insurance/14/<domain>/financial-reporting?tab=user-demo`
- **Recording**: TODO
...
Simulation URL: `http://192.168.1.88:3210/insurance/14/<domain>/financial-reporting?tab=simulation`
...
Release summary: auto-gen `docs/processes/finance-accounting/financial-reporting/release-summary-vX.Y.md` covering §1 problem · §4 impact deltas · §10 phase scorecard · §11 test pass/fail · top 3 failure modes · sign-off · git SHA + image digest.
...
Gold set: `data/eval/finance-accounting/financial-reporting/gold_set.jsonl` (100-500 queries · stratified · monthly refresh).
...
→ Tab: `?tab=resai` · evidence files: `data/eval/finance-accounting/financial-reporting/resai/`
...
→ Tab: `?tab=expai` · artifacts: `data/eval/finance-accounting/financial-reporting/expai/`
...
→ Tab: `?tab=analysis` · evidence: `data/eval/finance-accounting/financial-reporting/stats/`
