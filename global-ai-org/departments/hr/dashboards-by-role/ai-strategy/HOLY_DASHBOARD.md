# HOLY Beverage — Hr — Ai Strategy Dashboard

> Per global CLAUDE.md §64.37 — every (dept, role) pair MUST have a
> role-scoped dashboard. This is the dashboard for **ai-strategy** in **hr**.

## Persona

The **ai-strategy** at Hr. They use this dashboard
...
returned by backend `GET /api/v1/holy/dashboards/hr/ai-strategy/charts/<chart_id>`.
...
```
GET /api/v1/holy/dashboards/hr/ai-strategy
  → {tiles: [...], charts: [...], filters: {...}, refreshed_at}

GET /api/v1/holy/dashboards/hr/ai-strategy/charts/<chart_id>
...
- Frontend route: `/holy/hr/dashboard?role=ai-strategy`
