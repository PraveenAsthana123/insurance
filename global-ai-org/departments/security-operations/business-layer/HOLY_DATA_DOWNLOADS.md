# HOLY Beverage — Security Operations — Data Downloads
...
|---|---|---|---|---|---|
| 1 | `security_operations_primary_sample` | Security Operations primary use-case sample | tabular | 5 | 5 |
...
### 3.x `security_operations_primary_sample`

- **Title:** Security Operations primary use-case sample
- **Lifecycle:** tabular
...
| Endpoint | Returns |
|---|---|
| `GET /api/v1/holy/downloads/security-operations` | Catalog (datasets + URLs) |
| `GET /api/v1/holy/downloads/security-operations/<dataset_id>.csv` | CSV file |
| `GET /api/v1/holy/downloads/security-operations/<dataset_id>.json` | JSON file |
| `GET /api/v1/holy/downloads/security-operations/<dataset_id>.before.svg` | Pre-process viz |
| `GET /api/v1/holy/downloads/security-operations/<dataset_id>.after.svg` | Post-process viz |
