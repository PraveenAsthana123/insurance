# HOLY Beverage — It Operations — Incident Management (L1/L2/L3 + RAG)
...
|---|---|---|---|---|
| 1 | _stub: replace with real L1 issue for it-operations_ | runbook URL | < 1 min | < 5 min |
...
- RAG corpus: `data/it-operations/runbooks/` + `data/it-operations/past-incidents/`
