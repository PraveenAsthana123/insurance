# §140 · claims × small-data-fewshot · Use Case Spec

## Purpose
Cross-cutting fit · ML technique applied to claims domain.
...
## Example use case
Claims use case applying small-data-fewshot to few labels.
