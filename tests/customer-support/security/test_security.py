"""Tier 11-12 — Security tests for customer-support.
...
def test_customer_support_owasp_zap_scan():
    """REPLACE — invoke OWASP ZAP CLI against customer-support surface (auth env only)."""
    pass


@pytest.mark.skip(reason="placeholder — requires Garak install + AI endpoint")
def test_customer_support_garak_prompt_injection():
