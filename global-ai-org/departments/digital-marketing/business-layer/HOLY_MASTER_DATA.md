# HOLY Beverage — Digital Marketing — Master Data

> Per operator 2026-05-24 — every dept publishes its master + reference
> data here. Focus: **customer-segments + campaign-products + channel-partners**.
...
This dept (**digital-marketing**) operates against the slice of the structure
...
| Endpoint | Returns |
|---|---|
| `GET /api/v1/holy/master-data/digital-marketing` | Schema catalog + per-entity owner |
| `GET /api/v1/holy/master-data/digital-marketing/customer?limit=20` | Customer master sample |
| `GET /api/v1/holy/master-data/digital-marketing/vendor?limit=20` | Vendor master sample |
| `GET /api/v1/holy/master-data/digital-marketing/product?limit=20` | Product master sample |
| `GET /api/v1/holy/master-data/digital-marketing/org-structure` | Org tree slice for this dept |
...
1. (+) `/api/v1/holy/master-data/digital-marketing` returns 200 + entity catalog
