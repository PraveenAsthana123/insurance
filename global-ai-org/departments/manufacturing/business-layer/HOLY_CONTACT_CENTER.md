# HOLY Beverage — Manufacturing — Contact Center Automation
...
**Manager** + **CX role** (dept = manufacturing). For non-CX depts this covers
...
|---|---|---|---|---|
| 1 | _stub: replace with real intent for manufacturing_ | _ | yes/no | DistilBERT |
| … | (20 total minimum) | | | |
...
- LLM model: `gemma3:4b` (default for manufacturing) — adjust per latency/cost SLO
- RAG corpus: `data/manufacturing/kb/` + `data/manufacturing/sops/`
