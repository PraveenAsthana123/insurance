"""Tier 11-12 — Security tests for manufacturing.
...
def test_manufacturing_owasp_zap_scan():
    """REPLACE — invoke OWASP ZAP CLI against manufacturing surface (auth env only)."""
    pass


@pytest.mark.skip(reason="placeholder — requires Garak install + AI endpoint")
def test_manufacturing_garak_prompt_injection():
