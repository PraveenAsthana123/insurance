# Fraud / Special Investigations Unit (SIU) — tester Dashboard

Per global §64.37 — role-scoped dashboard.

## Persona
**tester** in Fraud / Special Investigations Unit (SIU).

## Focus
Test coverage, defect density, regression heatmap
...
## API
```
GET /api/v1/insur/dashboards/fraud-siu/tester
```
