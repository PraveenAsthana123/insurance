# Claims — digital-transformation Reports

Per global §64.37 — role-scoped reports (≥ 3 standard per role).

## Standard reports

### R1 — Claims digital-transformation digest
...
## API
```
GET  /api/v1/insur/reports/claims/digital-transformation
POST /api/v1/insur/reports/claims/digital-transformation/{report_id}/run
```
