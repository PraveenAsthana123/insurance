# HOLY Beverage — Customer Support — Security Dashboard

> Per global CLAUDE.md §64.37 — every (dept, role) pair MUST have a
> role-scoped dashboard. This is the dashboard for **security** in **customer-support**.

## Persona

The **security** at Customer Support. They use this dashboard
...
returned by backend `GET /api/v1/holy/dashboards/customer-support/security/charts/<chart_id>`.
...
```
GET /api/v1/holy/dashboards/customer-support/security
  → {tiles: [...], charts: [...], filters: {...}, refreshed_at}

GET /api/v1/holy/dashboards/customer-support/security/charts/<chart_id>
...
- Frontend route: `/holy/customer-support/dashboard?role=security`
