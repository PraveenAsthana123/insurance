# HOLY Beverage — Procurement — Contact Management (customer + vendor + internal)
...
- Sync: scheduled inbound from procurement's CRM / ERP / HRIS
...
|---|---|---|
| GET /api/v1/holy/contacts/procurement/customers | list | manager / data-owner |
| GET /api/v1/holy/contacts/procurement/vendors | list | manager / procurement |
| GET /api/v1/holy/contacts/procurement/internal | list | any dept role |
| POST /api/v1/holy/contacts/procurement/customers | create | admin / manager |
| PUT /api/v1/holy/contacts/procurement/customers/{id} | update | admin / data-owner |
| DELETE /api/v1/holy/contacts/procurement/customers/{id} | soft-delete | admin |
