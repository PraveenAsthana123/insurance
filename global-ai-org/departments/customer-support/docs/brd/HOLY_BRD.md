# HOLY Beverage — Customer Support — BRD (Business Requirements Document)

> Per global §47 + §59 + §64 — every functional commitment in HOLY_FRD.md
> traces back to a goal in this document. Owner: **VP Support**.

## 1. Executive summary

**Strategic goal:** Intent-classifier + RAG knowledge base + auto-resolution

**Primary KPI(s):** FCR ↑ to 78%, AHT ↓ 30%
...
|---|---|---|---|---|
| Operational efficiency | FCR ↑ to 78% | per AS-IS | per AS-IS | 6 months |
...
|---|---|---|
| BRD draft | VP Support | _pending_ |
