# §140 · customer-experience × time-series · Use Case Spec

## Purpose
Cross-cutting fit · TS technique applied to customer-experience domain.
...
## Example use case
Customer Experience use case applying time-series to temporal.
