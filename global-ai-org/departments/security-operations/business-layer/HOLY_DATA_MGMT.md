# HOLY Beverage — Security Operations — Input Data Mgmt + Before/After Viz
...
For every process AND sub-process in this dept (security-operations), populate the 6
surfaces below. SIEM + EDR + IAM + threat intel is the primary data class for security-operations.
...
Plots land in: `data/eval/security-operations/<pipeline>/<run_id>/plots/before_*.png`
...
Plots land in: `data/eval/security-operations/<pipeline>/<run_id>/plots/after_*.png`
