# HOLY Beverage — Engineering — Anomaly Detection
...
## Anomaly catalog (top 20 per engineering)

| # | Anomaly type | Severity | Tier | Auto-action | Backing data |
|---|---|---|---|---|---|
| 1 | _stub: anomaly for engineering_ | high | tier 2 | alert + auto-investigate | git + CI + incidents |
