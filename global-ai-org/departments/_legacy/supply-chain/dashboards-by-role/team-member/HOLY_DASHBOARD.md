# HOLY Beverage — Supply Chain — Team Member Dashboard

> Per global CLAUDE.md §64.37 — every (dept, role) pair MUST have a
> role-scoped dashboard. This is the dashboard for **team-member** in **supply-chain**.

## Persona

The **team-member** at Supply Chain. They use this dashboard
...
returned by backend `GET /api/v1/holy/dashboards/supply-chain/team-member/charts/<chart_id>`.
...
```
GET /api/v1/holy/dashboards/supply-chain/team-member
  → {tiles: [...], charts: [...], filters: {...}, refreshed_at}

GET /api/v1/holy/dashboards/supply-chain/team-member/charts/<chart_id>
...
- Frontend route: `/holy/supply-chain/dashboard?role=team-member`
