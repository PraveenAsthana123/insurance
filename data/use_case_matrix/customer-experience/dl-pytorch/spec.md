# §140 · customer-experience × dl-pytorch · Use Case Spec

## Purpose
Cross-cutting fit · DL technique applied to customer-experience domain.
...
## Example use case
Customer Experience use case applying dl-pytorch to tabular/imgs.
