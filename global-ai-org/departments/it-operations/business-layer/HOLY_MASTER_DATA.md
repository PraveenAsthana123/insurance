# HOLY Beverage — It Operations — Master Data

> Per operator 2026-05-24 — every dept publishes its master + reference
> data here. Focus: **CMDB + asset-master + change-categories + vendor-master**.
...
This dept (**it-operations**) operates against the slice of the structure
...
| Endpoint | Returns |
|---|---|
| `GET /api/v1/holy/master-data/it-operations` | Schema catalog + per-entity owner |
| `GET /api/v1/holy/master-data/it-operations/customer?limit=20` | Customer master sample |
| `GET /api/v1/holy/master-data/it-operations/vendor?limit=20` | Vendor master sample |
| `GET /api/v1/holy/master-data/it-operations/product?limit=20` | Product master sample |
| `GET /api/v1/holy/master-data/it-operations/org-structure` | Org tree slice for this dept |
...
1. (+) `/api/v1/holy/master-data/it-operations` returns 200 + entity catalog
