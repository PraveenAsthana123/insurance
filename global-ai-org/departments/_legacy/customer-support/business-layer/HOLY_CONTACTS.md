# HOLY Beverage — Customer Support — Contact Management (customer + vendor + internal)
...
- Sync: scheduled inbound from customer-support's CRM / ERP / HRIS
...
|---|---|---|
| GET /api/v1/holy/contacts/customer-support/customers | list | manager / data-owner |
| GET /api/v1/holy/contacts/customer-support/vendors | list | manager / procurement |
| GET /api/v1/holy/contacts/customer-support/internal | list | any dept role |
| POST /api/v1/holy/contacts/customer-support/customers | create | admin / manager |
| PUT /api/v1/holy/contacts/customer-support/customers/{id} | update | admin / data-owner |
| DELETE /api/v1/holy/contacts/customer-support/customers/{id} | soft-delete | admin |
