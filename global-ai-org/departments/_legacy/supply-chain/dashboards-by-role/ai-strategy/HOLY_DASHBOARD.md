# HOLY Beverage — Supply Chain — Ai Strategy Dashboard

> Per global CLAUDE.md §64.37 — every (dept, role) pair MUST have a
> role-scoped dashboard. This is the dashboard for **ai-strategy** in **supply-chain**.

## Persona

The **ai-strategy** at Supply Chain. They use this dashboard
...
returned by backend `GET /api/v1/holy/dashboards/supply-chain/ai-strategy/charts/<chart_id>`.
...
```
GET /api/v1/holy/dashboards/supply-chain/ai-strategy
  → {tiles: [...], charts: [...], filters: {...}, refreshed_at}

GET /api/v1/holy/dashboards/supply-chain/ai-strategy/charts/<chart_id>
...
- Frontend route: `/holy/supply-chain/dashboard?role=ai-strategy`
