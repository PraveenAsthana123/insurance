# Claims — system-architect Reports

Per global §64.37 — role-scoped reports (≥ 3 standard per role).

## Standard reports

### R1 — Claims system-architect digest
...
## API
```
GET  /api/v1/insur/reports/claims/system-architect
POST /api/v1/insur/reports/claims/system-architect/{report_id}/run
```
