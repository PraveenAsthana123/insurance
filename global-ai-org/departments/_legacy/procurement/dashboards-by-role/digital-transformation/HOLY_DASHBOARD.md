# HOLY Beverage — Procurement — Digital Transformation Dashboard

> Per global CLAUDE.md §64.37 — every (dept, role) pair MUST have a
> role-scoped dashboard. This is the dashboard for **digital-transformation** in **procurement**.

## Persona

The **digital-transformation** at Procurement. They use this dashboard
...
returned by backend `GET /api/v1/holy/dashboards/procurement/digital-transformation/charts/<chart_id>`.
...
```
GET /api/v1/holy/dashboards/procurement/digital-transformation
  → {tiles: [...], charts: [...], filters: {...}, refreshed_at}

GET /api/v1/holy/dashboards/procurement/digital-transformation/charts/<chart_id>
...
- Frontend route: `/holy/procurement/dashboard?role=digital-transformation`
