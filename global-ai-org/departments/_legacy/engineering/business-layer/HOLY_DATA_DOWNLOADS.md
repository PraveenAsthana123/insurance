# HOLY Beverage — Engineering — Data Downloads
...
|---|---|---|---|---|---|
| 1 | `engineering_primary_sample` | Engineering primary use-case sample | tabular | 5 | 5 |
...
### 3.x `engineering_primary_sample`

- **Title:** Engineering primary use-case sample
- **Lifecycle:** tabular
...
| Endpoint | Returns |
|---|---|
| `GET /api/v1/holy/downloads/engineering` | Catalog (datasets + URLs) |
| `GET /api/v1/holy/downloads/engineering/<dataset_id>.csv` | CSV file |
| `GET /api/v1/holy/downloads/engineering/<dataset_id>.json` | JSON file |
| `GET /api/v1/holy/downloads/engineering/<dataset_id>.before.svg` | Pre-process viz |
| `GET /api/v1/holy/downloads/engineering/<dataset_id>.after.svg` | Post-process viz |
