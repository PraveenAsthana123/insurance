# HOLY Beverage — Security Operations — Data Type: IMAGE
...
Quality inspection / OCR / classification / detection
...
Recommended role: `manufacturing / engineering`
(see `../../roles/manufacturing/HOLY_README.md`)

## Reference pipeline

`backend/ml/reference/cv_lifecycle.py`

Common libraries: pillow, opencv-python, torchvision, scikit-image
...
- augmented thumbnails + per-class predictions + saliency overlay
