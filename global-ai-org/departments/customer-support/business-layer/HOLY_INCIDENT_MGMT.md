# HOLY Beverage — Customer Support — Incident Management (L1/L2/L3 + RAG)
...
|---|---|---|---|---|
| 1 | _stub: replace with real L1 issue for customer-support_ | runbook URL | < 1 min | < 5 min |
...
- RAG corpus: `data/customer-support/runbooks/` + `data/customer-support/past-incidents/`
