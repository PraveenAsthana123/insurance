...
test.describe('manufacturing smoke tests', () => {
  test('HOLY nav page for manufacturing loads', async ({ page }) => {
    await page.goto('http://localhost:3000/holy/manufacturing');
    await expect(page).toHaveURL(/\/holy\/manufacturing/);
