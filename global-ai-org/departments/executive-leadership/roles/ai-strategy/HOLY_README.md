# Executive Leadership — Ai Strategy (HOLY)

**Source:** operator brief 2026-05-21.

## Role focus in this department

AI prioritization + investment + roadmap for this dept

## What this role owns

AI portfolio, ROI tracking, build-vs-buy decisions
...
- `../dashboards-by-role/ai-strategy/` — role-scoped dashboards (when authored)
- `../reports-by-role/ai-strategy/` — role-scoped reports (when authored)
