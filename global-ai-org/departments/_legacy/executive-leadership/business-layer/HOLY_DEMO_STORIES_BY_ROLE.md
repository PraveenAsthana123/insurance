...
any 3-5 to assemble a Executive Leadership board demo.
...
- **demo_id**: `admin_demo`
- **Persona**: Admin (System) in Executive Leadership
- **Scenario**: Demonstrate **Tenant onboarding + RBAC drift detection** on the Executive Leadership dashboards
- **KPI moved**: Strategic decision throughput
...
- **Talking points**: "This is Admin (System)'s view of Executive Leadership. In 90 seconds we'll move Strategic decision throughput by Tenant onboarding + RBAC drift detection."
- **Success criteria** (drill-able):
  - Dashboard endpoint responds in p95 < 500ms
  - Action triggers an audit row visible in `/api/v1/holy/transactions/executive-leadership` within 30s
...
- **Persona**: Dept Manager in Executive Leadership
- **Scenario**: Demonstrate **KPI surface + approval queue + team perf** on the Executive Leadership dashboards
- **KPI moved**: Strategic decision throughput
...
- **Talking points**: "This is Dept Manager's view of Executive Leadership. In 90 seconds we'll move Strategic decision throughput by KPI surface + approval queue + team perf."
- **Success criteria** (drill-able):
  - Dashboard endpoint responds in p95 < 500ms
  - Action triggers an audit row visible in `/api/v1/holy/transactions/executive-leadership` within 30s
...
- **Persona**: Team Member in Executive Leadership
- **Scenario**: Demonstrate **My-work queue + my SLA + personal metrics** on the Executive Leadership dashboards
- **KPI moved**: Strategic decision throughput
...
- **Talking points**: "This is Team Member's view of Executive Leadership. In 90 seconds we'll move Strategic decision throughput by My-work queue + my SLA + personal metrics."
- **Success criteria** (drill-able):
  - Dashboard endpoint responds in p95 < 500ms
  - Action triggers an audit row visible in `/api/v1/holy/transactions/executive-leadership` within 30s
...
- **demo_id**: `tester_demo`
- **Persona**: QA / Tester in Executive Leadership
- **Scenario**: Demonstrate **Regression heatmap + flaky-test triage** on the Executive Leadership dashboards
- **KPI moved**: Strategic decision throughput
...
- **Talking points**: "This is QA / Tester's view of Executive Leadership. In 90 seconds we'll move Strategic decision throughput by Regression heatmap + flaky-test triage."
- **Success criteria** (drill-able):
  - Dashboard endpoint responds in p95 < 500ms
  - Action triggers an audit row visible in `/api/v1/holy/transactions/executive-leadership` within 30s
...
- **Persona**: SecOps Engineer in Executive Leadership
- **Scenario**: Demonstrate **Alert volume + MTTD/MTTR + vuln backlog** on the Executive Leadership dashboards
- **KPI moved**: Strategic decision throughput
...
- **Talking points**: "This is SecOps Engineer's view of Executive Leadership. In 90 seconds we'll move Strategic decision throughput by Alert volume + MTTD/MTTR + vuln backlog."
- **Success criteria** (drill-able):
  - Dashboard endpoint responds in p95 < 500ms
  - Action triggers an audit row visible in `/api/v1/holy/transactions/executive-leadership` within 30s
...
- **demo_id**: `devops_demo`
- **Persona**: DevOps in Executive Leadership
- **Scenario**: Demonstrate **DORA metrics + deploy frequency + cost** on the Executive Leadership dashboards
- **KPI moved**: Strategic decision throughput
...
- **Talking points**: "This is DevOps's view of Executive Leadership. In 90 seconds we'll move Strategic decision throughput by DORA metrics + deploy frequency + cost."
- **Success criteria** (drill-able):
  - Dashboard endpoint responds in p95 < 500ms
  - Action triggers an audit row visible in `/api/v1/holy/transactions/executive-leadership` within 30s
...
- **Persona**: AI Reviewer in Executive Leadership
- **Scenario**: Demonstrate **Model drift + fairness gate + override rate** on the Executive Leadership dashboards
- **KPI moved**: Strategic decision throughput
...
- **Talking points**: "This is AI Reviewer's view of Executive Leadership. In 90 seconds we'll move Strategic decision throughput by Model drift + fairness gate + override rate."
- **Success criteria** (drill-able):
  - Dashboard endpoint responds in p95 < 500ms
  - Action triggers an audit row visible in `/api/v1/holy/transactions/executive-leadership` within 30s
...
- **Persona**: DT Lead in Executive Leadership
- **Scenario**: Demonstrate **AS-IS vs TO-BE + automation % per process** on the Executive Leadership dashboards
- **KPI moved**: Strategic decision throughput
...
- **Talking points**: "This is DT Lead's view of Executive Leadership. In 90 seconds we'll move Strategic decision throughput by AS-IS vs TO-BE + automation % per process."
- **Success criteria** (drill-able):
  - Dashboard endpoint responds in p95 < 500ms
  - Action triggers an audit row visible in `/api/v1/holy/transactions/executive-leadership` within 30s
...
- **Persona**: System Architect in Executive Leadership
- **Scenario**: Demonstrate **Service health + dep graph + capacity** on the Executive Leadership dashboards
- **KPI moved**: Strategic decision throughput
...
- **Talking points**: "This is System Architect's view of Executive Leadership. In 90 seconds we'll move Strategic decision throughput by Service health + dep graph + capacity."
- **Success criteria** (drill-able):
  - Dashboard endpoint responds in p95 < 500ms
  - Action triggers an audit row visible in `/api/v1/holy/transactions/executive-leadership` within 30s
...
- **Persona**: Test Architect in Executive Leadership
- **Scenario**: Demonstrate **Test pyramid health + coverage per service** on the Executive Leadership dashboards
- **KPI moved**: Strategic decision throughput
...
- **Talking points**: "This is Test Architect's view of Executive Leadership. In 90 seconds we'll move Strategic decision throughput by Test pyramid health + coverage per service."
- **Success criteria** (drill-able):
  - Dashboard endpoint responds in p95 < 500ms
  - Action triggers an audit row visible in `/api/v1/holy/transactions/executive-leadership` within 30s
...
- **Persona**: DB Architect in Executive Leadership
- **Scenario**: Demonstrate **Slow-query list + schema drift + replication** on the Executive Leadership dashboards
- **KPI moved**: Strategic decision throughput
...
- **Talking points**: "This is DB Architect's view of Executive Leadership. In 90 seconds we'll move Strategic decision throughput by Slow-query list + schema drift + replication."
- **Success criteria** (drill-able):
  - Dashboard endpoint responds in p95 < 500ms
  - Action triggers an audit row visible in `/api/v1/holy/transactions/executive-leadership` within 30s
...
- **Persona**: API Architect in Executive Leadership
- **Scenario**: Demonstrate **API p95 + version adoption + deprecation** on the Executive Leadership dashboards
- **KPI moved**: Strategic decision throughput
...
- **Talking points**: "This is API Architect's view of Executive Leadership. In 90 seconds we'll move Strategic decision throughput by API p95 + version adoption + deprecation."
- **Success criteria** (drill-able):
  - Dashboard endpoint responds in p95 < 500ms
  - Action triggers an audit row visible in `/api/v1/holy/transactions/executive-leadership` within 30s
...
- **Persona**: Data Owner in Executive Leadership
- **Scenario**: Demonstrate **Data quality + lineage + freshness SLA** on the Executive Leadership dashboards
- **KPI moved**: Strategic decision throughput
...
- **Talking points**: "This is Data Owner's view of Executive Leadership. In 90 seconds we'll move Strategic decision throughput by Data quality + lineage + freshness SLA."
- **Success criteria** (drill-able):
  - Dashboard endpoint responds in p95 < 500ms
  - Action triggers an audit row visible in `/api/v1/holy/transactions/executive-leadership` within 30s
...
- **Persona**: AI Strategy Lead in Executive Leadership
- **Scenario**: Demonstrate **Automation backlog + ROI vs plan** on the Executive Leadership dashboards
- **KPI moved**: Strategic decision throughput
...
- **Talking points**: "This is AI Strategy Lead's view of Executive Leadership. In 90 seconds we'll move Strategic decision throughput by Automation backlog + ROI vs plan."
- **Success criteria** (drill-able):
  - Dashboard endpoint responds in p95 < 500ms
  - Action triggers an audit row visible in `/api/v1/holy/transactions/executive-leadership` within 30s
...
- **Persona**: InfoSec / CISO Office in Executive Leadership
- **Scenario**: Demonstrate **Compliance gates + CVE backlog + 3rd-party risk** on the Executive Leadership dashboards
- **KPI moved**: Strategic decision throughput
...
- **Talking points**: "This is InfoSec / CISO Office's view of Executive Leadership. In 90 seconds we'll move Strategic decision throughput by Compliance gates + CVE backlog + 3rd-party risk."
- **Success criteria** (drill-able):
  - Dashboard endpoint responds in p95 < 500ms
  - Action triggers an audit row visible in `/api/v1/holy/transactions/executive-leadership` within 30s
...
| Endpoint | Returns |
|---|---|
| `GET /api/v1/holy/demo-stories/executive-leadership` | All 15 role demos |
| `GET /api/v1/holy/demo-stories/executive-leadership/<role>` | Single role demo detail |
