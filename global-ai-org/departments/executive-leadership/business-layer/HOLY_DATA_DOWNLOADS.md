# HOLY Beverage — Executive Leadership — Data Downloads
...
|---|---|---|---|---|---|
| 1 | `executive_leadership_primary_sample` | Executive Leadership primary use-case sample | tabular | 5 | 5 |
...
### 3.x `executive_leadership_primary_sample`

- **Title:** Executive Leadership primary use-case sample
- **Lifecycle:** tabular
...
| Endpoint | Returns |
|---|---|
| `GET /api/v1/holy/downloads/executive-leadership` | Catalog (datasets + URLs) |
| `GET /api/v1/holy/downloads/executive-leadership/<dataset_id>.csv` | CSV file |
| `GET /api/v1/holy/downloads/executive-leadership/<dataset_id>.json` | JSON file |
| `GET /api/v1/holy/downloads/executive-leadership/<dataset_id>.before.svg` | Pre-process viz |
| `GET /api/v1/holy/downloads/executive-leadership/<dataset_id>.after.svg` | Post-process viz |
