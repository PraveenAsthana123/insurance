# HOLY Beverage — Procurement — Information Security Dashboard

> Per global CLAUDE.md §64.37 — every (dept, role) pair MUST have a
> role-scoped dashboard. This is the dashboard for **information-security** in **procurement**.

## Persona

The **information-security** at Procurement. They use this dashboard
...
returned by backend `GET /api/v1/holy/dashboards/procurement/information-security/charts/<chart_id>`.
...
```
GET /api/v1/holy/dashboards/procurement/information-security
  → {tiles: [...], charts: [...], filters: {...}, refreshed_at}

GET /api/v1/holy/dashboards/procurement/information-security/charts/<chart_id>
...
- Frontend route: `/holy/procurement/dashboard?role=information-security`
