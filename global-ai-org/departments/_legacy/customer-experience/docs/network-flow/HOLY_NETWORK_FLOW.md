# HOLY Beverage — Customer Experience Network Flow
...
```
Customer Experience API ──HTTP──► Auth Service           (RBAC + ABAC checks)
...
```
Customer Experience API ──HTTPS──► Vendor APIs            (Salesforce / SAP / etc.)
...
─────────────                  ───────────────          ──────────
Frontend UI       ──►          customer-experience_user_events       analytics-svc
Backend API       ──►          customer-experience_audit              audit-store
ML Worker         ──►          customer-experience_predictions        prediction-store
Drift detector    ──►          customer-experience_alerts             on-call PagerDuty
...
|---|---|---|---|
| customer-experience-api | postgresql | 5432 | TCP |
| customer-experience-api | redis | 6379 | TCP |
| customer-experience-api | ollama | 11434 | TCP |
| customer-experience-api | otel-collector | 4317 | gRPC |
| customer-experience-api | (other dept APIs) | 8000 | HTTP via service mesh |
