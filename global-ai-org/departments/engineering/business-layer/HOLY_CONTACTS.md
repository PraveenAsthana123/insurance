# HOLY Beverage — Engineering — Contact Management (customer + vendor + internal)
...
- Sync: scheduled inbound from engineering's CRM / ERP / HRIS
...
|---|---|---|
| GET /api/v1/holy/contacts/engineering/customers | list | manager / data-owner |
| GET /api/v1/holy/contacts/engineering/vendors | list | manager / procurement |
| GET /api/v1/holy/contacts/engineering/internal | list | any dept role |
| POST /api/v1/holy/contacts/engineering/customers | create | admin / manager |
| PUT /api/v1/holy/contacts/engineering/customers/{id} | update | admin / data-owner |
| DELETE /api/v1/holy/contacts/engineering/customers/{id} | soft-delete | admin |
