# Product Rd — Digital Transformation (HOLY)
...
## How this role uses HOLY's Product Rd platform

- **Navigates** via `HOLY_NAV.json` (left-sidebar process picker; see `/holy/product-rd` in frontend)
...
GenAI, Bayesian Optimization, Knowledge Graph AI, NLP, RAG

## Tech stack this role touches

- Python + scikit-learn + optuna
- RDKit for cheminformatics
- Neo4j for ingredient knowledge graph
- OpenAI / Anthropic for GenAI
