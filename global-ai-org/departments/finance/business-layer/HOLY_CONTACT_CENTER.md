# HOLY Beverage — Finance — Contact Center Automation
...
**Manager** + **CX role** (dept = finance). For non-CX depts this covers
...
|---|---|---|---|---|
| 1 | _stub: replace with real intent for finance_ | _ | yes/no | DistilBERT |
| … | (20 total minimum) | | | |
...
- LLM model: `gemma3:4b` (default for finance) — adjust per latency/cost SLO
- RAG corpus: `data/finance/kb/` + `data/finance/sops/`
