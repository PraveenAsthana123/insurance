# HOLY Beverage — Procurement — Manager Dashboard

> Per global CLAUDE.md §64.37 — every (dept, role) pair MUST have a
> role-scoped dashboard. This is the dashboard for **manager** in **procurement**.

## Persona

The **manager** at Procurement. They use this dashboard
...
returned by backend `GET /api/v1/holy/dashboards/procurement/manager/charts/<chart_id>`.
...
```
GET /api/v1/holy/dashboards/procurement/manager
  → {tiles: [...], charts: [...], filters: {...}, refreshed_at}

GET /api/v1/holy/dashboards/procurement/manager/charts/<chart_id>
...
- Frontend route: `/holy/procurement/dashboard?role=manager`
