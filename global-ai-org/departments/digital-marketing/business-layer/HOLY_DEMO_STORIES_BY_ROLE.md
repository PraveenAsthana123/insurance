...
any 3-5 to assemble a Digital Marketing board demo.
...
- **demo_id**: `admin_demo`
- **Persona**: Admin (System) in Digital Marketing
- **Scenario**: Demonstrate **Tenant onboarding + RBAC drift detection** on the Digital Marketing dashboards
- **KPI moved**: CAC + attribution accuracy
...
- **Talking points**: "This is Admin (System)'s view of Digital Marketing. In 90 seconds we'll move CAC + attribution accuracy by Tenant onboarding + RBAC drift detection."
- **Success criteria** (drill-able):
  - Dashboard endpoint responds in p95 < 500ms
  - Action triggers an audit row visible in `/api/v1/holy/transactions/digital-marketing` within 30s
...
- **Persona**: Dept Manager in Digital Marketing
- **Scenario**: Demonstrate **KPI surface + approval queue + team perf** on the Digital Marketing dashboards
- **KPI moved**: CAC + attribution accuracy
...
- **Talking points**: "This is Dept Manager's view of Digital Marketing. In 90 seconds we'll move CAC + attribution accuracy by KPI surface + approval queue + team perf."
- **Success criteria** (drill-able):
  - Dashboard endpoint responds in p95 < 500ms
  - Action triggers an audit row visible in `/api/v1/holy/transactions/digital-marketing` within 30s
...
- **Persona**: Team Member in Digital Marketing
- **Scenario**: Demonstrate **My-work queue + my SLA + personal metrics** on the Digital Marketing dashboards
- **KPI moved**: CAC + attribution accuracy
...
- **Talking points**: "This is Team Member's view of Digital Marketing. In 90 seconds we'll move CAC + attribution accuracy by My-work queue + my SLA + personal metrics."
- **Success criteria** (drill-able):
  - Dashboard endpoint responds in p95 < 500ms
  - Action triggers an audit row visible in `/api/v1/holy/transactions/digital-marketing` within 30s
...
- **demo_id**: `tester_demo`
- **Persona**: QA / Tester in Digital Marketing
- **Scenario**: Demonstrate **Regression heatmap + flaky-test triage** on the Digital Marketing dashboards
- **KPI moved**: CAC + attribution accuracy
...
- **Talking points**: "This is QA / Tester's view of Digital Marketing. In 90 seconds we'll move CAC + attribution accuracy by Regression heatmap + flaky-test triage."
- **Success criteria** (drill-able):
  - Dashboard endpoint responds in p95 < 500ms
  - Action triggers an audit row visible in `/api/v1/holy/transactions/digital-marketing` within 30s
...
- **Persona**: SecOps Engineer in Digital Marketing
- **Scenario**: Demonstrate **Alert volume + MTTD/MTTR + vuln backlog** on the Digital Marketing dashboards
- **KPI moved**: CAC + attribution accuracy
...
- **Talking points**: "This is SecOps Engineer's view of Digital Marketing. In 90 seconds we'll move CAC + attribution accuracy by Alert volume + MTTD/MTTR + vuln backlog."
- **Success criteria** (drill-able):
  - Dashboard endpoint responds in p95 < 500ms
  - Action triggers an audit row visible in `/api/v1/holy/transactions/digital-marketing` within 30s
...
- **demo_id**: `devops_demo`
- **Persona**: DevOps in Digital Marketing
- **Scenario**: Demonstrate **DORA metrics + deploy frequency + cost** on the Digital Marketing dashboards
- **KPI moved**: CAC + attribution accuracy
...
- **Talking points**: "This is DevOps's view of Digital Marketing. In 90 seconds we'll move CAC + attribution accuracy by DORA metrics + deploy frequency + cost."
- **Success criteria** (drill-able):
  - Dashboard endpoint responds in p95 < 500ms
  - Action triggers an audit row visible in `/api/v1/holy/transactions/digital-marketing` within 30s
...
- **Persona**: AI Reviewer in Digital Marketing
- **Scenario**: Demonstrate **Model drift + fairness gate + override rate** on the Digital Marketing dashboards
- **KPI moved**: CAC + attribution accuracy
...
- **Talking points**: "This is AI Reviewer's view of Digital Marketing. In 90 seconds we'll move CAC + attribution accuracy by Model drift + fairness gate + override rate."
- **Success criteria** (drill-able):
  - Dashboard endpoint responds in p95 < 500ms
  - Action triggers an audit row visible in `/api/v1/holy/transactions/digital-marketing` within 30s
...
- **Persona**: DT Lead in Digital Marketing
- **Scenario**: Demonstrate **AS-IS vs TO-BE + automation % per process** on the Digital Marketing dashboards
- **KPI moved**: CAC + attribution accuracy
...
- **Talking points**: "This is DT Lead's view of Digital Marketing. In 90 seconds we'll move CAC + attribution accuracy by AS-IS vs TO-BE + automation % per process."
- **Success criteria** (drill-able):
  - Dashboard endpoint responds in p95 < 500ms
  - Action triggers an audit row visible in `/api/v1/holy/transactions/digital-marketing` within 30s
...
- **Persona**: System Architect in Digital Marketing
- **Scenario**: Demonstrate **Service health + dep graph + capacity** on the Digital Marketing dashboards
- **KPI moved**: CAC + attribution accuracy
...
- **Talking points**: "This is System Architect's view of Digital Marketing. In 90 seconds we'll move CAC + attribution accuracy by Service health + dep graph + capacity."
- **Success criteria** (drill-able):
  - Dashboard endpoint responds in p95 < 500ms
  - Action triggers an audit row visible in `/api/v1/holy/transactions/digital-marketing` within 30s
...
- **Persona**: Test Architect in Digital Marketing
- **Scenario**: Demonstrate **Test pyramid health + coverage per service** on the Digital Marketing dashboards
- **KPI moved**: CAC + attribution accuracy
...
- **Talking points**: "This is Test Architect's view of Digital Marketing. In 90 seconds we'll move CAC + attribution accuracy by Test pyramid health + coverage per service."
- **Success criteria** (drill-able):
  - Dashboard endpoint responds in p95 < 500ms
  - Action triggers an audit row visible in `/api/v1/holy/transactions/digital-marketing` within 30s
...
- **Persona**: DB Architect in Digital Marketing
- **Scenario**: Demonstrate **Slow-query list + schema drift + replication** on the Digital Marketing dashboards
- **KPI moved**: CAC + attribution accuracy
...
- **Talking points**: "This is DB Architect's view of Digital Marketing. In 90 seconds we'll move CAC + attribution accuracy by Slow-query list + schema drift + replication."
- **Success criteria** (drill-able):
  - Dashboard endpoint responds in p95 < 500ms
  - Action triggers an audit row visible in `/api/v1/holy/transactions/digital-marketing` within 30s
...
- **Persona**: API Architect in Digital Marketing
- **Scenario**: Demonstrate **API p95 + version adoption + deprecation** on the Digital Marketing dashboards
- **KPI moved**: CAC + attribution accuracy
...
- **Talking points**: "This is API Architect's view of Digital Marketing. In 90 seconds we'll move CAC + attribution accuracy by API p95 + version adoption + deprecation."
- **Success criteria** (drill-able):
  - Dashboard endpoint responds in p95 < 500ms
  - Action triggers an audit row visible in `/api/v1/holy/transactions/digital-marketing` within 30s
...
- **Persona**: Data Owner in Digital Marketing
- **Scenario**: Demonstrate **Data quality + lineage + freshness SLA** on the Digital Marketing dashboards
- **KPI moved**: CAC + attribution accuracy
...
- **Talking points**: "This is Data Owner's view of Digital Marketing. In 90 seconds we'll move CAC + attribution accuracy by Data quality + lineage + freshness SLA."
- **Success criteria** (drill-able):
  - Dashboard endpoint responds in p95 < 500ms
  - Action triggers an audit row visible in `/api/v1/holy/transactions/digital-marketing` within 30s
...
- **Persona**: AI Strategy Lead in Digital Marketing
- **Scenario**: Demonstrate **Automation backlog + ROI vs plan** on the Digital Marketing dashboards
- **KPI moved**: CAC + attribution accuracy
...
- **Talking points**: "This is AI Strategy Lead's view of Digital Marketing. In 90 seconds we'll move CAC + attribution accuracy by Automation backlog + ROI vs plan."
- **Success criteria** (drill-able):
  - Dashboard endpoint responds in p95 < 500ms
  - Action triggers an audit row visible in `/api/v1/holy/transactions/digital-marketing` within 30s
...
- **Persona**: InfoSec / CISO Office in Digital Marketing
- **Scenario**: Demonstrate **Compliance gates + CVE backlog + 3rd-party risk** on the Digital Marketing dashboards
- **KPI moved**: CAC + attribution accuracy
...
- **Talking points**: "This is InfoSec / CISO Office's view of Digital Marketing. In 90 seconds we'll move CAC + attribution accuracy by Compliance gates + CVE backlog + 3rd-party risk."
- **Success criteria** (drill-able):
  - Dashboard endpoint responds in p95 < 500ms
  - Action triggers an audit row visible in `/api/v1/holy/transactions/digital-marketing` within 30s
...
| Endpoint | Returns |
|---|---|
| `GET /api/v1/holy/demo-stories/digital-marketing` | All 15 role demos |
| `GET /api/v1/holy/demo-stories/digital-marketing/<role>` | Single role demo detail |
