# HOLY Beverage — Security Operations — Data Type: VIDEO
...
Surveillance / footfall analytics / object tracking
...
Recommended role: `retail-operations / security-operations`
(see `../../roles/retail-operations/HOLY_README.md`)

## Reference pipeline

`(to-build) backend/ml/reference/video_lifecycle.py`

Common libraries: opencv-python, decord, ffmpeg-python, ultralytics (YOLO)
...
- keyframe strip (every Nth frame)
...
- bounding-box overlays + tracking IDs + per-frame counts
