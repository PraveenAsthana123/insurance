# §140 · engineering × small-data-fewshot · Use Case Spec

## Purpose
Cross-cutting fit · ML technique applied to engineering domain.
...
## Example use case
Engineering use case applying small-data-fewshot to few labels.
