# HOLY Beverage — Engineering — Information Security Dashboard

> Per global CLAUDE.md §64.37 — every (dept, role) pair MUST have a
> role-scoped dashboard. This is the dashboard for **information-security** in **engineering**.

## Persona

The **information-security** at Engineering. They use this dashboard
...
returned by backend `GET /api/v1/holy/dashboards/engineering/information-security/charts/<chart_id>`.
...
```
GET /api/v1/holy/dashboards/engineering/information-security
  → {tiles: [...], charts: [...], filters: {...}, refreshed_at}

GET /api/v1/holy/dashboards/engineering/information-security/charts/<chart_id>
...
- Frontend route: `/holy/engineering/dashboard?role=information-security`
