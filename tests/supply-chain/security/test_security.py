"""Tier 11-12 — Security tests for supply-chain.
...
def test_supply_chain_owasp_zap_scan():
    """REPLACE — invoke OWASP ZAP CLI against supply-chain surface (auth env only)."""
    pass


@pytest.mark.skip(reason="placeholder — requires Garak install + AI endpoint")
def test_supply_chain_garak_prompt_injection():
