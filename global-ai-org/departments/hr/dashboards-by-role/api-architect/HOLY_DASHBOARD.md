# HOLY Beverage — Hr — Api Architect Dashboard

> Per global CLAUDE.md §64.37 — every (dept, role) pair MUST have a
> role-scoped dashboard. This is the dashboard for **api-architect** in **hr**.

## Persona

The **api-architect** at Hr. They use this dashboard
...
returned by backend `GET /api/v1/holy/dashboards/hr/api-architect/charts/<chart_id>`.
...
```
GET /api/v1/holy/dashboards/hr/api-architect
  → {tiles: [...], charts: [...], filters: {...}, refreshed_at}

GET /api/v1/holy/dashboards/hr/api-architect/charts/<chart_id>
...
- Frontend route: `/holy/hr/dashboard?role=api-architect`
