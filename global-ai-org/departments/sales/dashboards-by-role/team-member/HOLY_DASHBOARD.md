# HOLY Beverage — Sales — Team Member Dashboard

> Per global CLAUDE.md §64.37 — every (dept, role) pair MUST have a
> role-scoped dashboard. This is the dashboard for **team-member** in **sales**.

## Persona

The **team-member** at Sales. They use this dashboard
...
returned by backend `GET /api/v1/holy/dashboards/sales/team-member/charts/<chart_id>`.
...
```
GET /api/v1/holy/dashboards/sales/team-member
  → {tiles: [...], charts: [...], filters: {...}, refreshed_at}

GET /api/v1/holy/dashboards/sales/team-member/charts/<chart_id>
...
- Frontend route: `/holy/sales/dashboard?role=team-member`
