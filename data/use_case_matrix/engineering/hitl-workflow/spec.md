# §140 · engineering × hitl-workflow · Use Case Spec

## Purpose
Cross-cutting fit · Ops technique applied to engineering domain.
...
## Example use case
Engineering use case applying hitl-workflow to review queue.
