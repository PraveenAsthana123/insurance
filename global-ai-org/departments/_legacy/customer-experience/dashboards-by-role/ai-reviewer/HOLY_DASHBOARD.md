# HOLY Beverage — Customer Experience — Ai Reviewer Dashboard

> Per global CLAUDE.md §64.37 — every (dept, role) pair MUST have a
> role-scoped dashboard. This is the dashboard for **ai-reviewer** in **customer-experience**.

## Persona

The **ai-reviewer** at Customer Experience. They use this dashboard
...
returned by backend `GET /api/v1/holy/dashboards/customer-experience/ai-reviewer/charts/<chart_id>`.
...
```
GET /api/v1/holy/dashboards/customer-experience/ai-reviewer
  → {tiles: [...], charts: [...], filters: {...}, refreshed_at}

GET /api/v1/holy/dashboards/customer-experience/ai-reviewer/charts/<chart_id>
...
- Frontend route: `/holy/customer-experience/dashboard?role=ai-reviewer`
