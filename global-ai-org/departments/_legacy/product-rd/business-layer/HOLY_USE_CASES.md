# HOLY Beverage — Product Rd — AI Use-Case Catalog
...
> use cases for **product-rd**. Implementation status tracked per current
> codebase state.
...
## 2. Product Rd-Specific Use Cases

| Use Case | Category | Data Types | AI Area | Business Value | Status |
|---|---|---|---|---|---|
| Literature Search (RAG) | R&D | papers/PDFs | RAG + NLP | Faster research | ✅ rag_lifecycle.py |
| Recipe / Formulation Optimization | R&D | experiment data | Bayesian Opt | Less trial-and-error | ❌ deferred (BoTorch) |
| Sensory Panel AI | R&D | panel ratings | Stats + ML | Faster product dev | 🟡 full_lifecycle.py applies |
| Competitive Scan AI | R&D | web/news | NLP + Summarization | Market awareness | 🟡 nlp_lifecycle.py applies |
