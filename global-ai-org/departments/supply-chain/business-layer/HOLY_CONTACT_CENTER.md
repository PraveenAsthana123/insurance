# HOLY Beverage — Supply Chain — Contact Center Automation
...
**Manager** + **CX role** (dept = supply-chain). For non-CX depts this covers
...
|---|---|---|---|---|
| 1 | _stub: replace with real intent for supply-chain_ | _ | yes/no | DistilBERT |
| … | (20 total minimum) | | | |
...
- LLM model: `gemma3:4b` (default for supply-chain) — adjust per latency/cost SLO
- RAG corpus: `data/supply-chain/kb/` + `data/supply-chain/sops/`
