# §140 · customer-support × small-data-fewshot · Use Case Spec

## Purpose
PRIMARY fit · ML technique applied to customer-support domain.
...
## Example use case
Cold-start: new product line FAQ embedding match.
