# HOLY Beverage — Product Rd — Input Data Mgmt + Before/After Viz
...
For every process AND sub-process in this dept (product-rd), populate the 6
surfaces below. literature + lab + sensory is the primary data class for product-rd.
...
Plots land in: `data/eval/product-rd/<pipeline>/<run_id>/plots/before_*.png`
...
Plots land in: `data/eval/product-rd/<pipeline>/<run_id>/plots/after_*.png`
