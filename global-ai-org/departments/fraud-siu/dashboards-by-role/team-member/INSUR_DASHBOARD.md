# Fraud / Special Investigations Unit (SIU) — team-member Dashboard

Per global §64.37 — role-scoped dashboard.

## Persona
**team-member** in Fraud / Special Investigations Unit (SIU).

## Focus
Personal queue, my tickets/cases, my SLA
...
## API
```
GET /api/v1/insur/dashboards/fraud-siu/team-member
```
