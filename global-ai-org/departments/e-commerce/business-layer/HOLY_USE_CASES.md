# HOLY Beverage — E Commerce — AI Use-Case Catalog
...
> use cases for **e-commerce**. Implementation status tracked per current
> codebase state.
...
|---|---|---|
| ✅ Implemented | **16** of 31 | Working module exists in `backend/ml/reference/*.py` (drill-locked) |
...
## 2. E Commerce-Specific Use Cases

| Use Case | Category | Data Types | AI Area | Business Value | Status |
|---|---|---|---|---|---|
| Recommendation Engine (CF + Hybrid) | E-commerce | purchase history | Recommendation | Higher AOV/CTR | ✅ recommendation_lifecycle.py (hybrid wins) |
| Personalization AI | E-commerce | session | Recommendation | Higher conversion | 🟡 recommendation_lifecycle.py + session features |
| Cart-Abandonment Prediction | E-commerce | session | Classification | Higher recovery | 🟡 full_lifecycle.py classification applies |
| Fraud Detection (Payment) | E-commerce | transactions | Fraud ML | Less chargebacks | ✅ fraud_lifecycle.py |
