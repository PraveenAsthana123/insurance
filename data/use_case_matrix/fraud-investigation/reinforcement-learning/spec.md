# §140 · fraud-investigation × reinforcement-learning · Use Case Spec

## Purpose
PRIMARY fit · RL technique applied to fraud-investigation domain.
...
## Example use case
Sequential investigation routing (next-action policy).
