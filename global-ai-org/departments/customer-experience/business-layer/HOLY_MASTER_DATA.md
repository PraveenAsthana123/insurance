# HOLY Beverage — Customer Experience — Master Data

> Per operator 2026-05-24 — every dept publishes its master + reference
> data here. Focus: **customer-master + ticket-categories + CSAT-segments**.
...
This dept (**customer-experience**) operates against the slice of the structure
...
| Endpoint | Returns |
|---|---|
| `GET /api/v1/holy/master-data/customer-experience` | Schema catalog + per-entity owner |
| `GET /api/v1/holy/master-data/customer-experience/customer?limit=20` | Customer master sample |
| `GET /api/v1/holy/master-data/customer-experience/vendor?limit=20` | Vendor master sample |
| `GET /api/v1/holy/master-data/customer-experience/product?limit=20` | Product master sample |
| `GET /api/v1/holy/master-data/customer-experience/org-structure` | Org tree slice for this dept |
...
1. (+) `/api/v1/holy/master-data/customer-experience` returns 200 + entity catalog
