# HOLY Beverage — Procurement — AS-IS Process Assessment
...
This document is the **input to the AI strategy planning** for Procurement.
...
|---|---|---|---|---|---|---|---|---|
| 1 | Manual contract review | 16 hrs/wk | High | $400K/yr | Legal + buyer overload | Slow | +30-day cycle | Word + email |
| 2 | Manual vendor onboarding | 20 hrs/wk | Med | $300K/yr | Buyer overhead | Slow | Stale vendor DB | Spreadsheet + email |
| 3 | Manual invoice-PO matching | 30 hrs/wk | High | $500K/yr | AP team overload | Error-prone | −25% on-time pay | Manual match |
| 4 | Reactive supplier risk monitoring | 8 hrs/wk | High | $5M/yr risk | Risk team burnout | Quarterly | Missed crises | News scan |
| 5 | Manual spend categorization | 24 hrs/wk | High | $200K/yr | Analyst overload | Inconsistent taxonomy | Bad insights | Excel |
...
4. **Measure** via the persona's main KPI: Maverick spend %, contract compliance %, annual savings, supplier risk score
