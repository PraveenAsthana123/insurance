# HOLY Beverage — Legal — Incident Management (L1/L2/L3 + RAG)
...
|---|---|---|---|---|
| 1 | _stub: replace with real L1 issue for legal_ | runbook URL | < 1 min | < 5 min |
...
- RAG corpus: `data/legal/runbooks/` + `data/legal/past-incidents/`
