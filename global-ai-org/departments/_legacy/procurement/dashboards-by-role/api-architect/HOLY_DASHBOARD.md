# HOLY Beverage — Procurement — Api Architect Dashboard

> Per global CLAUDE.md §64.37 — every (dept, role) pair MUST have a
> role-scoped dashboard. This is the dashboard for **api-architect** in **procurement**.

## Persona

The **api-architect** at Procurement. They use this dashboard
...
returned by backend `GET /api/v1/holy/dashboards/procurement/api-architect/charts/<chart_id>`.
...
```
GET /api/v1/holy/dashboards/procurement/api-architect
  → {tiles: [...], charts: [...], filters: {...}, refreshed_at}

GET /api/v1/holy/dashboards/procurement/api-architect/charts/<chart_id>
...
- Frontend route: `/holy/procurement/dashboard?role=api-architect`
