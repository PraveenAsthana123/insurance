# Underwriting — tester Reports

Per global §64.37 — role-scoped reports (≥ 3 standard per role).

## Standard reports

### R1 — Underwriting tester digest
...
## API
```
GET  /api/v1/insur/reports/underwriting/tester
POST /api/v1/insur/reports/underwriting/tester/{report_id}/run
```
