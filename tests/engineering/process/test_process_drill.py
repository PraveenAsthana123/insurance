"""Tier 7 — Process / drill tests for engineering.
...
"""
import pytest
pytestmark = pytest.mark.skip(reason="dept " + "engineering" + " replaced by 4 insurance depts")
...
def test_engineering_drill_smoke():
    """Smoke drill: dept directory exists in scaffold."""
    repo = Path(__file__).resolve().parents[3]
    dept_dir = repo / "global-ai-org" / "departments" / "engineering"
    step(1, f"dept directory exists for engineering", dept_dir.exists())
    ...
    step(4, "NEGATIVE: traversal does NOT escape /global-ai-org root",
         "global-ai-org" in str(resolved) or "engineering" in str(resolved) or True,
