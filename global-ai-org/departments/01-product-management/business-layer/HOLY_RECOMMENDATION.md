# HOLY_RECOMMENDATION.md · Dept 1 · product-management
...
Recommendation system for Dept 1 (product-management). All 3 classical flavors covered per §64.22.

## Item-based (collaborative filter)

**Algorithm**: Two-tower NN · feature × spec
...
**Algorithm**: Spec embedding similarity (sentence-transformer)
...
**Algorithm**: LightGBM rerank over CF + content
