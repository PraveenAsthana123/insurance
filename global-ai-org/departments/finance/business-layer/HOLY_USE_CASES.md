# HOLY Beverage — Finance — AI Use-Case Catalog
...
> use cases for **finance**. Implementation status tracked per current
> codebase state.
...
|---|---|---|
| ✅ Implemented | **17** of 32 | Working module exists in `backend/ml/reference/*.py` (drill-locked) |
| 🟡 Partial | **9** of 32 | Existing module applies; dept-specific stub deferred |
...
## 2. Finance-Specific Use Cases

| Use Case | Category | Data Types | AI Area | Business Value | Status |
|---|---|---|---|---|---|
| AI Forecasting | Finance AI | fin time-series | Forecasting | Better planning | ✅ timeseries_lifecycle.py |
| AI Cost Optimization (FinOps) | Finance AI | billing logs | FinOps AI | Lower cloud cost | ❌ deferred |
| Fraud Detection AI | Finance AI | transactions | Fraud ML | Less losses | ✅ fraud_lifecycle.py 4-layer |
| AML Detection AI | Banking AI | transactions | Anomaly + Fraud | Compliance | ✅ extends fraud_lifecycle.py + anomaly_lifecycle.py |
| Credit Risk AI | Banking AI | financial records | Risk Modeling | Better lending | 🟡 full_lifecycle.py classification mode |
