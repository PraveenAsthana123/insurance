"""Tier 1 — Unit tests for e-commerce.
...
def test_dept_module_imports():
    ...
    assert "e-commerce" in "e-commerce", "dept name must match"
...
@pytest.mark.skip(reason="placeholder — replace with real e-commerce unit test")
def test_real_dept_logic():
    """REPLACE — real unit test for e-commerce business logic."""
    pass
