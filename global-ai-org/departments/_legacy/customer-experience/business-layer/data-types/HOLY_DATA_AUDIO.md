# HOLY Beverage — Customer Experience — Data Type: AUDIO
...
## Applicability for customer-experience

✅ **APPLICABLE**

## Use case

Call transcription / sentiment / keyword spotting

For Customer Experience: (operator-fill — name the specific business
process this data type powers in this dept; link the relevant sub-process
in `../HOLY_PROCESS_MGMT.md`).

## Owner

Recommended role: `customer-experience / customer-support`
(see `../../roles/customer-experience/HOLY_README.md`)

## Reference pipeline

`(to-build) backend/ml/reference/audio_lifecycle.py (Whisper-based)`

Common libraries: librosa, soundfile, whisper, pyannote.audio
...
- waveform + spectrogram (mel-scale)
...
- transcript + per-segment sentiment + speaker diarization
