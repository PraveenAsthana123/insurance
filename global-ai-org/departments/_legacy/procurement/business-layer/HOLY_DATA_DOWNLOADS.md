# HOLY Beverage — Procurement — Data Downloads
...
|---|---|---|---|---|---|
| 1 | `procurement_primary_sample` | Procurement primary use-case sample | tabular | 5 | 5 |
...
### 3.x `procurement_primary_sample`

- **Title:** Procurement primary use-case sample
- **Lifecycle:** tabular
...
| Endpoint | Returns |
|---|---|
| `GET /api/v1/holy/downloads/procurement` | Catalog (datasets + URLs) |
| `GET /api/v1/holy/downloads/procurement/<dataset_id>.csv` | CSV file |
| `GET /api/v1/holy/downloads/procurement/<dataset_id>.json` | JSON file |
| `GET /api/v1/holy/downloads/procurement/<dataset_id>.before.svg` | Pre-process viz |
| `GET /api/v1/holy/downloads/procurement/<dataset_id>.after.svg` | Post-process viz |
