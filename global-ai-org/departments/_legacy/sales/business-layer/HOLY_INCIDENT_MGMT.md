# HOLY Beverage — Sales — Incident Management (L1/L2/L3 + RAG)
...
|---|---|---|---|---|
| 1 | _stub: replace with real L1 issue for sales_ | runbook URL | < 1 min | < 5 min |
...
- RAG corpus: `data/sales/runbooks/` + `data/sales/past-incidents/`
