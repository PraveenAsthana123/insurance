        ...
        <table style={{ fontSize: 11, width: '100%' }}>
          <tbody>
            {[
              ...
              ['Status', <Pill key="status" color={STATUS_COLOR[a.status] || '#94a3b8'}>{a.status}</Pill>],
              ['Version', a.version],
              ['Autonomy', a.autonomy_level],
              ['Risk', <Pill key="risk" color={a.risk_level === 'High' ? '#ef4444' : a.risk_level === 'Medium' ? '#f59e0b' : '#10b981'}>{a.risk_level}</Pill>],
              ['Model', a.model_name || '—'],
