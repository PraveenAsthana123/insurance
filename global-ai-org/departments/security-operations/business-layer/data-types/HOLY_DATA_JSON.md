# HOLY Beverage — Security Operations — Data Type: JSON
...
API event ingestion → flattened ML / NoSQL audit
...
Recommended role: `api-architect`
(see `../../roles/api-architect/HOLY_README.md`)

## Reference pipeline

`backend/ml/reference/full_lifecycle.py (after JSON flattening)`

Common libraries: json, jq, pandas.json_normalize, jsonschema
...
- flattened columns + null-rate per field + schema-conformance %
