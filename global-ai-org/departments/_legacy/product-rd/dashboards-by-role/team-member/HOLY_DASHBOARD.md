# HOLY Beverage — Product Rd — Team Member Dashboard

> Per global CLAUDE.md §64.37 — every (dept, role) pair MUST have a
> role-scoped dashboard. This is the dashboard for **team-member** in **product-rd**.

## Persona

The **team-member** at Product Rd. They use this dashboard
...
returned by backend `GET /api/v1/holy/dashboards/product-rd/team-member/charts/<chart_id>`.
...
```
GET /api/v1/holy/dashboards/product-rd/team-member
  → {tiles: [...], charts: [...], filters: {...}, refreshed_at}

GET /api/v1/holy/dashboards/product-rd/team-member/charts/<chart_id>
...
- Frontend route: `/holy/product-rd/dashboard?role=team-member`
