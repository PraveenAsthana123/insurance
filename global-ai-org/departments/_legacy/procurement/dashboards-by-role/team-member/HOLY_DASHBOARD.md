# HOLY Beverage — Procurement — Team Member Dashboard

> Per global CLAUDE.md §64.37 — every (dept, role) pair MUST have a
> role-scoped dashboard. This is the dashboard for **team-member** in **procurement**.

## Persona

The **team-member** at Procurement. They use this dashboard
...
returned by backend `GET /api/v1/holy/dashboards/procurement/team-member/charts/<chart_id>`.
...
```
GET /api/v1/holy/dashboards/procurement/team-member
  → {tiles: [...], charts: [...], filters: {...}, refreshed_at}

GET /api/v1/holy/dashboards/procurement/team-member/charts/<chart_id>
...
- Frontend route: `/holy/procurement/dashboard?role=team-member`
