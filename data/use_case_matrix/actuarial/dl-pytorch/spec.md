# §140 · actuarial × dl-pytorch · Use Case Spec

## Purpose
Cross-cutting fit · DL technique applied to actuarial domain.
...
## Example use case
Actuarial use case applying dl-pytorch to tabular/imgs.
