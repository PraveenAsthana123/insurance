# HOLY Beverage — Finance — Manager Dashboard

> Per global CLAUDE.md §64.37 — every (dept, role) pair MUST have a
> role-scoped dashboard. This is the dashboard for **manager** in **finance**.

## Persona

The **manager** at Finance. They use this dashboard
...
returned by backend `GET /api/v1/holy/dashboards/finance/manager/charts/<chart_id>`.
...
```
GET /api/v1/holy/dashboards/finance/manager
  → {tiles: [...], charts: [...], filters: {...}, refreshed_at}

GET /api/v1/holy/dashboards/finance/manager/charts/<chart_id>
...
- Frontend route: `/holy/finance/dashboard?role=manager`
