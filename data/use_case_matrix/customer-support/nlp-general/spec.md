# §140 · customer-support × nlp-general · Use Case Spec

## Purpose
PRIMARY fit · NLP technique applied to customer-support domain.
...
## Example use case
Customer Support use case applying nlp-general to text.
