# HOLY Beverage — E Commerce — Tester Dashboard

> Per global CLAUDE.md §64.37 — every (dept, role) pair MUST have a
> role-scoped dashboard. This is the dashboard for **tester** in **e-commerce**.

## Persona

The **tester** at E Commerce. They use this dashboard
...
returned by backend `GET /api/v1/holy/dashboards/e-commerce/tester/charts/<chart_id>`.
...
```
GET /api/v1/holy/dashboards/e-commerce/tester
  → {tiles: [...], charts: [...], filters: {...}, refreshed_at}

GET /api/v1/holy/dashboards/e-commerce/tester/charts/<chart_id>
...
- Frontend route: `/holy/e-commerce/dashboard?role=tester`
