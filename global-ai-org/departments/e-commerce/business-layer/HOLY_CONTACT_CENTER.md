# HOLY Beverage — E Commerce — Contact Center Automation
...
**Manager** + **CX role** (dept = e-commerce). For non-CX depts this covers
...
|---|---|---|---|---|
| 1 | _stub: replace with real intent for e-commerce_ | _ | yes/no | DistilBERT |
| … | (20 total minimum) | | | |
...
- LLM model: `gemma3:4b` (default for e-commerce) — adjust per latency/cost SLO
- RAG corpus: `data/e-commerce/kb/` + `data/e-commerce/sops/`
