# HOLY Beverage — Customer Experience — AI Use-Case Catalog
...
> use cases for **customer-experience**. Implementation status tracked per current
> codebase state.
...
|---|---|---|
| ✅ Implemented | **14** of 32 | Working module exists in `backend/ml/reference/*.py` (drill-locked) |
| 🟡 Partial | **12** of 32 | Existing module applies; dept-specific stub deferred |
...
## 2. Customer Experience-Specific Use Cases

| Use Case | Category | Data Types | AI Area | Business Value | Status |
|---|---|---|---|---|---|
| AI Contact Center Assistant | CX | audio/transcript | Conversational AI | Lower AHT | 🟡 council_agent.py applies; voice-specific deferred |
| Conversation Intelligence | CX | audio/transcript | NLP + Speech | Better coaching | 🟡 nlp_lifecycle.py text portion |
| Sentiment Analysis | CX | chat/email/voice | Sentiment ML | Higher CSAT | 🟡 nlp_lifecycle.py applies |
| Customer 360 Intelligence | CX | CRM/behavioral | Graph AI | Better engagement | ❌ deferred |
| Customer Sentiment Trend | CX | reviews/calls/email | Sentiment + Trend | Better retention | 🟡 nlp_lifecycle + timeseries_lifecycle |
