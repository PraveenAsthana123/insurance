# HOLY Beverage — It Operations — Security Dashboard

> Per global CLAUDE.md §64.37 — every (dept, role) pair MUST have a
> role-scoped dashboard. This is the dashboard for **security** in **it-operations**.

## Persona

The **security** at It Operations. They use this dashboard
...
returned by backend `GET /api/v1/holy/dashboards/it-operations/security/charts/<chart_id>`.
...
```
GET /api/v1/holy/dashboards/it-operations/security
  → {tiles: [...], charts: [...], filters: {...}, refreshed_at}

GET /api/v1/holy/dashboards/it-operations/security/charts/<chart_id>
...
- Frontend route: `/holy/it-operations/dashboard?role=security`
