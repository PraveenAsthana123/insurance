# §140 · customer-experience × small-data-fewshot · Use Case Spec

## Purpose
Cross-cutting fit · ML technique applied to customer-experience domain.
...
## Example use case
Customer Experience use case applying small-data-fewshot to few labels.
