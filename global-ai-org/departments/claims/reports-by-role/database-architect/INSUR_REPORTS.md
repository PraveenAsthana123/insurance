# Claims — database-architect Reports

Per global §64.37 — role-scoped reports (≥ 3 standard per role).

## Standard reports

### R1 — Claims database-architect digest
...
## API
```
GET  /api/v1/insur/reports/claims/database-architect
POST /api/v1/insur/reports/claims/database-architect/{report_id}/run
```
