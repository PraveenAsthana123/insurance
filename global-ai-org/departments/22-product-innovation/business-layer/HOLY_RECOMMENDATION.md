# HOLY_RECOMMENDATION.md · Dept 22 · product-innovation
...
Recommendation system for Dept 22 (product-innovation). All 3 classical flavors covered per §64.22.
...
**Algorithm**: Concept embedding (idea + market + adjacency)
...
**Algorithm**: Content-only · then graduate to hybrid post-launch
