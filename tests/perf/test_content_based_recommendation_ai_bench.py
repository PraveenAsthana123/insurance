"""§138 · Content-Based Recommendation AI performance benchmark · pytest-benchmark."""
import joblib
import numpy as np
import pytest

MODEL_PATH = "/mnt/deepa/insur_project/models/content-based-recommendation-ai/model.joblib"
