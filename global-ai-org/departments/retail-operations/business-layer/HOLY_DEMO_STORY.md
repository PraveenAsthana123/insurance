# HOLY Beverage — Retail Operations — Demo User Story
...
**Carlos, Director of Retail Operations**
...
The persona needs to: **raise per-store revenue 15% and cut shrink 40%**

Main KPI being moved: **Revenue per square foot, shrink rate, customer satisfaction**

## 3. Walkthrough (what they see + do)

1. Persona lands on `/holy/retail-operations` (the HOLY navigation page for this dept).
...
> "Today Carlos spends 80% of their week on manual data
...
> counterfactual. We don't replace Carlos — we replace
...
|---|---|---|---|
| 1 | Open `/holy/retail-operations` | Left sidebar with N processes | "Every process this dept owns, surfaced as navigable artifacts" |
...
**Cross-reference**: This story powers the demo at `/holy/retail-operations` in the
HOLY frontend. The literal click-by-click in §5 is also the drill
`tests/drills/drill_dept_demo_retail_operations.py` (planned).
