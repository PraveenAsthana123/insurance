# HOLY Beverage — Digital Marketing — Devops Dashboard

> Per global CLAUDE.md §64.37 — every (dept, role) pair MUST have a
> role-scoped dashboard. This is the dashboard for **devops** in **digital-marketing**.

## Persona

The **devops** at Digital Marketing. They use this dashboard
...
returned by backend `GET /api/v1/holy/dashboards/digital-marketing/devops/charts/<chart_id>`.
...
```
GET /api/v1/holy/dashboards/digital-marketing/devops
  → {tiles: [...], charts: [...], filters: {...}, refreshed_at}

GET /api/v1/holy/dashboards/digital-marketing/devops/charts/<chart_id>
...
- Frontend route: `/holy/digital-marketing/dashboard?role=devops`
