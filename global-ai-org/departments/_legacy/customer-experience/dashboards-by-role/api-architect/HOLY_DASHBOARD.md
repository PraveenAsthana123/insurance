# HOLY Beverage — Customer Experience — Api Architect Dashboard

> Per global CLAUDE.md §64.37 — every (dept, role) pair MUST have a
> role-scoped dashboard. This is the dashboard for **api-architect** in **customer-experience**.

## Persona

The **api-architect** at Customer Experience. They use this dashboard
...
returned by backend `GET /api/v1/holy/dashboards/customer-experience/api-architect/charts/<chart_id>`.
...
```
GET /api/v1/holy/dashboards/customer-experience/api-architect
  → {tiles: [...], charts: [...], filters: {...}, refreshed_at}

GET /api/v1/holy/dashboards/customer-experience/api-architect/charts/<chart_id>
...
- Frontend route: `/holy/customer-experience/dashboard?role=api-architect`
