# §140 · actuarial × small-data-fewshot · Use Case Spec

## Purpose
PRIMARY fit · ML technique applied to actuarial domain.
...
## Example use case
New product line reserving with few historical years.
