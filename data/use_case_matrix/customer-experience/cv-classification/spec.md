# §140 · customer-experience × cv-classification · Use Case Spec

## Purpose
Cross-cutting fit · CV technique applied to customer-experience domain.
...
## Example use case
Customer Experience use case applying cv-classification to images.
