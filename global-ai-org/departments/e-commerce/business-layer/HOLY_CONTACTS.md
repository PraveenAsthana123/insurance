# HOLY Beverage — E Commerce — Contact Management (customer + vendor + internal)
...
- Sync: scheduled inbound from e-commerce's CRM / ERP / HRIS
...
|---|---|---|
| GET /api/v1/holy/contacts/e-commerce/customers | list | manager / data-owner |
| GET /api/v1/holy/contacts/e-commerce/vendors | list | manager / procurement |
| GET /api/v1/holy/contacts/e-commerce/internal | list | any dept role |
| POST /api/v1/holy/contacts/e-commerce/customers | create | admin / manager |
| PUT /api/v1/holy/contacts/e-commerce/customers/{id} | update | admin / data-owner |
| DELETE /api/v1/holy/contacts/e-commerce/customers/{id} | soft-delete | admin |
