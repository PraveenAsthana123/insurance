# Customer Service / Contact Center — ai-reviewer Dashboard

Per global §64.37 — role-scoped dashboard.

## Persona
**ai-reviewer** in Customer Service / Contact Center.
...
## API
```
GET /api/v1/insur/dashboards/customer-service/ai-reviewer
```
