# HOLY Beverage — Supply Chain — Tester Dashboard

> Per global CLAUDE.md §64.37 — every (dept, role) pair MUST have a
> role-scoped dashboard. This is the dashboard for **tester** in **supply-chain**.

## Persona

The **tester** at Supply Chain. They use this dashboard
...
returned by backend `GET /api/v1/holy/dashboards/supply-chain/tester/charts/<chart_id>`.
...
```
GET /api/v1/holy/dashboards/supply-chain/tester
  → {tiles: [...], charts: [...], filters: {...}, refreshed_at}

GET /api/v1/holy/dashboards/supply-chain/tester/charts/<chart_id>
...
- Frontend route: `/holy/supply-chain/dashboard?role=tester`
