# HOLY Beverage — Sales — BRD (Business Requirements Document)

> Per global §47 + §59 + §64 — every functional commitment in HOLY_FRD.md
> traces back to a goal in this document. Owner: **VP Sales**.

## 1. Executive summary

**Strategic goal:** AI lead-scoring + next-best-action + churn-risk early-warning

**Primary KPI(s):** Pipeline conversion ↑ 30%, churn ↓ 20%
...
| Affected functions | Sales, Marketing, CX, Finance | I |
...
|---|---|---|---|---|
| Operational efficiency | Pipeline conversion ↑ 30% | per AS-IS | per AS-IS | 6 months |
