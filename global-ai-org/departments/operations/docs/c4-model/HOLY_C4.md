# HOLY Beverage — Operations C4 Model
...
graph LR
    ...
    features --> model[Process Mining AI, Forecasting ML, Optimization AI, Anomaly Detection]
...
- Decision lineage: every API call writes a row to `operations_audit` (see LLD §2)

## L6 — Observability

- Logs: structured JSON with `correlation_id`, `tenant_id`, `user_id`, `model_version`, `prompt_version`
- Metrics: `operations_request_count`, `operations_latency_p95`, `operations_model_confidence`, `operations_hallucination_rate`
