# HOLY Beverage — Manufacturing — Team Member Dashboard

> Per global CLAUDE.md §64.37 — every (dept, role) pair MUST have a
> role-scoped dashboard. This is the dashboard for **team-member** in **manufacturing**.

## Persona

The **team-member** at Manufacturing. They use this dashboard
...
returned by backend `GET /api/v1/holy/dashboards/manufacturing/team-member/charts/<chart_id>`.
...
```
GET /api/v1/holy/dashboards/manufacturing/team-member
  → {tiles: [...], charts: [...], filters: {...}, refreshed_at}

GET /api/v1/holy/dashboards/manufacturing/team-member/charts/<chart_id>
...
- Frontend route: `/holy/manufacturing/dashboard?role=team-member`
