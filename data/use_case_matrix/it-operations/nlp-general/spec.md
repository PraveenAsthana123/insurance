# §140 · it-operations × nlp-general · Use Case Spec

## Purpose
Cross-cutting fit · NLP technique applied to it-operations domain.
...
## Example use case
It Operations use case applying nlp-general to text.
