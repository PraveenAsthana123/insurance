# Fraud / Special Investigations Unit (SIU) — test-architect Dashboard

Per global §64.37 — role-scoped dashboard.

## Persona
**test-architect** in Fraud / Special Investigations Unit (SIU).

## Focus
Test pyramid health, flaky-test count, coverage per service
...
## API
```
GET /api/v1/insur/dashboards/fraud-siu/test-architect
```
