# HOLY Beverage — Customer Experience — Data Type: XML
...
SAP / B2B / ERP integration data → structured intake
...
Recommended role: `data-owner / api-architect`
(see `../../roles/data-owner/HOLY_README.md`)

## Reference pipeline

`backend/ml/reference/full_lifecycle.py (after XML→table)`

Common libraries: lxml, xml.etree.ElementTree, xmltodict, xmlschema
...
- flattened table + schema-validation pass-rate + per-tag count
