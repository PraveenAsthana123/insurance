# Customer Service / Contact Center — system-architect Dashboard

Per global §64.37 — role-scoped dashboard.

## Persona
**system-architect** in Customer Service / Contact Center.
...
## API
```
GET /api/v1/insur/dashboards/customer-service/system-architect
```
