# HOLY Beverage — Executive Leadership — Input Data Mgmt + Before/After Viz
...
For every process AND sub-process in this dept (executive-leadership), populate the 6
surfaces below. consolidated KPIs + market intel is the primary data class for executive-leadership.
...
Plots land in: `data/eval/executive-leadership/<pipeline>/<run_id>/plots/before_*.png`
...
Plots land in: `data/eval/executive-leadership/<pipeline>/<run_id>/plots/after_*.png`
