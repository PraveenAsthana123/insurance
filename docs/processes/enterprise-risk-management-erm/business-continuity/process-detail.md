...
> Department 15 · Enterprise Risk Management (ERM) · slug `business-continuity` · AI items: 3
...
| Item | What | Where |
|---|---|---|
| Test data | TODO scrubbed sample | `data/demo/business-continuity/` |
...
- **One-liner**: TODO
- **Demo URL**: `http://192.168.1.88:3210/insurance/15/<domain>/business-continuity?tab=user-demo`
- **Recording**: TODO
...
Simulation URL: `http://192.168.1.88:3210/insurance/15/<domain>/business-continuity?tab=simulation`
...
| 2 | Feature schema | data spec | `backend/ml/insurance/schemas/business-continuity.yaml` | view-only |
...
Release summary: auto-gen `docs/processes/enterprise-risk-management-erm/business-continuity/release-summary-vX.Y.md` covering §1 problem · §4 impact deltas · §10 phase scorecard · §11 test pass/fail · top 3 failure modes · sign-off · git SHA + image digest.

## 12. Cron jobs + DB writes

| Cron tag | Schedule | Purpose | DB updated |
|---|---|---|---|
| `INSUR-BUSINESS_CONTINUITY-DAILY-REFRESH` | daily 02:00 | refresh model on new data | MLflow + audit |
| `INSUR-BUSINESS_CONTINUITY-DRIFT-CHECK` | hourly | data + concept drift | drift_metrics |
| `INSUR-BUSINESS_CONTINUITY-HITL-AUDIT` | daily 09:00 | sample HITL overrides for retrain | hitl_audit |
| `INSUR-BUSINESS_CONTINUITY-RAG-REINDEX` | weekly Mon 03:00 | re-embed source docs | vector_db |
| `INSUR-BUSINESS_CONTINUITY-COST-REPORT` | weekly Mon 08:00 | dollar impact reconciliation | cost_report |
| `INSUR-BUSINESS_CONTINUITY-EVAL-DEEPEVAL` | weekly Mon 04:00 | Ragas + DeepEval regression | eval_metrics |
| `INSUR-BUSINESS_CONTINUITY-VECTOR-INGEST` | */15 * * * * | move new data into vector DB | vector_db |
...
Gold set: `data/eval/enterprise-risk-management-erm/business-continuity/gold_set.jsonl` (100-500 queries · stratified · monthly refresh).
...
Every data artifact embedded automatically · per `INSUR-BUSINESS_CONTINUITY-VECTOR-INGEST` cron above.
...
→ Tab: `?tab=resai` · evidence files: `data/eval/enterprise-risk-management-erm/business-continuity/resai/`
...
→ Tab: `?tab=expai` · artifacts: `data/eval/enterprise-risk-management-erm/business-continuity/expai/`
...
→ Tab: `?tab=analysis` · evidence: `data/eval/enterprise-risk-management-erm/business-continuity/stats/`
