# HOLY Beverage — Product Rd — Contact Management (customer + vendor + internal)
...
- Sync: scheduled inbound from product-rd's CRM / ERP / HRIS
...
|---|---|---|
| GET /api/v1/holy/contacts/product-rd/customers | list | manager / data-owner |
| GET /api/v1/holy/contacts/product-rd/vendors | list | manager / procurement |
| GET /api/v1/holy/contacts/product-rd/internal | list | any dept role |
| POST /api/v1/holy/contacts/product-rd/customers | create | admin / manager |
| PUT /api/v1/holy/contacts/product-rd/customers/{id} | update | admin / data-owner |
| DELETE /api/v1/holy/contacts/product-rd/customers/{id} | soft-delete | admin |
