# HOLY Beverage — Supply Chain — Devops Dashboard

> Per global CLAUDE.md §64.37 — every (dept, role) pair MUST have a
> role-scoped dashboard. This is the dashboard for **devops** in **supply-chain**.

## Persona

The **devops** at Supply Chain. They use this dashboard
...
returned by backend `GET /api/v1/holy/dashboards/supply-chain/devops/charts/<chart_id>`.
...
```
GET /api/v1/holy/dashboards/supply-chain/devops
  → {tiles: [...], charts: [...], filters: {...}, refreshed_at}

GET /api/v1/holy/dashboards/supply-chain/devops/charts/<chart_id>
...
- Frontend route: `/holy/supply-chain/dashboard?role=devops`
