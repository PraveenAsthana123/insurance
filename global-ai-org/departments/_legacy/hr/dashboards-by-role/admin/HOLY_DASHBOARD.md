# HOLY Beverage — Hr — Admin Dashboard

> Per global CLAUDE.md §64.37 — every (dept, role) pair MUST have a
> role-scoped dashboard. This is the dashboard for **admin** in **hr**.

## Persona

The **admin** at Hr. They use this dashboard
...
returned by backend `GET /api/v1/holy/dashboards/hr/admin/charts/<chart_id>`.
...
```
GET /api/v1/holy/dashboards/hr/admin
  → {tiles: [...], charts: [...], filters: {...}, refreshed_at}

GET /api/v1/holy/dashboards/hr/admin/charts/<chart_id>
...
- Frontend route: `/holy/hr/dashboard?role=admin`
