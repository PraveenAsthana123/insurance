# HOLY_RECOMMENDATION.md · Dept 3 · sales-distribution
...
Recommendation system for Dept 3 (sales-distribution). All 3 classical flavors covered per §64.22.

## Item-based (collaborative filter)

**Algorithm**: ALS on customer×product matrix
...
**Algorithm**: TF-IDF on product copy + sentence-transformer
...
**Algorithm**: Hybrid · margin × inventory × eligibility business rule
