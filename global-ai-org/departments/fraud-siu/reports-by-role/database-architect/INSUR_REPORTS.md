# Fraud / Special Investigations Unit (SIU) — database-architect Reports

Per global §64.37 — role-scoped reports (≥ 3 standard per role).

## Standard reports

### R1 — Fraud / Special Investigations Unit (SIU) database-architect digest
...
## API
```
GET  /api/v1/insur/reports/fraud-siu/database-architect
POST /api/v1/insur/reports/fraud-siu/database-architect/{report_id}/run
```
