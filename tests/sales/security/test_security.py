"""Tier 11-12 — Security tests for sales.
...
def test_sales_owasp_zap_scan():
    """REPLACE — invoke OWASP ZAP CLI against sales surface (auth env only)."""
    pass


@pytest.mark.skip(reason="placeholder — requires Garak install + AI endpoint")
def test_sales_garak_prompt_injection():
