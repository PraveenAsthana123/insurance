# HOLY Beverage — Legal — Demo User Story
...
The persona needs to: **cut contract turnaround from 14d to 3d, raise clause-compliance 95%, cut legal-spend 30%**

Main KPI being moved: **Contract turnaround time, clause compliance, outside-counsel spend**

## 3. Walkthrough (what they see + do)

1. Persona lands on `/holy/legal` (the HOLY navigation page for this dept).
...
> "Today Marcus spends 80% of their week on manual data
...
> counterfactual. We don't replace Marcus — we replace
...
|---|---|---|---|
| 1 | Open `/holy/legal` | Left sidebar with N processes | "Every process this dept owns, surfaced as navigable artifacts" |
...
**Cross-reference**: This story powers the demo at `/holy/legal` in the
HOLY frontend. The literal click-by-click in §5 is also the drill
`tests/drills/drill_dept_demo_legal.py` (planned).
