# HOLY Beverage — Marketing — Security Dashboard

> Per global CLAUDE.md §64.37 — every (dept, role) pair MUST have a
> role-scoped dashboard. This is the dashboard for **security** in **marketing**.

## Persona

The **security** at Marketing. They use this dashboard
...
returned by backend `GET /api/v1/holy/dashboards/marketing/security/charts/<chart_id>`.
...
```
GET /api/v1/holy/dashboards/marketing/security
  → {tiles: [...], charts: [...], filters: {...}, refreshed_at}

GET /api/v1/holy/dashboards/marketing/security/charts/<chart_id>
...
- Frontend route: `/holy/marketing/dashboard?role=security`
