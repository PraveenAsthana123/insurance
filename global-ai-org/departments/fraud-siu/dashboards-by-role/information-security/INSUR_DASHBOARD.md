# Fraud / Special Investigations Unit (SIU) — information-security Dashboard

Per global §64.37 — role-scoped dashboard.

## Persona
**information-security** in Fraud / Special Investigations Unit (SIU).

## Focus
Pen-test results, compliance gates, CVE backlog
...
## API
```
GET /api/v1/insur/dashboards/fraud-siu/information-security
```
