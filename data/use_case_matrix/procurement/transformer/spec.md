# §140 · procurement × transformer · Use Case Spec

## Purpose
Cross-cutting fit · NLP technique applied to procurement domain.
...
## Example use case
Procurement use case applying transformer to text.
