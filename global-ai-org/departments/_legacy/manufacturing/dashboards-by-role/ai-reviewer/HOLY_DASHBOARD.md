# HOLY Beverage — Manufacturing — Ai Reviewer Dashboard

> Per global CLAUDE.md §64.37 — every (dept, role) pair MUST have a
> role-scoped dashboard. This is the dashboard for **ai-reviewer** in **manufacturing**.

## Persona

The **ai-reviewer** at Manufacturing. They use this dashboard
...
returned by backend `GET /api/v1/holy/dashboards/manufacturing/ai-reviewer/charts/<chart_id>`.
...
```
GET /api/v1/holy/dashboards/manufacturing/ai-reviewer
  → {tiles: [...], charts: [...], filters: {...}, refreshed_at}

GET /api/v1/holy/dashboards/manufacturing/ai-reviewer/charts/<chart_id>
...
- Frontend route: `/holy/manufacturing/dashboard?role=ai-reviewer`
