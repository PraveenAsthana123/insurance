# §140 · fraud-investigation × cv-classification · Use Case Spec

## Purpose
Cross-cutting fit · CV technique applied to fraud-investigation domain.
...
## Example use case
Fraud Investigation use case applying cv-classification to images.
