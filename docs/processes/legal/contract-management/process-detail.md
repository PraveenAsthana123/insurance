...
> Department 13 · Legal · slug `contract-management` · AI items: 5
...
- **One-liner**: TODO
- **Demo URL**: `http://192.168.1.88:3210/insurance/13/<domain>/contract-management?tab=user-demo`
- **Recording**: TODO
...
Simulation URL: `http://192.168.1.88:3210/insurance/13/<domain>/contract-management?tab=simulation`
...
Release summary: auto-gen `docs/processes/legal/contract-management/release-summary-vX.Y.md` covering §1 problem · §4 impact deltas · §10 phase scorecard · §11 test pass/fail · top 3 failure modes · sign-off · git SHA + image digest.
...
Gold set: `data/eval/legal/contract-management/gold_set.jsonl` (100-500 queries · stratified · monthly refresh).
...
→ Tab: `?tab=resai` · evidence files: `data/eval/legal/contract-management/resai/`
...
→ Tab: `?tab=expai` · artifacts: `data/eval/legal/contract-management/expai/`
...
→ Tab: `?tab=analysis` · evidence: `data/eval/legal/contract-management/stats/`
