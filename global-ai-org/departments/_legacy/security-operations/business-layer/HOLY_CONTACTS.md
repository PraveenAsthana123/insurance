# HOLY Beverage — Security Operations — Contact Management (customer + vendor + internal)
...
- Sync: scheduled inbound from security-operations's CRM / ERP / HRIS
...
|---|---|---|
| GET /api/v1/holy/contacts/security-operations/customers | list | manager / data-owner |
| GET /api/v1/holy/contacts/security-operations/vendors | list | manager / procurement |
| GET /api/v1/holy/contacts/security-operations/internal | list | any dept role |
| POST /api/v1/holy/contacts/security-operations/customers | create | admin / manager |
| PUT /api/v1/holy/contacts/security-operations/customers/{id} | update | admin / data-owner |
| DELETE /api/v1/holy/contacts/security-operations/customers/{id} | soft-delete | admin |
