# HOLY Beverage — Marketing — Team Member Dashboard

> Per global CLAUDE.md §64.37 — every (dept, role) pair MUST have a
> role-scoped dashboard. This is the dashboard for **team-member** in **marketing**.

## Persona

The **team-member** at Marketing. They use this dashboard
...
returned by backend `GET /api/v1/holy/dashboards/marketing/team-member/charts/<chart_id>`.
...
```
GET /api/v1/holy/dashboards/marketing/team-member
  → {tiles: [...], charts: [...], filters: {...}, refreshed_at}

GET /api/v1/holy/dashboards/marketing/team-member/charts/<chart_id>
...
- Frontend route: `/holy/marketing/dashboard?role=team-member`
