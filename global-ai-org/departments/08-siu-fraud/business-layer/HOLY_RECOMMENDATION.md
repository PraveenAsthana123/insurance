# HOLY_RECOMMENDATION.md · Dept 8 · siu-fraud
...
Recommendation system for Dept 8 (siu-fraud). All 3 classical flavors covered per §64.22.
...
**Algorithm**: Narrative similarity (BERT embed)
...
**Algorithm**: XGBoost · narrative + GNN ensemble
