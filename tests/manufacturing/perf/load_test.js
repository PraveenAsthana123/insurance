// Tier 9-10 — Performance + load test for manufacturing.
//
// Recommended: k6 (per global §64.42).
//
// Run with:  k6 run tests/manufacturing/perf/load_test.js
//
...
export default function () {
  ...
  check(res, {
    ...
    'has manufacturing': (r) => r.body.includes('manufacturing'),
  });
  sleep(1);
}
