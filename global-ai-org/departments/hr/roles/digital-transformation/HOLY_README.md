# Hr — Digital Transformation (HOLY)
...
## How this role uses HOLY's Hr platform

- **Navigates** via `HOLY_NAV.json` (left-sidebar process picker; see `/holy/hr` in frontend)
...
NLP, RPA, Churn / Retention ML, Fairness AI, Recommendation AI

## Tech stack this role touches

- Workday + Snowflake
- Python + spaCy + Hugging Face
- Aequitas / Fairlearn for bias
