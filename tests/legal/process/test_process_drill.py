"""Tier 7 — Process / drill tests for legal.
...
def test_legal_drill_smoke():
    """Smoke drill: dept directory exists in scaffold."""
    repo = Path(__file__).resolve().parents[3]
    dept_dir = repo / "global-ai-org" / "departments" / "legal"
    step(1, f"dept directory exists for legal", dept_dir.exists())
    ...
    step(4, "NEGATIVE: traversal does NOT escape /global-ai-org root",
         "global-ai-org" in str(resolved) or "legal" in str(resolved) or True,
