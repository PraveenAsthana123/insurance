# HOLY Beverage — E Commerce — Devops Dashboard

> Per global CLAUDE.md §64.37 — every (dept, role) pair MUST have a
> role-scoped dashboard. This is the dashboard for **devops** in **e-commerce**.

## Persona

The **devops** at E Commerce. They use this dashboard
...
returned by backend `GET /api/v1/holy/dashboards/e-commerce/devops/charts/<chart_id>`.
...
```
GET /api/v1/holy/dashboards/e-commerce/devops
  → {tiles: [...], charts: [...], filters: {...}, refreshed_at}

GET /api/v1/holy/dashboards/e-commerce/devops/charts/<chart_id>
...
- Frontend route: `/holy/e-commerce/dashboard?role=devops`
