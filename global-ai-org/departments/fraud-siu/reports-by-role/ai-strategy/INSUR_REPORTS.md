# Fraud / Special Investigations Unit (SIU) — ai-strategy Reports

Per global §64.37 — role-scoped reports (≥ 3 standard per role).

## Standard reports

### R1 — Fraud / Special Investigations Unit (SIU) ai-strategy digest
...
## API
```
GET  /api/v1/insur/reports/fraud-siu/ai-strategy
POST /api/v1/insur/reports/fraud-siu/ai-strategy/{report_id}/run
```
