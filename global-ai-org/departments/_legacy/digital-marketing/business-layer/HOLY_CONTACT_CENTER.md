# HOLY Beverage — Digital Marketing — Contact Center Automation
...
**Manager** + **CX role** (dept = digital-marketing). For non-CX depts this covers
...
|---|---|---|---|---|
| 1 | _stub: replace with real intent for digital-marketing_ | _ | yes/no | DistilBERT |
| … | (20 total minimum) | | | |
...
- LLM model: `gemma3:4b` (default for digital-marketing) — adjust per latency/cost SLO
- RAG corpus: `data/digital-marketing/kb/` + `data/digital-marketing/sops/`
