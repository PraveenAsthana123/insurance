# §140 · fraud-investigation × time-series · Use Case Spec

## Purpose
Cross-cutting fit · TS technique applied to fraud-investigation domain.
...
## Example use case
Fraud Investigation use case applying time-series to temporal.
