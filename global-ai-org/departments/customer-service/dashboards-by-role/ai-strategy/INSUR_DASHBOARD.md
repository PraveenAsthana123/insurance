# Customer Service / Contact Center — ai-strategy Dashboard

Per global §64.37 — role-scoped dashboard.

## Persona
**ai-strategy** in Customer Service / Contact Center.
...
## API
```
GET /api/v1/insur/dashboards/customer-service/ai-strategy
```
