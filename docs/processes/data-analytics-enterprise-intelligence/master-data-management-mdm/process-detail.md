...
> Department 18 · Data, Analytics & Enterprise Intelligence · slug `master-data-management-mdm` · AI items: 4
...
| Item | What | Where |
|---|---|---|
| Test data | TODO scrubbed sample | `data/demo/master-data-management-mdm/` |
...
- **One-liner**: TODO
- **Demo URL**: `http://192.168.1.88:3210/insurance/18/<domain>/master-data-management-mdm?tab=user-demo`
- **Recording**: TODO
...
Simulation URL: `http://192.168.1.88:3210/insurance/18/<domain>/master-data-management-mdm?tab=simulation`
...
|---|---|---|---|---|
| 1 | Input dataset | data | `data/insurance/data-analytics-enterprise-intelligence/` | yes (file picker) |
| 2 | Feature schema | data spec | `backend/ml/insurance/schemas/master-data-management-mdm.yaml` | view-only |
...
Release summary: auto-gen `docs/processes/data-analytics-enterprise-intelligence/master-data-management-mdm/release-summary-vX.Y.md` covering §1 problem · §4 impact deltas · §10 phase scorecard · §11 test pass/fail · top 3 failure modes · sign-off · git SHA + image digest.

## 12. Cron jobs + DB writes

| Cron tag | Schedule | Purpose | DB updated |
|---|---|---|---|
| `INSUR-MASTER_DATA_MANAGEMENT_MDM-DAILY-REFRESH` | daily 02:00 | refresh model on new data | MLflow + audit |
| `INSUR-MASTER_DATA_MANAGEMENT_MDM-DRIFT-CHECK` | hourly | data + concept drift | drift_metrics |
| `INSUR-MASTER_DATA_MANAGEMENT_MDM-HITL-AUDIT` | daily 09:00 | sample HITL overrides for retrain | hitl_audit |
| `INSUR-MASTER_DATA_MANAGEMENT_MDM-RAG-REINDEX` | weekly Mon 03:00 | re-embed source docs | vector_db |
| `INSUR-MASTER_DATA_MANAGEMENT_MDM-COST-REPORT` | weekly Mon 08:00 | dollar impact reconciliation | cost_report |
| `INSUR-MASTER_DATA_MANAGEMENT_MDM-EVAL-DEEPEVAL` | weekly Mon 04:00 | Ragas + DeepEval regression | eval_metrics |
| `INSUR-MASTER_DATA_MANAGEMENT_MDM-VECTOR-INGEST` | */15 * * * * | move new data into vector DB | vector_db |
...
Gold set: `data/eval/data-analytics-enterprise-intelligence/master-data-management-mdm/gold_set.jsonl` (100-500 queries · stratified · monthly refresh).
...
Every data artifact embedded automatically · per `INSUR-MASTER_DATA_MANAGEMENT_MDM-VECTOR-INGEST` cron above.
...
→ Tab: `?tab=resai` · evidence files: `data/eval/data-analytics-enterprise-intelligence/master-data-management-mdm/resai/`
...
→ Tab: `?tab=expai` · artifacts: `data/eval/data-analytics-enterprise-intelligence/master-data-management-mdm/expai/`
...
→ Tab: `?tab=analysis` · evidence: `data/eval/data-analytics-enterprise-intelligence/master-data-management-mdm/stats/`
