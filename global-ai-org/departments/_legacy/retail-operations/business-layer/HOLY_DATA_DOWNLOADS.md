# HOLY Beverage — Retail Operations — Data Downloads
...
|---|---|---|---|---|---|
| 1 | `retail_operations_primary_sample` | Retail Operations primary use-case sample | tabular | 5 | 5 |
...
### 3.x `retail_operations_primary_sample`

- **Title:** Retail Operations primary use-case sample
- **Lifecycle:** tabular
...
| Endpoint | Returns |
|---|---|
| `GET /api/v1/holy/downloads/retail-operations` | Catalog (datasets + URLs) |
| `GET /api/v1/holy/downloads/retail-operations/<dataset_id>.csv` | CSV file |
| `GET /api/v1/holy/downloads/retail-operations/<dataset_id>.json` | JSON file |
| `GET /api/v1/holy/downloads/retail-operations/<dataset_id>.before.svg` | Pre-process viz |
| `GET /api/v1/holy/downloads/retail-operations/<dataset_id>.after.svg` | Post-process viz |
