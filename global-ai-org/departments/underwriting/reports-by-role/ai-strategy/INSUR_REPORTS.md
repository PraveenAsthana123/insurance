# Underwriting — ai-strategy Reports

Per global §64.37 — role-scoped reports (≥ 3 standard per role).

## Standard reports

### R1 — Underwriting ai-strategy digest
...
## API
```
GET  /api/v1/insur/reports/underwriting/ai-strategy
POST /api/v1/insur/reports/underwriting/ai-strategy/{report_id}/run
```
