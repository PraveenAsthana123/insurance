# HOLY Beverage — Legal — Data Downloads
...
|---|---|---|---|---|---|
| 1 | `legal_primary_sample` | Legal primary use-case sample | tabular | 5 | 5 |
...
### 3.x `legal_primary_sample`

- **Title:** Legal primary use-case sample
- **Lifecycle:** tabular
...
| Endpoint | Returns |
|---|---|
| `GET /api/v1/holy/downloads/legal` | Catalog (datasets + URLs) |
| `GET /api/v1/holy/downloads/legal/<dataset_id>.csv` | CSV file |
| `GET /api/v1/holy/downloads/legal/<dataset_id>.json` | JSON file |
| `GET /api/v1/holy/downloads/legal/<dataset_id>.before.svg` | Pre-process viz |
| `GET /api/v1/holy/downloads/legal/<dataset_id>.after.svg` | Post-process viz |
