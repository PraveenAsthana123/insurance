# HOLY Beverage — Retail Operations — Simulation Tab
...
under `REFERENCE_PROCESSES[("retail-operations", "<process>")]`.
...
| Endpoint | Purpose |
|---|---|
| POST /api/v1/holy/sim/retail-operations/{process}/run | Trigger simulation |
| GET /api/v1/holy/sim/retail-operations/{process}/runs | List past runs |
| GET /api/v1/holy/sim/retail-operations/{process}/runs/{sim_id}/manifest | Per-run summary |
| GET /api/v1/holy/sim/retail-operations/{process}/runs/{sim_id}/events | Event stream |

## TODO

- [ ] Define ≥ 1 process for retail-operations in `REFERENCE_PROCESSES` dict
