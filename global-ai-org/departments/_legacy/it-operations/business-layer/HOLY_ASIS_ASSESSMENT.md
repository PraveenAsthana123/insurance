# HOLY Beverage — It Operations — AS-IS Process Assessment
...
This document is the **input to the AI strategy planning** for It Operations.
...
|---|---|---|---|---|---|---|---|---|
| 1 | Manual incident routing | 4 hrs/wk | High | $300K/yr | Service-desk burnout | Slow | Lost SLA | ServiceNow only |
| 2 | Reactive capacity scaling | 8 hrs/wk | Med | $2M/yr cloud waste | SRE overload | Threshold-based | Over-provisioned | AWS console |
| 3 | Manual log search | 6 hrs/wk | Med | $200K/yr time | Eng overhead | Slow | Missed signals | Splunk searches |
| 4 | Manual runbook lookup | 4 hrs/wk | Med | $150K/yr | On-call confusion | Stale docs | Slow recovery | Confluence |
| 5 | Manual cloud-cost analysis | 16 hrs/wk | Med | $5M/yr waste | FinOps overhead | Monthly | Reactive | Cost Explorer |
...
4. **Measure** via the persona's main KPI: Uptime, MTTD, MTTR, ticket volume, cloud-cost-per-active-user
