# HOLY Beverage — Engineering — Team Member Dashboard

> Per global CLAUDE.md §64.37 — every (dept, role) pair MUST have a
> role-scoped dashboard. This is the dashboard for **team-member** in **engineering**.

## Persona

The **team-member** at Engineering. They use this dashboard
...
returned by backend `GET /api/v1/holy/dashboards/engineering/team-member/charts/<chart_id>`.
...
```
GET /api/v1/holy/dashboards/engineering/team-member
  → {tiles: [...], charts: [...], filters: {...}, refreshed_at}

GET /api/v1/holy/dashboards/engineering/team-member/charts/<chart_id>
...
- Frontend route: `/holy/engineering/dashboard?role=team-member`
