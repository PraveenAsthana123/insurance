# HOLY Beverage — Executive Leadership — Digital Transformation Dashboard

> Per global CLAUDE.md §64.37 — every (dept, role) pair MUST have a
> role-scoped dashboard. This is the dashboard for **digital-transformation** in **executive-leadership**.

## Persona

The **digital-transformation** at Executive Leadership. They use this dashboard
...
returned by backend `GET /api/v1/holy/dashboards/executive-leadership/digital-transformation/charts/<chart_id>`.
...
```
GET /api/v1/holy/dashboards/executive-leadership/digital-transformation
  → {tiles: [...], charts: [...], filters: {...}, refreshed_at}

GET /api/v1/holy/dashboards/executive-leadership/digital-transformation/charts/<chart_id>
...
- Frontend route: `/holy/executive-leadership/dashboard?role=digital-transformation`
