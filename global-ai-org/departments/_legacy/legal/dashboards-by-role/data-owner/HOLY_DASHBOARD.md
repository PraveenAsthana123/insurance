# HOLY Beverage — Legal — Data Owner Dashboard

> Per global CLAUDE.md §64.37 — every (dept, role) pair MUST have a
> role-scoped dashboard. This is the dashboard for **data-owner** in **legal**.

## Persona

The **data-owner** at Legal. They use this dashboard
...
returned by backend `GET /api/v1/holy/dashboards/legal/data-owner/charts/<chart_id>`.
...
```
GET /api/v1/holy/dashboards/legal/data-owner
  → {tiles: [...], charts: [...], filters: {...}, refreshed_at}

GET /api/v1/holy/dashboards/legal/data-owner/charts/<chart_id>
...
- Frontend route: `/holy/legal/dashboard?role=data-owner`
