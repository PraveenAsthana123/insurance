"""§140 · security-operations × small-data-fewshot drill · ≥1 pos + ≥1 neg."""
import json
from pathlib import Path

R = Path("/mnt/deepa/insur_project")
CELL = R / "data/use_case_matrix/security-operations/small-data-fewshot"
...
def test_manifest_has_dept_and_technique():
    ...
    assert m["technique"] == "small-data-fewshot"
