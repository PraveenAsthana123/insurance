# Customer Service / Contact Center — admin Reports

Per global §64.37 — role-scoped reports (≥ 3 standard per role).

## Standard reports

### R1 — Customer Service / Contact Center admin digest
- **Purpose**: System health + user mgmt + RBAC events
- **Cadence**: Daily ops digest
- **Format**: PDF + email
- **Recipients**: admin mailing list
...
## API
```
GET  /api/v1/insur/reports/customer-service/admin
POST /api/v1/insur/reports/customer-service/admin/{report_id}/run
```
