# HOLY Beverage — Engineering — Contact Center Automation
...
**Manager** + **CX role** (dept = engineering). For non-CX depts this covers
...
|---|---|---|---|---|
| 1 | _stub: replace with real intent for engineering_ | _ | yes/no | DistilBERT |
| … | (20 total minimum) | | | |
...
- LLM model: `gemma3:4b` (default for engineering) — adjust per latency/cost SLO
- RAG corpus: `data/engineering/kb/` + `data/engineering/sops/`
