# §140 · finance × small-data-fewshot · Use Case Spec

## Purpose
Cross-cutting fit · ML technique applied to finance domain.
...
## Example use case
Finance use case applying small-data-fewshot to few labels.
