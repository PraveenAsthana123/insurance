# HOLY Beverage — Operations — Input Data Mgmt + Before/After Viz
...
For every process AND sub-process in this dept (operations), populate the 6
surfaces below. process telemetry + ERP is the primary data class for operations.
...
Plots land in: `data/eval/operations/<pipeline>/<run_id>/plots/before_*.png`
...
Plots land in: `data/eval/operations/<pipeline>/<run_id>/plots/after_*.png`
