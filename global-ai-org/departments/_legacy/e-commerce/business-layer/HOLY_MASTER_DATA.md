# HOLY Beverage — E Commerce — Master Data

> Per operator 2026-05-24 — every dept publishes its master + reference
> data here. Focus: **product-catalog + customer-master + promotion + carrier-rates**.
...
This dept (**e-commerce**) operates against the slice of the structure
...
| Endpoint | Returns |
|---|---|
| `GET /api/v1/holy/master-data/e-commerce` | Schema catalog + per-entity owner |
| `GET /api/v1/holy/master-data/e-commerce/customer?limit=20` | Customer master sample |
| `GET /api/v1/holy/master-data/e-commerce/vendor?limit=20` | Vendor master sample |
| `GET /api/v1/holy/master-data/e-commerce/product?limit=20` | Product master sample |
| `GET /api/v1/holy/master-data/e-commerce/org-structure` | Org tree slice for this dept |
...
1. (+) `/api/v1/holy/master-data/e-commerce` returns 200 + entity catalog
