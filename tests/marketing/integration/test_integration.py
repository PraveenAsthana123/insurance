"""Tier 2 — Integration tests for marketing.
...
def test_marketing_db_roundtrip():
    """REPLACE — verify marketing table CRUD round-trips against real Postgres."""
    pass


@pytest.mark.skip(reason="placeholder — requires Redis + queue fixtures")
def test_marketing_queue_dispatch():
    """REPLACE — verify marketing task enqueue + consume via Redis."""
    pass
