# Customer Service / Contact Center — database-architect Reports

Per global §64.37 — role-scoped reports (≥ 3 standard per role).

## Standard reports

### R1 — Customer Service / Contact Center database-architect digest
...
## API
```
GET  /api/v1/insur/reports/customer-service/database-architect
POST /api/v1/insur/reports/customer-service/database-architect/{report_id}/run
```
