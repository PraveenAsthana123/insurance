# HOLY Beverage — Executive Leadership — Simulation Tab
...
under `REFERENCE_PROCESSES[("executive-leadership", "<process>")]`.
...
| Endpoint | Purpose |
|---|---|
| POST /api/v1/holy/sim/executive-leadership/{process}/run | Trigger simulation |
| GET /api/v1/holy/sim/executive-leadership/{process}/runs | List past runs |
| GET /api/v1/holy/sim/executive-leadership/{process}/runs/{sim_id}/manifest | Per-run summary |
| GET /api/v1/holy/sim/executive-leadership/{process}/runs/{sim_id}/events | Event stream |

## TODO

- [ ] Define ≥ 1 process for executive-leadership in `REFERENCE_PROCESSES` dict
