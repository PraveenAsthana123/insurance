# HOLY Beverage — Customer Support — Master Data

> Per operator 2026-05-24 — every dept publishes its master + reference
> data here. Focus: **customer-master + product-master + SLA + KB-articles**.
...
This dept (**customer-support**) operates against the slice of the structure
...
| Endpoint | Returns |
|---|---|
| `GET /api/v1/holy/master-data/customer-support` | Schema catalog + per-entity owner |
| `GET /api/v1/holy/master-data/customer-support/customer?limit=20` | Customer master sample |
| `GET /api/v1/holy/master-data/customer-support/vendor?limit=20` | Vendor master sample |
| `GET /api/v1/holy/master-data/customer-support/product?limit=20` | Product master sample |
| `GET /api/v1/holy/master-data/customer-support/org-structure` | Org tree slice for this dept |
...
1. (+) `/api/v1/holy/master-data/customer-support` returns 200 + entity catalog
