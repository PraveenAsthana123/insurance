# HOLY Beverage — Supply Chain — Data Owner Dashboard

> Per global CLAUDE.md §64.37 — every (dept, role) pair MUST have a
> role-scoped dashboard. This is the dashboard for **data-owner** in **supply-chain**.

## Persona

The **data-owner** at Supply Chain. They use this dashboard
...
returned by backend `GET /api/v1/holy/dashboards/supply-chain/data-owner/charts/<chart_id>`.
...
```
GET /api/v1/holy/dashboards/supply-chain/data-owner
  → {tiles: [...], charts: [...], filters: {...}, refreshed_at}

GET /api/v1/holy/dashboards/supply-chain/data-owner/charts/<chart_id>
...
- Frontend route: `/holy/supply-chain/dashboard?role=data-owner`
