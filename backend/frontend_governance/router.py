...
SECTIONS = {
    ...
    "3_refresh_recovery": [
        ...
        {"item": "Uploaded files persist", "status": "⚠️",
         "where": "useFileUpload resumable chunks (Iter 65) · backend stub"},
    ...
    "12_forgotten_issues": [
        ...
        {"item": "Large table freeze (no virtualize)",   "status": "⚠️"},
        {"item": "Infinite spinner (no timeout)",        "status": "✅"},
        {"item": "White screen of death",                "status": "✅"},
        {"item": "Memory leak in browser",               "status": "⚠️"},
        {"item": "Session timeout no warning",           "status": "⚠️"},
