# HOLY Beverage — Marketing — Digital Transformation Dashboard

> Per global CLAUDE.md §64.37 — every (dept, role) pair MUST have a
> role-scoped dashboard. This is the dashboard for **digital-transformation** in **marketing**.

## Persona

The **digital-transformation** at Marketing. They use this dashboard
...
returned by backend `GET /api/v1/holy/dashboards/marketing/digital-transformation/charts/<chart_id>`.
...
```
GET /api/v1/holy/dashboards/marketing/digital-transformation
  → {tiles: [...], charts: [...], filters: {...}, refreshed_at}

GET /api/v1/holy/dashboards/marketing/digital-transformation/charts/<chart_id>
...
- Frontend route: `/holy/marketing/dashboard?role=digital-transformation`
