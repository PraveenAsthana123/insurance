# HOLY_RECOMMENDATION.md · Dept 16 · hr
...
Recommendation system for Dept 16 (hr). All 3 classical flavors covered per §64.22.

## Item-based (collaborative filter)

**Algorithm**: Item-based collaborative + content embed
...
**Algorithm**: Resume embedding (sentence-transformer)
...
**Algorithm**: LightGBM + role-fit rule · skill + experience match
