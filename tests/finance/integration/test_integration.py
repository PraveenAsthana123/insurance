"""Tier 2 — Integration tests for finance.
...
def test_finance_db_roundtrip():
    """REPLACE — verify finance table CRUD round-trips against real Postgres."""
    pass


@pytest.mark.skip(reason="placeholder — requires Redis + queue fixtures")
def test_finance_queue_dispatch():
    """REPLACE — verify finance task enqueue + consume via Redis."""
    pass
