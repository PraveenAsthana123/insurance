// Tier 9-10 — Performance + load test for customer-experience.
//
// Recommended: k6 (per global §64.42).
//
// Run with:  k6 run tests/customer-experience/perf/load_test.js
//
...
export default function () {
  ...
  check(res, {
    ...
    'has customer-experience': (r) => r.body.includes('customer-experience'),
  });
  sleep(1);
}
