# HOLY Beverage — E Commerce — Security Dashboard

> Per global CLAUDE.md §64.37 — every (dept, role) pair MUST have a
> role-scoped dashboard. This is the dashboard for **security** in **e-commerce**.

## Persona

The **security** at E Commerce. They use this dashboard
...
returned by backend `GET /api/v1/holy/dashboards/e-commerce/security/charts/<chart_id>`.
...
```
GET /api/v1/holy/dashboards/e-commerce/security
  → {tiles: [...], charts: [...], filters: {...}, refreshed_at}

GET /api/v1/holy/dashboards/e-commerce/security/charts/<chart_id>
...
- Frontend route: `/holy/e-commerce/dashboard?role=security`
