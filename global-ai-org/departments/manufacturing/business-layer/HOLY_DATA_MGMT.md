# HOLY Beverage — Manufacturing — Input Data Mgmt + Before/After Viz
...
For every process AND sub-process in this dept (manufacturing), populate the 6
surfaces below. sensor + image + batch is the primary data class for manufacturing.
...
Plots land in: `data/eval/manufacturing/<pipeline>/<run_id>/plots/before_*.png`
...
Plots land in: `data/eval/manufacturing/<pipeline>/<run_id>/plots/after_*.png`
