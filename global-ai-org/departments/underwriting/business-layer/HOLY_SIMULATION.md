# HOLY_SIMULATION.md · Dept 4 · Underwriting
...
## Backend API
- `POST /api/v1/holy/sim/underwriting/{process}/run`
- `GET /api/v1/holy/sim/underwriting/{process}/runs/{sim_id}/events` (SSE)
- `GET /api/v1/holy/sim/underwriting/{process}/runs/{sim_id}/manifest`
- `GET /api/v1/holy/sim/underwriting/{process}/runs/{sim_id}/replay`
