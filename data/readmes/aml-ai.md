# AML AI · Comprehensive README · §137

**Effective**: 2026-06-11 · **Slug**: `aml-ai` · **Kind**: `tabular_ml`
**Accuracy**: 0.955 · **Algorithm**: GradientBoostingClassifier

---

## 1. BRD · Business Requirements Document

**Business goal**: Reduce manual effort + improve accuracy for aml ai tasks in
...
**FR-1**: System MUST accept input matching `aml-ai` schema
...
Caller (frontend/agent)
        │
        ▼
  /api/v1/ai-types/aml-ai/predict
        │
        ▼
...
- `predictions_aml-ai`: id · input_jsonb · output · confidence · timestamp

**Endpoints**:
- `POST /api/v1/ai-types/aml-ai/predict` · body: features → prediction
- `GET /api/v1/ai-types/aml-ai/metrics` → live metrics.json
- `GET /api/v1/ai-types/aml-ai/explain/{prediction_id}` → SHAP
...
```
[router.py] → [model_loader.py] → [/models/aml-ai/model.joblib]
            ↘ [preprocessor.py]
...
**Fairness metrics** (from data/fairness/aml-ai.json):
