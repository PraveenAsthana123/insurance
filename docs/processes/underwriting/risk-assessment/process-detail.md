...
> Department 4 · Underwriting · slug `risk-assessment` · AI items: 5
...
- **One-liner**: TODO
- **Demo URL**: `http://192.168.1.88:3210/insurance/4/<domain>/risk-assessment?tab=user-demo`
- **Recording**: TODO
...
Simulation URL: `http://192.168.1.88:3210/insurance/4/<domain>/risk-assessment?tab=simulation`
...
Release summary: auto-gen `docs/processes/underwriting/risk-assessment/release-summary-vX.Y.md` covering §1 problem · §4 impact deltas · §10 phase scorecard · §11 test pass/fail · top 3 failure modes · sign-off · git SHA + image digest.
...
Gold set: `data/eval/underwriting/risk-assessment/gold_set.jsonl` (100-500 queries · stratified · monthly refresh).
...
→ Tab: `?tab=resai` · evidence files: `data/eval/underwriting/risk-assessment/resai/`
...
→ Tab: `?tab=expai` · artifacts: `data/eval/underwriting/risk-assessment/expai/`
...
→ Tab: `?tab=analysis` · evidence: `data/eval/underwriting/risk-assessment/stats/`
