# HOLY Beverage — Marketing — Contact Center Automation
...
**Manager** + **CX role** (dept = marketing). For non-CX depts this covers
...
|---|---|---|---|---|
| 1 | _stub: replace with real intent for marketing_ | _ | yes/no | DistilBERT |
| … | (20 total minimum) | | | |
...
- LLM model: `gemma3:4b` (default for marketing) — adjust per latency/cost SLO
- RAG corpus: `data/marketing/kb/` + `data/marketing/sops/`
