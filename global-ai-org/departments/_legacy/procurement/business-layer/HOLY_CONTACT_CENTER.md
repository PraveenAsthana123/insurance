# HOLY Beverage — Procurement — Contact Center Automation
...
**Manager** + **CX role** (dept = procurement). For non-CX depts this covers
...
|---|---|---|---|---|
| 1 | _stub: replace with real intent for procurement_ | _ | yes/no | DistilBERT |
| … | (20 total minimum) | | | |
...
- LLM model: `gemma3:4b` (default for procurement) — adjust per latency/cost SLO
- RAG corpus: `data/procurement/kb/` + `data/procurement/sops/`
