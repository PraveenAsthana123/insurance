# HOLY Beverage — It Operations — Contact Center Automation
...
**Manager** + **CX role** (dept = it-operations). For non-CX depts this covers
...
|---|---|---|---|---|
| 1 | _stub: replace with real intent for it-operations_ | _ | yes/no | DistilBERT |
| … | (20 total minimum) | | | |
...
- LLM model: `gemma3:4b` (default for it-operations) — adjust per latency/cost SLO
- RAG corpus: `data/it-operations/kb/` + `data/it-operations/sops/`
