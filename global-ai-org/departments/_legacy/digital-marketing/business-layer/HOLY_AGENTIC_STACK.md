# HOLY Beverage — Digital Marketing — Agentic Stack
...
> actions against and the required scope for each. The Digital Marketing manager owns
> reviews; AI-Strategy owns scope grants.

## Owner

**Manager (Digital Marketing)** + **AI-Strategy** + **Information Security**.

## 10-layer execution flow (§64.40)

Every Digital Marketing agent action MUST traverse layers 1 → 10 in order. Skipping any
...
| OS | What it gives Digital Marketing agents |
|---|---|
...
| **Harness Agent** | Cross-agent sync between Digital Marketing and adjacent depts (handoffs) |
...
co-approval. The grant lives in [config/scopes/digital-marketing.yaml](../../../../config/scopes/digital-marketing.yaml)
...
| Action irreversible (deletion, signing) | Manager (Digital Marketing) approval |
| Confidence < 0.6 | Manager (Digital Marketing) review queue |
...
will enforce every grant in `config/scopes/digital-marketing.yaml` has a matching audit
