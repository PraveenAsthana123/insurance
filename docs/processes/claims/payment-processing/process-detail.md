...
> Department 7 · Claims · slug `payment-processing` · AI items: 4
...
- **One-liner**: TODO
- **Demo URL**: `http://192.168.1.88:3210/insurance/7/<domain>/payment-processing?tab=user-demo`
- **Recording**: TODO
...
Simulation URL: `http://192.168.1.88:3210/insurance/7/<domain>/payment-processing?tab=simulation`
...
Release summary: auto-gen `docs/processes/claims/payment-processing/release-summary-vX.Y.md` covering §1 problem · §4 impact deltas · §10 phase scorecard · §11 test pass/fail · top 3 failure modes · sign-off · git SHA + image digest.
...
Gold set: `data/eval/claims/payment-processing/gold_set.jsonl` (100-500 queries · stratified · monthly refresh).
...
→ Tab: `?tab=resai` · evidence files: `data/eval/claims/payment-processing/resai/`
...
→ Tab: `?tab=expai` · artifacts: `data/eval/claims/payment-processing/expai/`
...
→ Tab: `?tab=analysis` · evidence: `data/eval/claims/payment-processing/stats/`
