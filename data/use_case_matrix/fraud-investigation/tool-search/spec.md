# §140 · fraud-investigation × tool-search · Use Case Spec

## Purpose
PRIMARY fit · Ops technique applied to fraud-investigation domain.
...
## Example use case
Fraud Investigation use case applying tool-search to tool catalog.
