"""Tier 1 — Unit tests for customer-experience.
...
def test_dept_module_imports():
    ...
    assert "customer-experience" in "customer-experience", "dept name must match"
...
@pytest.mark.skip(reason="placeholder — replace with real customer-experience unit test")
def test_real_dept_logic():
    """REPLACE — real unit test for customer-experience business logic."""
    pass
