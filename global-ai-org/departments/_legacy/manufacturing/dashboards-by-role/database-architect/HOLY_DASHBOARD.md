# HOLY Beverage — Manufacturing — Database Architect Dashboard

> Per global CLAUDE.md §64.37 — every (dept, role) pair MUST have a
> role-scoped dashboard. This is the dashboard for **database-architect** in **manufacturing**.

## Persona

The **database-architect** at Manufacturing. They use this dashboard
...
returned by backend `GET /api/v1/holy/dashboards/manufacturing/database-architect/charts/<chart_id>`.
...
```
GET /api/v1/holy/dashboards/manufacturing/database-architect
  → {tiles: [...], charts: [...], filters: {...}, refreshed_at}

GET /api/v1/holy/dashboards/manufacturing/database-architect/charts/<chart_id>
...
- Frontend route: `/holy/manufacturing/dashboard?role=database-architect`
