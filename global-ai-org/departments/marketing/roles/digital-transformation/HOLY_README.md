# Marketing — Digital Transformation (HOLY)
...
## How this role uses HOLY's Marketing platform

- **Navigates** via `HOLY_NAV.json` (left-sidebar process picker; see `/holy/marketing` in frontend)
...
NLP, GenAI, Recommendation AI, Attribution ML, Brand-safety AI

## Tech stack this role touches

- Adobe + Salesforce Marketing Cloud
- Python + scikit-learn
- OpenAI / Anthropic for content
- Snowflake + dbt
