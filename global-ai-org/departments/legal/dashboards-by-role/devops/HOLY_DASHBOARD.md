# HOLY Beverage — Legal — Devops Dashboard

> Per global CLAUDE.md §64.37 — every (dept, role) pair MUST have a
> role-scoped dashboard. This is the dashboard for **devops** in **legal**.

## Persona

The **devops** at Legal. They use this dashboard
...
returned by backend `GET /api/v1/holy/dashboards/legal/devops/charts/<chart_id>`.
...
```
GET /api/v1/holy/dashboards/legal/devops
  → {tiles: [...], charts: [...], filters: {...}, refreshed_at}

GET /api/v1/holy/dashboards/legal/devops/charts/<chart_id>
...
- Frontend route: `/holy/legal/dashboard?role=devops`
