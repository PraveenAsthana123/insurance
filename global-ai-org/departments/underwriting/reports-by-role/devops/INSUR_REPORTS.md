# Underwriting — devops Reports

Per global §64.37 — role-scoped reports (≥ 3 standard per role).

## Standard reports

### R1 — Underwriting devops digest
...
## API
```
GET  /api/v1/insur/reports/underwriting/devops
POST /api/v1/insur/reports/underwriting/devops/{report_id}/run
```
