# Ethical AI · Comprehensive README · §137

**Effective**: 2026-06-11 · **Slug**: `ethical-ai` · **Kind**: `ops_existing`
...
**Business goal**: Reduce manual effort + improve accuracy for ethical ai tasks in
...
**FR-1**: System MUST accept input matching `ethical-ai` schema
...
Caller (frontend/agent)
        │
        ▼
  /api/v1/ai-types/ethical-ai/predict
        │
        ▼
...
- `predictions_ethical-ai`: id · input_jsonb · output · confidence · timestamp

**Endpoints**:
- `POST /api/v1/ai-types/ethical-ai/predict` · body: features → prediction
- `GET /api/v1/ai-types/ethical-ai/metrics` → live metrics.json
- `GET /api/v1/ai-types/ethical-ai/explain/{prediction_id}` → SHAP
...
```
[router.py] → [model_loader.py] → [/models/ethical-ai/model.joblib]
            ↘ [preprocessor.py]
...
- collection: `ethical-ai_embeddings`
...
**Fairness metrics** (from data/fairness/ethical-ai.json):
