...
test.describe('security-operations smoke tests', () => {
  test('INSUR nav page for security-operations loads', async ({ page }) => {
    await page.goto('http://localhost:3000/insur/security-operations');
    await expect(page).toHaveURL(/\/insur\/security-operations/);
