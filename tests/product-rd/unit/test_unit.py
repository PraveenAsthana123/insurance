"""Tier 1 — Unit tests for product-rd.
...
def test_dept_module_imports():
    ...
    assert "product-rd" in "product-rd", "dept name must match"
...
@pytest.mark.skip(reason="placeholder — replace with real product-rd unit test")
def test_real_dept_logic():
    """REPLACE — real unit test for product-rd business logic."""
    pass
