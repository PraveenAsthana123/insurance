# §140 · procurement × cv-classification · Use Case Spec

## Purpose
Cross-cutting fit · CV technique applied to procurement domain.
...
## Example use case
Procurement use case applying cv-classification to images.
