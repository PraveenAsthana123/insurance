# HOLY Beverage — Sales — Contact Management (customer + vendor + internal)
...
- Sync: scheduled inbound from sales's CRM / ERP / HRIS
...
|---|---|---|
| GET /api/v1/holy/contacts/sales/customers | list | manager / data-owner |
| GET /api/v1/holy/contacts/sales/vendors | list | manager / procurement |
| GET /api/v1/holy/contacts/sales/internal | list | any dept role |
| POST /api/v1/holy/contacts/sales/customers | create | admin / manager |
| PUT /api/v1/holy/contacts/sales/customers/{id} | update | admin / data-owner |
| DELETE /api/v1/holy/contacts/sales/customers/{id} | soft-delete | admin |
