# Underwriting — api-architect Reports

Per global §64.37 — role-scoped reports (≥ 3 standard per role).

## Standard reports

### R1 — Underwriting api-architect digest
...
## API
```
GET  /api/v1/insur/reports/underwriting/api-architect
POST /api/v1/insur/reports/underwriting/api-architect/{report_id}/run
```
