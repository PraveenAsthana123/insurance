# HOLY Beverage — Legal — Simulation Tab
...
under `REFERENCE_PROCESSES[("legal", "<process>")]`.
...
| Endpoint | Purpose |
|---|---|
| POST /api/v1/holy/sim/legal/{process}/run | Trigger simulation |
| GET /api/v1/holy/sim/legal/{process}/runs | List past runs |
| GET /api/v1/holy/sim/legal/{process}/runs/{sim_id}/manifest | Per-run summary |
| GET /api/v1/holy/sim/legal/{process}/runs/{sim_id}/events | Event stream |

## TODO

- [ ] Define ≥ 1 process for legal in `REFERENCE_PROCESSES` dict
