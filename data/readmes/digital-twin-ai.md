# Digital Twin AI · Comprehensive README · §137

**Effective**: 2026-06-11 · **Slug**: `digital-twin-ai` · **Kind**: `spec_only`
...
**Business goal**: Reduce manual effort + improve accuracy for digital twin ai tasks in
...
**FR-1**: System MUST accept input matching `digital-twin-ai` schema
...
Caller (frontend/agent)
        │
        ▼
  /api/v1/ai-types/digital-twin-ai/predict
        │
        ▼
...
- `predictions_digital-twin-ai`: id · input_jsonb · output · confidence · timestamp

**Endpoints**:
- `POST /api/v1/ai-types/digital-twin-ai/predict` · body: features → prediction
- `GET /api/v1/ai-types/digital-twin-ai/metrics` → live metrics.json
- `GET /api/v1/ai-types/digital-twin-ai/explain/{prediction_id}` → SHAP
...
```
[router.py] → [model_loader.py] → [/models/digital-twin-ai/model.joblib]
            ↘ [preprocessor.py]
...
- collection: `digital-twin-ai_embeddings`
...
**Fairness metrics** (from data/fairness/digital-twin-ai.json):
