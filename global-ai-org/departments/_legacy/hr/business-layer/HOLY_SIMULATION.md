# HOLY Beverage — Hr — Simulation Tab
...
under `REFERENCE_PROCESSES[("hr", "<process>")]`.
...
| Endpoint | Purpose |
|---|---|
| POST /api/v1/holy/sim/hr/{process}/run | Trigger simulation |
| GET /api/v1/holy/sim/hr/{process}/runs | List past runs |
| GET /api/v1/holy/sim/hr/{process}/runs/{sim_id}/manifest | Per-run summary |
| GET /api/v1/holy/sim/hr/{process}/runs/{sim_id}/events | Event stream |

## TODO

- [ ] Define ≥ 1 process for hr in `REFERENCE_PROCESSES` dict
