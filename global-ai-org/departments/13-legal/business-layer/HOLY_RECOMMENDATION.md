# HOLY_RECOMMENDATION.md · Dept 13 · legal
...
Recommendation system for Dept 13 (legal). All 3 classical flavors covered per §64.22.
...
**Algorithm**: Caselaw dense retrieval (LegalBERT)
...
**Algorithm**: Rerank · clause + precedent + jurisdiction blend
