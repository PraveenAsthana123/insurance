# HOLY Beverage — Manufacturing — Tester Dashboard

> Per global CLAUDE.md §64.37 — every (dept, role) pair MUST have a
> role-scoped dashboard. This is the dashboard for **tester** in **manufacturing**.

## Persona

The **tester** at Manufacturing. They use this dashboard
...
returned by backend `GET /api/v1/holy/dashboards/manufacturing/tester/charts/<chart_id>`.
...
```
GET /api/v1/holy/dashboards/manufacturing/tester
  → {tiles: [...], charts: [...], filters: {...}, refreshed_at}

GET /api/v1/holy/dashboards/manufacturing/tester/charts/<chart_id>
...
- Frontend route: `/holy/manufacturing/dashboard?role=tester`
