...
3 endpoints under /api/v1/insur/evals/safety/* federated via core.insur_audit
...
router = APIRouter(
    prefix="/api/v1/insur/evals/safety",
    tags=["insur", "evals", "safety"],
)
...
def safety_global(http_request: Request) -> dict[str, Any]:
    ...
    log_insur_access(http_request, "evals_safety", "safety_global")
...
def safety_incidents(
    ...
    log_insur_access(http_request, "evals_safety", "safety_incidents",
