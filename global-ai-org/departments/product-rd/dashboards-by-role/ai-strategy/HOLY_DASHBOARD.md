# HOLY Beverage — Product Rd — Ai Strategy Dashboard

> Per global CLAUDE.md §64.37 — every (dept, role) pair MUST have a
> role-scoped dashboard. This is the dashboard for **ai-strategy** in **product-rd**.

## Persona

The **ai-strategy** at Product Rd. They use this dashboard
...
returned by backend `GET /api/v1/holy/dashboards/product-rd/ai-strategy/charts/<chart_id>`.
...
```
GET /api/v1/holy/dashboards/product-rd/ai-strategy
  → {tiles: [...], charts: [...], filters: {...}, refreshed_at}

GET /api/v1/holy/dashboards/product-rd/ai-strategy/charts/<chart_id>
...
- Frontend route: `/holy/product-rd/dashboard?role=ai-strategy`
