# Data Quality AI · Comprehensive README · §137

**Effective**: 2026-06-11 · **Slug**: `data-quality-ai` · **Kind**: `ops_existing`
...
**Business goal**: Reduce manual effort + improve accuracy for data quality ai tasks in
...
**FR-1**: System MUST accept input matching `data-quality-ai` schema
...
Caller (frontend/agent)
        │
        ▼
  /api/v1/ai-types/data-quality-ai/predict
        │
        ▼
...
- `predictions_data-quality-ai`: id · input_jsonb · output · confidence · timestamp

**Endpoints**:
- `POST /api/v1/ai-types/data-quality-ai/predict` · body: features → prediction
- `GET /api/v1/ai-types/data-quality-ai/metrics` → live metrics.json
- `GET /api/v1/ai-types/data-quality-ai/explain/{prediction_id}` → SHAP
...
```
[router.py] → [model_loader.py] → [/models/data-quality-ai/model.joblib]
            ↘ [preprocessor.py]
...
- collection: `data-quality-ai_embeddings`
...
**Fairness metrics** (from data/fairness/data-quality-ai.json):
