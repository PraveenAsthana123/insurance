# HOLY Beverage — Sales — Data Owner Dashboard

> Per global CLAUDE.md §64.37 — every (dept, role) pair MUST have a
> role-scoped dashboard. This is the dashboard for **data-owner** in **sales**.

## Persona

The **data-owner** at Sales. They use this dashboard
...
returned by backend `GET /api/v1/holy/dashboards/sales/data-owner/charts/<chart_id>`.
...
```
GET /api/v1/holy/dashboards/sales/data-owner
  → {tiles: [...], charts: [...], filters: {...}, refreshed_at}

GET /api/v1/holy/dashboards/sales/data-owner/charts/<chart_id>
...
- Frontend route: `/holy/sales/dashboard?role=data-owner`
