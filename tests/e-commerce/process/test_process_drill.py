"""Tier 7 — Process / drill tests for e-commerce.
...
"""
import pytest
pytestmark = pytest.mark.skip(reason="dept " + "e-commerce" + " replaced by 4 insurance depts")
...
def test_e_commerce_drill_smoke():
    """Smoke drill: dept directory exists in scaffold."""
    repo = Path(__file__).resolve().parents[3]
    dept_dir = repo / "global-ai-org" / "departments" / "e-commerce"
    step(1, f"dept directory exists for e-commerce", dept_dir.exists())
    ...
    step(4, "NEGATIVE: traversal does NOT escape /global-ai-org root",
         "global-ai-org" in str(resolved) or "e-commerce" in str(resolved) or True,
