# §140 · supply-chain × small-data-fewshot · Use Case Spec

## Purpose
Cross-cutting fit · ML technique applied to supply-chain domain.
...
## Example use case
Supply Chain use case applying small-data-fewshot to few labels.
