"""Tier 11-12 — Security tests for product-rd.
...
def test_product_rd_owasp_zap_scan():
    """REPLACE — invoke OWASP ZAP CLI against product-rd surface (auth env only)."""
    pass


@pytest.mark.skip(reason="placeholder — requires Garak install + AI endpoint")
def test_product_rd_garak_prompt_injection():
