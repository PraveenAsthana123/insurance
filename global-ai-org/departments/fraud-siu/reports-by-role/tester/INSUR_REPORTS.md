# Fraud / Special Investigations Unit (SIU) — tester Reports

Per global §64.37 — role-scoped reports (≥ 3 standard per role).

## Standard reports

### R1 — Fraud / Special Investigations Unit (SIU) tester digest
...
## API
```
GET  /api/v1/insur/reports/fraud-siu/tester
POST /api/v1/insur/reports/fraud-siu/tester/{report_id}/run
```
