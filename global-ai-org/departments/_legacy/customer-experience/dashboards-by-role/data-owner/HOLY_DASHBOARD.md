# HOLY Beverage — Customer Experience — Data Owner Dashboard

> Per global CLAUDE.md §64.37 — every (dept, role) pair MUST have a
> role-scoped dashboard. This is the dashboard for **data-owner** in **customer-experience**.

## Persona

The **data-owner** at Customer Experience. They use this dashboard
...
returned by backend `GET /api/v1/holy/dashboards/customer-experience/data-owner/charts/<chart_id>`.
...
```
GET /api/v1/holy/dashboards/customer-experience/data-owner
  → {tiles: [...], charts: [...], filters: {...}, refreshed_at}

GET /api/v1/holy/dashboards/customer-experience/data-owner/charts/<chart_id>
...
- Frontend route: `/holy/customer-experience/dashboard?role=data-owner`
