# HOLY Beverage — E Commerce C4 Model
...
graph LR
    ...
    features --> model[Recommendation AI, Personalization AI, Predictive ML, Fraud AI, GenAI]
...
- Decision lineage: every API call writes a row to `e_commerce_audit` (see LLD §2)

## L6 — Observability

- Logs: structured JSON with `correlation_id`, `tenant_id`, `user_id`, `model_version`, `prompt_version`
- Metrics: `e-commerce_request_count`, `e-commerce_latency_p95`, `e-commerce_model_confidence`, `e-commerce_hallucination_rate`
