# HOLY Beverage — Operations — Contact Center Automation
...
**Manager** + **CX role** (dept = operations). For non-CX depts this covers
...
|---|---|---|---|---|
| 1 | _stub: replace with real intent for operations_ | _ | yes/no | DistilBERT |
| … | (20 total minimum) | | | |
...
- LLM model: `gemma3:4b` (default for operations) — adjust per latency/cost SLO
- RAG corpus: `data/operations/kb/` + `data/operations/sops/`
