# HOLY Beverage — Manufacturing — Data Downloads
...
|---|---|---|---|---|---|
| 1 | `defect_inspection_sample` | Defect detection sample | tabular | 5 | 5 |
| 2 | `predictive_maint_sample` | Predictive maintenance sample | timeseries | 5 | 5 |
| 3 | `oee_sample` | OEE optimization sample | tabular | 5 | 5 |
...
### 3.x `defect_inspection_sample`

- **Title:** Defect detection sample
- **Lifecycle:** tabular
- **Columns (5):** unit_id, line_id, defect_class, confidence, diverted
- **Sample size:** 5 rows (download to see full)

### 3.x `predictive_maint_sample`

- **Title:** Predictive maintenance sample
- **Lifecycle:** timeseries
- **Columns (5):** machine_id, temp_c, vib_hz, current_a, rul_days
- **Sample size:** 5 rows (download to see full)

### 3.x `oee_sample`

- **Title:** OEE optimization sample
- **Lifecycle:** tabular
- **Columns (5):** line_id, availability, performance, quality, oee
- **Sample size:** 5 rows (download to see full)
...
| Endpoint | Returns |
|---|---|
| `GET /api/v1/holy/downloads/manufacturing` | Catalog (datasets + URLs) |
| `GET /api/v1/holy/downloads/manufacturing/<dataset_id>.csv` | CSV file |
| `GET /api/v1/holy/downloads/manufacturing/<dataset_id>.json` | JSON file |
| `GET /api/v1/holy/downloads/manufacturing/<dataset_id>.before.svg` | Pre-process viz |
| `GET /api/v1/holy/downloads/manufacturing/<dataset_id>.after.svg` | Post-process viz |
