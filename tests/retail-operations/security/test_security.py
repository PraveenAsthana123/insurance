"""Tier 11-12 — Security tests for retail-operations.
...
def test_retail_operations_owasp_zap_scan():
    """REPLACE — invoke OWASP ZAP CLI against retail-operations surface (auth env only)."""
    pass


@pytest.mark.skip(reason="placeholder — requires Garak install + AI endpoint")
def test_retail_operations_garak_prompt_injection():
