...
> Department 7 · Claims · slug `investigation` · AI items: 5
...
- **One-liner**: TODO
- **Demo URL**: `http://192.168.1.88:3210/insurance/7/<domain>/investigation?tab=user-demo`
- **Recording**: TODO
...
Simulation URL: `http://192.168.1.88:3210/insurance/7/<domain>/investigation?tab=simulation`
...
Release summary: auto-gen `docs/processes/claims/investigation/release-summary-vX.Y.md` covering §1 problem · §4 impact deltas · §10 phase scorecard · §11 test pass/fail · top 3 failure modes · sign-off · git SHA + image digest.
...
Gold set: `data/eval/claims/investigation/gold_set.jsonl` (100-500 queries · stratified · monthly refresh).
...
→ Tab: `?tab=resai` · evidence files: `data/eval/claims/investigation/resai/`
...
→ Tab: `?tab=expai` · artifacts: `data/eval/claims/investigation/expai/`
...
→ Tab: `?tab=analysis` · evidence: `data/eval/claims/investigation/stats/`
