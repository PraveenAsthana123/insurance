# HOLY Beverage — Digital Marketing — Ai Strategy Dashboard

> Per global CLAUDE.md §64.37 — every (dept, role) pair MUST have a
> role-scoped dashboard. This is the dashboard for **ai-strategy** in **digital-marketing**.

## Persona

The **ai-strategy** at Digital Marketing. They use this dashboard
...
returned by backend `GET /api/v1/holy/dashboards/digital-marketing/ai-strategy/charts/<chart_id>`.
...
```
GET /api/v1/holy/dashboards/digital-marketing/ai-strategy
  → {tiles: [...], charts: [...], filters: {...}, refreshed_at}

GET /api/v1/holy/dashboards/digital-marketing/ai-strategy/charts/<chart_id>
...
- Frontend route: `/holy/digital-marketing/dashboard?role=ai-strategy`
