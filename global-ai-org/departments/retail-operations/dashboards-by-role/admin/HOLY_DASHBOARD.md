# HOLY Beverage — Retail Operations — Admin Dashboard

> Per global CLAUDE.md §64.37 — every (dept, role) pair MUST have a
> role-scoped dashboard. This is the dashboard for **admin** in **retail-operations**.

## Persona

The **admin** at Retail Operations. They use this dashboard
...
returned by backend `GET /api/v1/holy/dashboards/retail-operations/admin/charts/<chart_id>`.
...
```
GET /api/v1/holy/dashboards/retail-operations/admin
  → {tiles: [...], charts: [...], filters: {...}, refreshed_at}

GET /api/v1/holy/dashboards/retail-operations/admin/charts/<chart_id>
...
- Frontend route: `/holy/retail-operations/dashboard?role=admin`
