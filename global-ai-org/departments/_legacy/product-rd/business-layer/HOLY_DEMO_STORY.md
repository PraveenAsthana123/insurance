# HOLY Beverage — Product Rd — Demo User Story
...
The persona needs to: **compress new-flavor TTM from 14 months to 6 months**

Main KPI being moved: **Time-to-market, recipe success rate, sensory panel acceptance**

## 3. Walkthrough (what they see + do)

1. Persona lands on `/holy/product-rd` (the HOLY navigation page for this dept).
...
> "Today Dr. Priya spends 80% of their week on manual data
...
> counterfactual. We don't replace Dr. Priya — we replace
...
|---|---|---|---|
| 1 | Open `/holy/product-rd` | Left sidebar with N processes | "Every process this dept owns, surfaced as navigable artifacts" |
...
**Cross-reference**: This story powers the demo at `/holy/product-rd` in the
HOLY frontend. The literal click-by-click in §5 is also the drill
`tests/drills/drill_dept_demo_product_rd.py` (planned).
