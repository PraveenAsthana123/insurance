# Customer Service / Contact Center — team-member Dashboard

Per global §64.37 — role-scoped dashboard.

## Persona
**team-member** in Customer Service / Contact Center.
...
## API
```
GET /api/v1/insur/dashboards/customer-service/team-member
```
