# HOLY_RECOMMENDATION.md · Dept 21 · partner
...
Recommendation system for Dept 21 (partner). All 3 classical flavors covered per §64.22.

## Item-based (collaborative filter)

**Algorithm**: Item-item collaborative (partner × product)
...
**Algorithm**: Partner profile embedding (vertical + scale + region)
...
**Algorithm**: XGBoost + tier blend · partner-fit ranking
