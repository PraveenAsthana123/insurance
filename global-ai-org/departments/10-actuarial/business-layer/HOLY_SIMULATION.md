# HOLY_SIMULATION.md · Dept 10 · Actuarial
...
## Backend API
- `POST /api/v1/holy/sim/actuarial/{process}/run`
- `GET /api/v1/holy/sim/actuarial/{process}/runs/{sim_id}/events` (SSE)
- `GET /api/v1/holy/sim/actuarial/{process}/runs/{sim_id}/manifest`
- `GET /api/v1/holy/sim/actuarial/{process}/runs/{sim_id}/replay`
