# HOLY Beverage — Digital Marketing — Data Downloads
...
|---|---|---|---|---|---|
| 1 | `digital_marketing_primary_sample` | Digital Marketing primary use-case sample | tabular | 5 | 5 |
...
### 3.x `digital_marketing_primary_sample`

- **Title:** Digital Marketing primary use-case sample
- **Lifecycle:** tabular
...
| Endpoint | Returns |
|---|---|
| `GET /api/v1/holy/downloads/digital-marketing` | Catalog (datasets + URLs) |
| `GET /api/v1/holy/downloads/digital-marketing/<dataset_id>.csv` | CSV file |
| `GET /api/v1/holy/downloads/digital-marketing/<dataset_id>.json` | JSON file |
| `GET /api/v1/holy/downloads/digital-marketing/<dataset_id>.before.svg` | Pre-process viz |
| `GET /api/v1/holy/downloads/digital-marketing/<dataset_id>.after.svg` | Post-process viz |
