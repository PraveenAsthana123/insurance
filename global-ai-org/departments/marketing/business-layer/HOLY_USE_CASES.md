# HOLY Beverage — Marketing — AI Use-Case Catalog
...
> use cases for **marketing**. Implementation status tracked per current
> codebase state.
...
|---|---|---|
| ✅ Implemented | **16** of 32 | Working module exists in `backend/ml/reference/*.py` (drill-locked) |
| 🟡 Partial | **10** of 32 | Existing module applies; dept-specific stub deferred |
| ❌ Not yet | **6** of 32 | Backlogged — needs new module or external integration |
...
| Use Case | Category | Data Types | AI Area | Business Value | Status |
|---|---|---|---|---|---|
| Campaign Optimization AI | Marketing AI | campaign metrics | Predictive Analytics | Better ROAS | 🟡 full_lifecycle.py applicable; campaign-specific stub deferred |
| Content Generation AI | Marketing AI | text/image/video | GenAI | Faster campaigns | ❌ deferred (Stable Diffusion + LLM) |
| Customer Segmentation AI | Marketing AI | behavioral | Clustering ML | Targeted campaigns | 🟡 full_lifecycle.py can do KMeans add-on |
| Next Best Action AI | Marketing AI | journey events | Recommendation AI | Better engagement | ✅ recommendation_lifecycle.py |
| Churn Prediction AI | Marketing AI | customer history | Classification ML | Better retention | ✅ full_lifecycle.py (Telco churn smoke proves it) |
