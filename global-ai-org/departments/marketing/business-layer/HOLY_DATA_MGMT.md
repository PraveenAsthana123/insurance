# HOLY Beverage — Marketing — Input Data Mgmt + Before/After Viz
...
For every process AND sub-process in this dept (marketing), populate the 6
surfaces below. campaigns + creative + attribution is the primary data class for marketing.
...
Plots land in: `data/eval/marketing/<pipeline>/<run_id>/plots/before_*.png`
...
Plots land in: `data/eval/marketing/<pipeline>/<run_id>/plots/after_*.png`
