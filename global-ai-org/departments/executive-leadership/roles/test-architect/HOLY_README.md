# Executive Leadership — Test Architect (HOLY)

**Source:** operator brief 2026-05-21.

## Role focus in this department

test strategy across unit/integration/e2e/AI-eval

## What this role owns

test pyramid, golden datasets, AI evaluation harness, regression gates
...
- `../dashboards-by-role/test-architect/` — role-scoped dashboards (when authored)
- `../reports-by-role/test-architect/` — role-scoped reports (when authored)
