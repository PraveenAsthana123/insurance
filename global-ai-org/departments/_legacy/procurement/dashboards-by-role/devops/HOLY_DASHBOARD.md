# HOLY Beverage — Procurement — Devops Dashboard

> Per global CLAUDE.md §64.37 — every (dept, role) pair MUST have a
> role-scoped dashboard. This is the dashboard for **devops** in **procurement**.

## Persona

The **devops** at Procurement. They use this dashboard
...
returned by backend `GET /api/v1/holy/dashboards/procurement/devops/charts/<chart_id>`.
...
```
GET /api/v1/holy/dashboards/procurement/devops
  → {tiles: [...], charts: [...], filters: {...}, refreshed_at}

GET /api/v1/holy/dashboards/procurement/devops/charts/<chart_id>
...
- Frontend route: `/holy/procurement/dashboard?role=devops`
