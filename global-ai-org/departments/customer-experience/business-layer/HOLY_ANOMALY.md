# HOLY Beverage — Customer Experience — Anomaly Detection
...
## Anomaly catalog (top 20 per customer-experience)

| # | Anomaly type | Severity | Tier | Auto-action | Backing data |
|---|---|---|---|---|---|
| 1 | _stub: anomaly for customer-experience_ | high | tier 2 | alert + auto-investigate | tickets + voice + chat |
