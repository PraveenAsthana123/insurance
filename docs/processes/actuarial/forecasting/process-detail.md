...
> Department 10 · Actuarial · slug `forecasting` · AI items: 4
...
- **One-liner**: TODO
- **Demo URL**: `http://192.168.1.88:3210/insurance/10/<domain>/forecasting?tab=user-demo`
- **Recording**: TODO
...
Simulation URL: `http://192.168.1.88:3210/insurance/10/<domain>/forecasting?tab=simulation`
...
Release summary: auto-gen `docs/processes/actuarial/forecasting/release-summary-vX.Y.md` covering §1 problem · §4 impact deltas · §10 phase scorecard · §11 test pass/fail · top 3 failure modes · sign-off · git SHA + image digest.
...
Gold set: `data/eval/actuarial/forecasting/gold_set.jsonl` (100-500 queries · stratified · monthly refresh).
...
→ Tab: `?tab=resai` · evidence files: `data/eval/actuarial/forecasting/resai/`
...
→ Tab: `?tab=expai` · artifacts: `data/eval/actuarial/forecasting/expai/`
...
→ Tab: `?tab=analysis` · evidence: `data/eval/actuarial/forecasting/stats/`
