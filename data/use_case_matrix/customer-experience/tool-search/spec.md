# §140 · customer-experience × tool-search · Use Case Spec

## Purpose
PRIMARY fit · Ops technique applied to customer-experience domain.
...
## Example use case
Customer Experience use case applying tool-search to tool catalog.
