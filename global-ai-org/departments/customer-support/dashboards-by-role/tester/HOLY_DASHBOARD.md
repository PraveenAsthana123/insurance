# HOLY Beverage — Customer Support — Tester Dashboard

> Per global CLAUDE.md §64.37 — every (dept, role) pair MUST have a
> role-scoped dashboard. This is the dashboard for **tester** in **customer-support**.

## Persona

The **tester** at Customer Support. They use this dashboard
...
returned by backend `GET /api/v1/holy/dashboards/customer-support/tester/charts/<chart_id>`.
...
```
GET /api/v1/holy/dashboards/customer-support/tester
  → {tiles: [...], charts: [...], filters: {...}, refreshed_at}

GET /api/v1/holy/dashboards/customer-support/tester/charts/<chart_id>
...
- Frontend route: `/holy/customer-support/dashboard?role=tester`
