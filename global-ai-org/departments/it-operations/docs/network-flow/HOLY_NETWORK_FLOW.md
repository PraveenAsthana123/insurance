# HOLY Beverage — It Operations Network Flow
...
```
It Operations API ──HTTP──► Auth Service           (RBAC + ABAC checks)
...
```
It Operations API ──HTTPS──► Vendor APIs            (Salesforce / SAP / etc.)
...
─────────────                  ───────────────          ──────────
Frontend UI       ──►          it-operations_user_events       analytics-svc
Backend API       ──►          it-operations_audit              audit-store
ML Worker         ──►          it-operations_predictions        prediction-store
Drift detector    ──►          it-operations_alerts             on-call PagerDuty
...
|---|---|---|---|
| it-operations-api | postgresql | 5432 | TCP |
| it-operations-api | redis | 6379 | TCP |
| it-operations-api | ollama | 11434 | TCP |
| it-operations-api | otel-collector | 4317 | gRPC |
| it-operations-api | (other dept APIs) | 8000 | HTTP via service mesh |
