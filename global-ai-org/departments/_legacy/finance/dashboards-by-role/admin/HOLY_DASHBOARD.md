# HOLY Beverage — Finance — Admin Dashboard

> Per global CLAUDE.md §64.37 — every (dept, role) pair MUST have a
> role-scoped dashboard. This is the dashboard for **admin** in **finance**.

## Persona

The **admin** at Finance. They use this dashboard
...
returned by backend `GET /api/v1/holy/dashboards/finance/admin/charts/<chart_id>`.
...
```
GET /api/v1/holy/dashboards/finance/admin
  → {tiles: [...], charts: [...], filters: {...}, refreshed_at}

GET /api/v1/holy/dashboards/finance/admin/charts/<chart_id>
...
- Frontend route: `/holy/finance/dashboard?role=admin`
