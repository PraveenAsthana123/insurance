# HOLY Beverage — Executive Leadership — Contact Management (customer + vendor + internal)
...
- Sync: scheduled inbound from executive-leadership's CRM / ERP / HRIS
...
|---|---|---|
| GET /api/v1/holy/contacts/executive-leadership/customers | list | manager / data-owner |
| GET /api/v1/holy/contacts/executive-leadership/vendors | list | manager / procurement |
| GET /api/v1/holy/contacts/executive-leadership/internal | list | any dept role |
| POST /api/v1/holy/contacts/executive-leadership/customers | create | admin / manager |
| PUT /api/v1/holy/contacts/executive-leadership/customers/{id} | update | admin / data-owner |
| DELETE /api/v1/holy/contacts/executive-leadership/customers/{id} | soft-delete | admin |
