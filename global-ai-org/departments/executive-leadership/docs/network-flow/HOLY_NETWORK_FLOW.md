# HOLY Beverage — Executive Leadership Network Flow
...
```
Executive Leadership API ──HTTP──► Auth Service           (RBAC + ABAC checks)
...
```
Executive Leadership API ──HTTPS──► Vendor APIs            (Salesforce / SAP / etc.)
...
─────────────                  ───────────────          ──────────
Frontend UI       ──►          executive-leadership_user_events       analytics-svc
Backend API       ──►          executive-leadership_audit              audit-store
ML Worker         ──►          executive-leadership_predictions        prediction-store
Drift detector    ──►          executive-leadership_alerts             on-call PagerDuty
...
|---|---|---|---|
| executive-leadership-api | postgresql | 5432 | TCP |
| executive-leadership-api | redis | 6379 | TCP |
| executive-leadership-api | ollama | 11434 | TCP |
| executive-leadership-api | otel-collector | 4317 | gRPC |
| executive-leadership-api | (other dept APIs) | 8000 | HTTP via service mesh |
