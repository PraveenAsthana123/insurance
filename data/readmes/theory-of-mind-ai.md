# Theory of Mind AI · Comprehensive README · §137

**Effective**: 2026-06-11 · **Slug**: `theory-of-mind-ai` · **Kind**: `spec_only`
**Accuracy**: 0.9383 · **Algorithm**: GradientBoostingClassifier (per-type baseline)

---

## 1. BRD · Business Requirements Document

**Business goal**: Reduce manual effort + improve accuracy for theory of mind ai tasks in
...
**FR-1**: System MUST accept input matching `theory-of-mind-ai` schema
...
Caller (frontend/agent)
        │
        ▼
  /api/v1/ai-types/theory-of-mind-ai/predict
        │
        ▼
...
- `predictions_theory-of-mind-ai`: id · input_jsonb · output · confidence · timestamp

**Endpoints**:
- `POST /api/v1/ai-types/theory-of-mind-ai/predict` · body: features → prediction
- `GET /api/v1/ai-types/theory-of-mind-ai/metrics` → live metrics.json
- `GET /api/v1/ai-types/theory-of-mind-ai/explain/{prediction_id}` → SHAP
...
```
[router.py] → [model_loader.py] → [/models/theory-of-mind-ai/model.joblib]
            ↘ [preprocessor.py]
...
- collection: `theory-of-mind-ai_embeddings`
...
**Fairness metrics** (from data/fairness/theory-of-mind-ai.json):
