# HOLY Beverage — Supply Chain — Manager Dashboard

> Per global CLAUDE.md §64.37 — every (dept, role) pair MUST have a
> role-scoped dashboard. This is the dashboard for **manager** in **supply-chain**.

## Persona

The **manager** at Supply Chain. They use this dashboard
...
returned by backend `GET /api/v1/holy/dashboards/supply-chain/manager/charts/<chart_id>`.
...
```
GET /api/v1/holy/dashboards/supply-chain/manager
  → {tiles: [...], charts: [...], filters: {...}, refreshed_at}

GET /api/v1/holy/dashboards/supply-chain/manager/charts/<chart_id>
...
- Frontend route: `/holy/supply-chain/dashboard?role=manager`
