# §140 · procurement × small-data-fewshot · Use Case Spec

## Purpose
PRIMARY fit · ML technique applied to procurement domain.
...
## Example use case
New supplier scoring from 5-10 historical orders.
