# HOLY Beverage — Manufacturing — Ai Strategy Dashboard

> Per global CLAUDE.md §64.37 — every (dept, role) pair MUST have a
> role-scoped dashboard. This is the dashboard for **ai-strategy** in **manufacturing**.

## Persona

The **ai-strategy** at Manufacturing. They use this dashboard
...
returned by backend `GET /api/v1/holy/dashboards/manufacturing/ai-strategy/charts/<chart_id>`.
...
```
GET /api/v1/holy/dashboards/manufacturing/ai-strategy
  → {tiles: [...], charts: [...], filters: {...}, refreshed_at}

GET /api/v1/holy/dashboards/manufacturing/ai-strategy/charts/<chart_id>
...
- Frontend route: `/holy/manufacturing/dashboard?role=ai-strategy`
