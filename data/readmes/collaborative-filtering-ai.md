# Collaborative Filtering AI · Comprehensive README · §137

**Effective**: 2026-06-11 · **Slug**: `collaborative-filtering-ai` · **Kind**: `spec_only`
**Accuracy**: 0.9583 · **Algorithm**: GradientBoostingClassifier (per-type baseline)

---

## 1. BRD · Business Requirements Document

**Business goal**: Reduce manual effort + improve accuracy for collaborative filtering ai tasks in
...
**FR-1**: System MUST accept input matching `collaborative-filtering-ai` schema
...
Caller (frontend/agent)
        │
        ▼
  /api/v1/ai-types/collaborative-filtering-ai/predict
        │
        ▼
...
- `predictions_collaborative-filtering-ai`: id · input_jsonb · output · confidence · timestamp

**Endpoints**:
- `POST /api/v1/ai-types/collaborative-filtering-ai/predict` · body: features → prediction
- `GET /api/v1/ai-types/collaborative-filtering-ai/metrics` → live metrics.json
- `GET /api/v1/ai-types/collaborative-filtering-ai/explain/{prediction_id}` → SHAP
...
```
[router.py] → [model_loader.py] → [/models/collaborative-filtering-ai/model.joblib]
            ↘ [preprocessor.py]
...
- collection: `collaborative-filtering-ai_embeddings`
...
**Fairness metrics** (from data/fairness/collaborative-filtering-ai.json):
