# HOLY Beverage — Executive Leadership — Database Architect Dashboard

> Per global CLAUDE.md §64.37 — every (dept, role) pair MUST have a
> role-scoped dashboard. This is the dashboard for **database-architect** in **executive-leadership**.

## Persona

The **database-architect** at Executive Leadership. They use this dashboard
...
returned by backend `GET /api/v1/holy/dashboards/executive-leadership/database-architect/charts/<chart_id>`.
...
```
GET /api/v1/holy/dashboards/executive-leadership/database-architect
  → {tiles: [...], charts: [...], filters: {...}, refreshed_at}

GET /api/v1/holy/dashboards/executive-leadership/database-architect/charts/<chart_id>
...
- Frontend route: `/holy/executive-leadership/dashboard?role=database-architect`
