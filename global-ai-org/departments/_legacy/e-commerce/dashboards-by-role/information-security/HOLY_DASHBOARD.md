# HOLY Beverage — E Commerce — Information Security Dashboard

> Per global CLAUDE.md §64.37 — every (dept, role) pair MUST have a
> role-scoped dashboard. This is the dashboard for **information-security** in **e-commerce**.

## Persona

The **information-security** at E Commerce. They use this dashboard
...
returned by backend `GET /api/v1/holy/dashboards/e-commerce/information-security/charts/<chart_id>`.
...
```
GET /api/v1/holy/dashboards/e-commerce/information-security
  → {tiles: [...], charts: [...], filters: {...}, refreshed_at}

GET /api/v1/holy/dashboards/e-commerce/information-security/charts/<chart_id>
...
- Frontend route: `/holy/e-commerce/dashboard?role=information-security`
