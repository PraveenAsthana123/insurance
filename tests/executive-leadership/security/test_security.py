"""Tier 11-12 — Security tests for executive-leadership.
...
def test_executive_leadership_owasp_zap_scan():
    """REPLACE — invoke OWASP ZAP CLI against executive-leadership surface (auth env only)."""
    pass


@pytest.mark.skip(reason="placeholder — requires Garak install + AI endpoint")
def test_executive_leadership_garak_prompt_injection():
