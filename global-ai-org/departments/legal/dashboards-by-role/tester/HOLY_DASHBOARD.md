# HOLY Beverage — Legal — Tester Dashboard

> Per global CLAUDE.md §64.37 — every (dept, role) pair MUST have a
> role-scoped dashboard. This is the dashboard for **tester** in **legal**.

## Persona

The **tester** at Legal. They use this dashboard
...
returned by backend `GET /api/v1/holy/dashboards/legal/tester/charts/<chart_id>`.
...
```
GET /api/v1/holy/dashboards/legal/tester
  → {tiles: [...], charts: [...], filters: {...}, refreshed_at}

GET /api/v1/holy/dashboards/legal/tester/charts/<chart_id>
...
- Frontend route: `/holy/legal/dashboard?role=tester`
