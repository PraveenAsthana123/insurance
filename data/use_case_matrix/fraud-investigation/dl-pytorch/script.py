"""§140 · fraud-investigation × dl-pytorch scaffold · DL/Custom CNN.

Honest §57.7 scaffold. Wire real impl when:
- dataset for fraud-investigation is available + labeled
- torch installed
...
def run():
    return {
        "dept": "fraud-investigation",
        "technique": "dl-pytorch",
        "ref_model": "Custom CNN",
        "lib": "torch",
        "impl_level": "scaffold",
