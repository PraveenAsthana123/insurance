"""Tier 11-12 — Security tests for customer-experience.
...
def test_customer_experience_owasp_zap_scan():
    """REPLACE — invoke OWASP ZAP CLI against customer-experience surface (auth env only)."""
    pass


@pytest.mark.skip(reason="placeholder — requires Garak install + AI endpoint")
def test_customer_experience_garak_prompt_injection():
