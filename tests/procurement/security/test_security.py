"""Tier 11-12 — Security tests for procurement.
...
def test_procurement_owasp_zap_scan():
    """REPLACE — invoke OWASP ZAP CLI against procurement surface (auth env only)."""
    pass


@pytest.mark.skip(reason="placeholder — requires Garak install + AI endpoint")
def test_procurement_garak_prompt_injection():
