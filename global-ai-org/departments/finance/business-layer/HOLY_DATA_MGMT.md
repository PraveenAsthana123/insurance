# HOLY Beverage — Finance — Input Data Mgmt + Before/After Viz
...
For every process AND sub-process in this dept (finance), populate the 6
surfaces below. GL + AR + AP + cash is the primary data class for finance.
...
Plots land in: `data/eval/finance/<pipeline>/<run_id>/plots/before_*.png`
...
Plots land in: `data/eval/finance/<pipeline>/<run_id>/plots/after_*.png`
