# HOLY Beverage — Security Operations — Security Dashboard

> Per global CLAUDE.md §64.37 — every (dept, role) pair MUST have a
> role-scoped dashboard. This is the dashboard for **security** in **security-operations**.

## Persona

The **security** at Security Operations. They use this dashboard
...
returned by backend `GET /api/v1/holy/dashboards/security-operations/security/charts/<chart_id>`.
...
```
GET /api/v1/holy/dashboards/security-operations/security
  → {tiles: [...], charts: [...], filters: {...}, refreshed_at}

GET /api/v1/holy/dashboards/security-operations/security/charts/<chart_id>
...
- Frontend route: `/holy/security-operations/dashboard?role=security`
