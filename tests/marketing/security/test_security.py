"""Tier 11-12 — Security tests for marketing.
...
def test_marketing_owasp_zap_scan():
    """REPLACE — invoke OWASP ZAP CLI against marketing surface (auth env only)."""
    pass


@pytest.mark.skip(reason="placeholder — requires Garak install + AI endpoint")
def test_marketing_garak_prompt_injection():
