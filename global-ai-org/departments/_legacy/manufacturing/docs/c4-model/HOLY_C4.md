# HOLY Beverage — Manufacturing C4 Model
...
graph TB
    ...
    holy[HOLY Manufacturing Platform]
...
graph LR
    ...
    features --> model[Predictive ML, Computer Vision, IoT AI, Edge AI, Optimization AI]
...
- Decision lineage: every API call writes a row to `manufacturing_audit` (see LLD §2)

## L6 — Observability

- Logs: structured JSON with `correlation_id`, `tenant_id`, `user_id`, `model_version`, `prompt_version`
- Metrics: `manufacturing_request_count`, `manufacturing_latency_p95`, `manufacturing_model_confidence`, `manufacturing_hallucination_rate`
