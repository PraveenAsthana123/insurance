# HOLY Beverage — Procurement — Data Owner Dashboard

> Per global CLAUDE.md §64.37 — every (dept, role) pair MUST have a
> role-scoped dashboard. This is the dashboard for **data-owner** in **procurement**.

## Persona

The **data-owner** at Procurement. They use this dashboard
...
returned by backend `GET /api/v1/holy/dashboards/procurement/data-owner/charts/<chart_id>`.
...
```
GET /api/v1/holy/dashboards/procurement/data-owner
  → {tiles: [...], charts: [...], filters: {...}, refreshed_at}

GET /api/v1/holy/dashboards/procurement/data-owner/charts/<chart_id>
...
- Frontend route: `/holy/procurement/dashboard?role=data-owner`
