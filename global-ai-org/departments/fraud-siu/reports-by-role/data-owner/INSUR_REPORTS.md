# Fraud / Special Investigations Unit (SIU) — data-owner Reports

Per global §64.37 — role-scoped reports (≥ 3 standard per role).

## Standard reports

### R1 — Fraud / Special Investigations Unit (SIU) data-owner digest
...
## API
```
GET  /api/v1/insur/reports/fraud-siu/data-owner
POST /api/v1/insur/reports/fraud-siu/data-owner/{report_id}/run
```
