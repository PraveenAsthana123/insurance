# HOLY Beverage — Finance — Api Architect Dashboard

> Per global CLAUDE.md §64.37 — every (dept, role) pair MUST have a
> role-scoped dashboard. This is the dashboard for **api-architect** in **finance**.

## Persona

The **api-architect** at Finance. They use this dashboard
...
returned by backend `GET /api/v1/holy/dashboards/finance/api-architect/charts/<chart_id>`.
...
```
GET /api/v1/holy/dashboards/finance/api-architect
  → {tiles: [...], charts: [...], filters: {...}, refreshed_at}

GET /api/v1/holy/dashboards/finance/api-architect/charts/<chart_id>
...
- Frontend route: `/holy/finance/dashboard?role=api-architect`
