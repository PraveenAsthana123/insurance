# HOLY Beverage — Procurement — Database Architect Dashboard

> Per global CLAUDE.md §64.37 — every (dept, role) pair MUST have a
> role-scoped dashboard. This is the dashboard for **database-architect** in **procurement**.

## Persona

The **database-architect** at Procurement. They use this dashboard
...
returned by backend `GET /api/v1/holy/dashboards/procurement/database-architect/charts/<chart_id>`.
...
```
GET /api/v1/holy/dashboards/procurement/database-architect
  → {tiles: [...], charts: [...], filters: {...}, refreshed_at}

GET /api/v1/holy/dashboards/procurement/database-architect/charts/<chart_id>
...
- Frontend route: `/holy/procurement/dashboard?role=database-architect`
