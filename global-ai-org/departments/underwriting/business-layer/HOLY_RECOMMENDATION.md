# HOLY_RECOMMENDATION.md · Dept 4 · underwriting
...
Recommendation system for Dept 4 (underwriting). All 3 classical flavors covered per §64.22.

## Item-based (collaborative filter)

**Algorithm**: Two-tower NN (UW decision history)
...
**Algorithm**: Property attribute embedding match
...
**Algorithm**: XGBoost rerank · risk + history blend
