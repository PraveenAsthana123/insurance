# §140 · fraud-investigation × cv-detection · Use Case Spec

## Purpose
PRIMARY fit · CV technique applied to fraud-investigation domain.
...
## Example use case
Detect photo manipulation (image splicing) in claim evidence.
