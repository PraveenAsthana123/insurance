# §140 · fraud-investigation × transformer · Use Case Spec

## Purpose
Cross-cutting fit · NLP technique applied to fraud-investigation domain.
...
## Example use case
Fraud Investigation use case applying transformer to text.
