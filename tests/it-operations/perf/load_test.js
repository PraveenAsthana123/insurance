// Tier 9-10 — Performance + load test for it-operations.
//
// Recommended: k6 (per global §64.42).
//
// Run with:  k6 run tests/it-operations/perf/load_test.js
//
...
export default function () {
  ...
  check(res, {
    ...
    'has it-operations': (r) => r.body.includes('it-operations'),
  });
  sleep(1);
}
