# Customer Service / Contact Center — test-architect Dashboard

Per global §64.37 — role-scoped dashboard.

## Persona
**test-architect** in Customer Service / Contact Center.
...
## API
```
GET /api/v1/insur/dashboards/customer-service/test-architect
```
