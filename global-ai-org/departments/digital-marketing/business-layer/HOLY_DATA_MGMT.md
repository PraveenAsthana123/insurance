# HOLY Beverage — Digital Marketing — Input Data Mgmt + Before/After Viz
...
For every process AND sub-process in this dept (digital-marketing), populate the 6
surfaces below. clickstream + CRM is the primary data class for digital-marketing.
...
Plots land in: `data/eval/digital-marketing/<pipeline>/<run_id>/plots/before_*.png`
...
Plots land in: `data/eval/digital-marketing/<pipeline>/<run_id>/plots/after_*.png`
