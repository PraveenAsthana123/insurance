"""Tier 1 — Unit tests for marketing.
...
def test_dept_module_imports():
    ...
    assert "marketing" in "marketing", "dept name must match"
...
@pytest.mark.skip(reason="placeholder — replace with real marketing unit test")
def test_real_dept_logic():
    """REPLACE — real unit test for marketing business logic."""
    pass
