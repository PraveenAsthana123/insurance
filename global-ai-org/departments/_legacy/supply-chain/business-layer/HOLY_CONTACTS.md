# HOLY Beverage — Supply Chain — Contact Management (customer + vendor + internal)
...
- Sync: scheduled inbound from supply-chain's CRM / ERP / HRIS
...
|---|---|---|
| GET /api/v1/holy/contacts/supply-chain/customers | list | manager / data-owner |
| GET /api/v1/holy/contacts/supply-chain/vendors | list | manager / procurement |
| GET /api/v1/holy/contacts/supply-chain/internal | list | any dept role |
| POST /api/v1/holy/contacts/supply-chain/customers | create | admin / manager |
| PUT /api/v1/holy/contacts/supply-chain/customers/{id} | update | admin / data-owner |
| DELETE /api/v1/holy/contacts/supply-chain/customers/{id} | soft-delete | admin |
