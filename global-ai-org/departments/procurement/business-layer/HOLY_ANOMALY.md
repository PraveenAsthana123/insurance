# HOLY Beverage — Procurement — Anomaly Detection
...
## Anomaly catalog (top 20 per procurement)

| # | Anomaly type | Severity | Tier | Auto-action | Backing data |
|---|---|---|---|---|---|
| 1 | _stub: anomaly for procurement_ | high | tier 2 | alert + auto-investigate | spend + contracts + vendor data |
