# HOLY Beverage — Customer Experience — Incident Management (L1/L2/L3 + RAG)
...
|---|---|---|---|---|
| 1 | _stub: replace with real L1 issue for customer-experience_ | runbook URL | < 1 min | < 5 min |
...
- RAG corpus: `data/customer-experience/runbooks/` + `data/customer-experience/past-incidents/`
