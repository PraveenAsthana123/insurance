# HOLY Beverage — E Commerce — Anomaly Detection
...
## Anomaly catalog (top 20 per e-commerce)

| # | Anomaly type | Severity | Tier | Auto-action | Backing data |
|---|---|---|---|---|---|
| 1 | _stub: anomaly for e-commerce_ | high | tier 2 | alert + auto-investigate | clickstream + orders + sessions |
