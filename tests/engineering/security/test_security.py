"""Tier 11-12 — Security tests for engineering.
...
def test_engineering_owasp_zap_scan():
    """REPLACE — invoke OWASP ZAP CLI against engineering surface (auth env only)."""
    pass


@pytest.mark.skip(reason="placeholder — requires Garak install + AI endpoint")
def test_engineering_garak_prompt_injection():
