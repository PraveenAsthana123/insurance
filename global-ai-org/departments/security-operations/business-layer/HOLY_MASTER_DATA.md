# HOLY Beverage — Security Operations — Master Data

> Per operator 2026-05-24 — every dept publishes its master + reference
> data here. Focus: **asset-master + identity-master + threat-classification + control-catalog**.
...
This dept (**security-operations**) operates against the slice of the structure
...
| Endpoint | Returns |
|---|---|
| `GET /api/v1/holy/master-data/security-operations` | Schema catalog + per-entity owner |
| `GET /api/v1/holy/master-data/security-operations/customer?limit=20` | Customer master sample |
| `GET /api/v1/holy/master-data/security-operations/vendor?limit=20` | Vendor master sample |
| `GET /api/v1/holy/master-data/security-operations/product?limit=20` | Product master sample |
| `GET /api/v1/holy/master-data/security-operations/org-structure` | Org tree slice for this dept |
...
1. (+) `/api/v1/holy/master-data/security-operations` returns 200 + entity catalog
