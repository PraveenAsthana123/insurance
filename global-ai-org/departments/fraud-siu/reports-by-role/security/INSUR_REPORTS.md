# Fraud / Special Investigations Unit (SIU) — security Reports

Per global §64.37 — role-scoped reports (≥ 3 standard per role).

## Standard reports

### R1 — Fraud / Special Investigations Unit (SIU) security digest
...
## API
```
GET  /api/v1/insur/reports/fraud-siu/security
POST /api/v1/insur/reports/fraud-siu/security/{report_id}/run
```
