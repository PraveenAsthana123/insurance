...
test.describe('supply-chain smoke tests', () => {
  test('HOLY nav page for supply-chain loads', async ({ page }) => {
    await page.goto('http://localhost:3000/holy/supply-chain');
    await expect(page).toHaveURL(/\/holy\/supply-chain/);
