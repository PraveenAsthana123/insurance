# HOLY Beverage — Digital Marketing — AI Use-Case Catalog
...
> use cases for **digital-marketing**. Implementation status tracked per current
> codebase state.
...
|---|---|---|
| ✅ Implemented | **14** of 30 | Working module exists in `backend/ml/reference/*.py` (drill-locked) |
| 🟡 Partial | **10** of 30 | Existing module applies; dept-specific stub deferred |
| ❌ Not yet | **6** of 30 | Backlogged — needs new module or external integration |
...
## 2. Digital Marketing-Specific Use Cases

| Use Case | Category | Data Types | AI Area | Business Value | Status |
|---|---|---|---|---|---|
| Campaign Optimization AI | Marketing AI | campaign metrics | Predictive | Better CPA/ROAS | 🟡 see marketing |
| AI Ad Copy Generation | GenAI | text | LLM | Higher CTR | ❌ deferred |
| Customer Journey Intelligence | Analytics AI | events | Journey Analytics | Better funnel | 🟡 simulation_engine.py covers process flow |
