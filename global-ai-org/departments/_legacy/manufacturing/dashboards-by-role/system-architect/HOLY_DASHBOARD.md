# HOLY Beverage — Manufacturing — System Architect Dashboard

> Per global CLAUDE.md §64.37 — every (dept, role) pair MUST have a
> role-scoped dashboard. This is the dashboard for **system-architect** in **manufacturing**.

## Persona

The **system-architect** at Manufacturing. They use this dashboard
...
returned by backend `GET /api/v1/holy/dashboards/manufacturing/system-architect/charts/<chart_id>`.
...
```
GET /api/v1/holy/dashboards/manufacturing/system-architect
  → {tiles: [...], charts: [...], filters: {...}, refreshed_at}

GET /api/v1/holy/dashboards/manufacturing/system-architect/charts/<chart_id>
...
- Frontend route: `/holy/manufacturing/dashboard?role=system-architect`
