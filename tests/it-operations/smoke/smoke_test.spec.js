...
test.describe('it-operations smoke tests', () => {
  test('HOLY nav page for it-operations loads', async ({ page }) => {
    await page.goto('http://localhost:3000/holy/it-operations');
    await expect(page).toHaveURL(/\/holy\/it-operations/);
