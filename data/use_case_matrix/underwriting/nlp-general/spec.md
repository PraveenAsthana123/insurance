# §140 · underwriting × nlp-general · Use Case Spec

## Purpose
Cross-cutting fit · NLP technique applied to underwriting domain.
...
## Example use case
Underwriting use case applying nlp-general to text.
