# Underwriting — ai-reviewer Reports

Per global §64.37 — role-scoped reports (≥ 3 standard per role).

## Standard reports

### R1 — Underwriting ai-reviewer digest
...
## API
```
GET  /api/v1/insur/reports/underwriting/ai-reviewer
POST /api/v1/insur/reports/underwriting/ai-reviewer/{report_id}/run
```
