# HOLY Beverage — Sales — AS-IS Process Assessment
...
This document is the **input to the AI strategy planning** for Sales.
...
|---|---|---|---|---|---|---|---|---|
| 1 | Manual lead scoring | 6 hrs/wk | High | $150K/yr | SDR confusion | Subjective | −25% conversion | Spreadsheet |
| 2 | Pipeline review meetings | 8 hrs/wk | Med | $200K/yr | Mgr overload | Anecdotal | Slow forecast | CRM screens |
| 3 | Manual proposal generation | 10 hrs/wk | Med | $300K/yr | Rep time-drain | Inconsistent | Slow close | Word + manual |
| 4 | Reactive churn detection | 12 hrs/wk | High | $800K/yr | CSM firefighting | Post-cancel | Lost ARR | Manual review |
| 5 | Manual territory planning | 16 hrs/wk | Med | $100K/qtr | Annual only | Stale assignments | Sub-optimal coverage | Excel + maps |
...
4. **Measure** via the persona's main KPI: Quota attainment, sales cycle length, win rate
