# Sales — Digital Transformation (HOLY)
...
## How this role uses HOLY's Sales platform

- **Navigates** via `HOLY_NAV.json` (left-sidebar process picker; see `/holy/sales` in frontend)
...
Lead Scoring ML, RAG, GenAI, Optimization AI, Forecasting
