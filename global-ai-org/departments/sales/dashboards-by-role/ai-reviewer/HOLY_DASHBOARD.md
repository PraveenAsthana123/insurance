# HOLY Beverage — Sales — Ai Reviewer Dashboard

> Per global CLAUDE.md §64.37 — every (dept, role) pair MUST have a
> role-scoped dashboard. This is the dashboard for **ai-reviewer** in **sales**.

## Persona

The **ai-reviewer** at Sales. They use this dashboard
...
returned by backend `GET /api/v1/holy/dashboards/sales/ai-reviewer/charts/<chart_id>`.
...
```
GET /api/v1/holy/dashboards/sales/ai-reviewer
  → {tiles: [...], charts: [...], filters: {...}, refreshed_at}

GET /api/v1/holy/dashboards/sales/ai-reviewer/charts/<chart_id>
...
- Frontend route: `/holy/sales/dashboard?role=ai-reviewer`
