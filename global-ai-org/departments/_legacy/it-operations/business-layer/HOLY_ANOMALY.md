# HOLY Beverage — It Operations — Anomaly Detection
...
## Anomaly catalog (top 20 per it-operations)

| # | Anomaly type | Severity | Tier | Auto-action | Backing data |
|---|---|---|---|---|---|
| 1 | _stub: anomaly for it-operations_ | high | tier 2 | alert + auto-investigate | CMDB + logs + metrics |
