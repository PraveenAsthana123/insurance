# HOLY Beverage — Manufacturing — Incident Management (L1/L2/L3 + RAG)
...
|---|---|---|---|---|
| 1 | _stub: replace with real L1 issue for manufacturing_ | runbook URL | < 1 min | < 5 min |
...
- RAG corpus: `data/manufacturing/runbooks/` + `data/manufacturing/past-incidents/`
