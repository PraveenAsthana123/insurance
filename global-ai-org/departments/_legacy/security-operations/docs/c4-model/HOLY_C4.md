# HOLY Beverage — Security Operations C4 Model
...
graph TB
    ...
    holy[HOLY Security Operations Platform]
...
graph LR
    ...
    features --> model[Cybersecurity AI, Behavioral AI, Correlation AI, Anomaly Detection, RAG]
...
- Decision lineage: every API call writes a row to `security_operations_audit` (see LLD §2)

## L6 — Observability

- Logs: structured JSON with `correlation_id`, `tenant_id`, `user_id`, `model_version`, `prompt_version`
- Metrics: `security-operations_request_count`, `security-operations_latency_p95`, `security-operations_model_confidence`, `security-operations_hallucination_rate`
