# HOLY Beverage — Digital Marketing — Automated Pipelines
...
|---|---|---|---|
| 1 | Campaign Attribution | Tabular ML (default — extend per dept-specific lifecycle) | Dept manager + AI reviewer |

_Additional candidate pipelines (not yet detailed): **Campaign Attribution + Creative Recommendation + Audience Segmentation**._
...
**Audit prefix:** `pipeline.digital_marketing.campaign_attribution`

| Phase | What | Audit-row outcome |
|---|---|---|
| 1 Input | Per-process inputs from upstream digital-marketing systems | `outcome=data_received` |
...
| 5 Report | Digital Marketing manager dashboard per §64.37 | `outcome=report_published` + visible_to[] |
...
| Endpoint | Returns |
|---|---|
| `GET /api/v1/holy/pipelines/digital-marketing` | Pipeline catalog above as JSON |
| `GET /api/v1/holy/pipelines/digital-marketing/<process_id>` | Full 5-phase spec for one process |
