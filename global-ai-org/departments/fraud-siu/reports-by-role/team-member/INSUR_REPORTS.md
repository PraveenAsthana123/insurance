# Fraud / Special Investigations Unit (SIU) — team-member Reports

Per global §64.37 — role-scoped reports (≥ 3 standard per role).

## Standard reports

### R1 — Fraud / Special Investigations Unit (SIU) team-member digest
...
## API
```
GET  /api/v1/insur/reports/fraud-siu/team-member
POST /api/v1/insur/reports/fraud-siu/team-member/{report_id}/run
```
