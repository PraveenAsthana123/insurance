# HOLY Beverage — Product Rd — Admin Dashboard

> Per global CLAUDE.md §64.37 — every (dept, role) pair MUST have a
> role-scoped dashboard. This is the dashboard for **admin** in **product-rd**.

## Persona

The **admin** at Product Rd. They use this dashboard
...
returned by backend `GET /api/v1/holy/dashboards/product-rd/admin/charts/<chart_id>`.
...
```
GET /api/v1/holy/dashboards/product-rd/admin
  → {tiles: [...], charts: [...], filters: {...}, refreshed_at}

GET /api/v1/holy/dashboards/product-rd/admin/charts/<chart_id>
...
- Frontend route: `/holy/product-rd/dashboard?role=admin`
