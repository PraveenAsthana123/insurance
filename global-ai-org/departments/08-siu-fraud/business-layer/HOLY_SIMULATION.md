# HOLY_SIMULATION.md · Dept 8 · SIU / Fraud Investigation
...
## Backend API
- `POST /api/v1/holy/sim/siu-fraud/{process}/run`
- `GET /api/v1/holy/sim/siu-fraud/{process}/runs/{sim_id}/events` (SSE)
- `GET /api/v1/holy/sim/siu-fraud/{process}/runs/{sim_id}/manifest`
- `GET /api/v1/holy/sim/siu-fraud/{process}/runs/{sim_id}/replay`
