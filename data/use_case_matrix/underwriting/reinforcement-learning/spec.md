# §140 · underwriting × reinforcement-learning · Use Case Spec

## Purpose
Cross-cutting fit · RL technique applied to underwriting domain.
...
## Example use case
Underwriting use case applying reinforcement-learning to env+reward.
