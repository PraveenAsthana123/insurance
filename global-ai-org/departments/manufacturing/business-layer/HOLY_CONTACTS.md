# HOLY Beverage — Manufacturing — Contact Management (customer + vendor + internal)
...
- Sync: scheduled inbound from manufacturing's CRM / ERP / HRIS
...
|---|---|---|
| GET /api/v1/holy/contacts/manufacturing/customers | list | manager / data-owner |
| GET /api/v1/holy/contacts/manufacturing/vendors | list | manager / procurement |
| GET /api/v1/holy/contacts/manufacturing/internal | list | any dept role |
| POST /api/v1/holy/contacts/manufacturing/customers | create | admin / manager |
| PUT /api/v1/holy/contacts/manufacturing/customers/{id} | update | admin / data-owner |
| DELETE /api/v1/holy/contacts/manufacturing/customers/{id} | soft-delete | admin |
