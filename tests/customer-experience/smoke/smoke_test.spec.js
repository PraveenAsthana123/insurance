...
test.describe('customer-experience smoke tests', () => {
  test('HOLY nav page for customer-experience loads', async ({ page }) => {
    await page.goto('http://localhost:3000/holy/customer-experience');
    await expect(page).toHaveURL(/\/holy\/customer-experience/);
