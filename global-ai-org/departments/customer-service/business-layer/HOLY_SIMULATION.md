# HOLY_SIMULATION.md · Dept 9 · Customer Service
...
## Backend API
- `POST /api/v1/holy/sim/customer-service/{process}/run`
- `GET /api/v1/holy/sim/customer-service/{process}/runs/{sim_id}/events` (SSE)
- `GET /api/v1/holy/sim/customer-service/{process}/runs/{sim_id}/manifest`
- `GET /api/v1/holy/sim/customer-service/{process}/runs/{sim_id}/replay`
