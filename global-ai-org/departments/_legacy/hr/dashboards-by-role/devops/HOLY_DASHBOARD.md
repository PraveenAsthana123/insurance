# HOLY Beverage — Hr — Devops Dashboard

> Per global CLAUDE.md §64.37 — every (dept, role) pair MUST have a
> role-scoped dashboard. This is the dashboard for **devops** in **hr**.

## Persona

The **devops** at Hr. They use this dashboard
...
returned by backend `GET /api/v1/holy/dashboards/hr/devops/charts/<chart_id>`.
...
```
GET /api/v1/holy/dashboards/hr/devops
  → {tiles: [...], charts: [...], filters: {...}, refreshed_at}

GET /api/v1/holy/dashboards/hr/devops/charts/<chart_id>
...
- Frontend route: `/holy/hr/dashboard?role=devops`
