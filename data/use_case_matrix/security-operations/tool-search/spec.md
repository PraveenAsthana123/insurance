# §140 · security-operations × tool-search · Use Case Spec

## Purpose
PRIMARY fit · Ops technique applied to security-operations domain.
...
## Example use case
Security Operations use case applying tool-search to tool catalog.
