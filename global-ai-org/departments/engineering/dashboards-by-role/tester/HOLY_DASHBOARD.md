# HOLY Beverage — Engineering — Tester Dashboard

> Per global CLAUDE.md §64.37 — every (dept, role) pair MUST have a
> role-scoped dashboard. This is the dashboard for **tester** in **engineering**.

## Persona

The **tester** at Engineering. They use this dashboard
...
returned by backend `GET /api/v1/holy/dashboards/engineering/tester/charts/<chart_id>`.
...
```
GET /api/v1/holy/dashboards/engineering/tester
  → {tiles: [...], charts: [...], filters: {...}, refreshed_at}

GET /api/v1/holy/dashboards/engineering/tester/charts/<chart_id>
...
- Frontend route: `/holy/engineering/dashboard?role=tester`
