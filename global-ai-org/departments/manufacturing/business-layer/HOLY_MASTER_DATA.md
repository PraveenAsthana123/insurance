# HOLY Beverage — Manufacturing — Master Data

> Per operator 2026-05-24 — every dept publishes its master + reference
> data here. Focus: **BOM + work-center + plant + material-master + routing**.
...
This dept (**manufacturing**) operates against the slice of the structure
...
| Endpoint | Returns |
|---|---|
| `GET /api/v1/holy/master-data/manufacturing` | Schema catalog + per-entity owner |
| `GET /api/v1/holy/master-data/manufacturing/customer?limit=20` | Customer master sample |
| `GET /api/v1/holy/master-data/manufacturing/vendor?limit=20` | Vendor master sample |
| `GET /api/v1/holy/master-data/manufacturing/product?limit=20` | Product master sample |
| `GET /api/v1/holy/master-data/manufacturing/org-structure` | Org tree slice for this dept |
...
1. (+) `/api/v1/holy/master-data/manufacturing` returns 200 + entity catalog
