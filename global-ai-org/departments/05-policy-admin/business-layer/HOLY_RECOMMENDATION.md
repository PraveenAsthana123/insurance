# HOLY_RECOMMENDATION.md · Dept 5 · policy-admin
...
Recommendation system for Dept 5 (policy-admin). All 3 classical flavors covered per §64.22.

## Item-based (collaborative filter)

**Algorithm**: Item-item collaborative (template × customer)
...
**Algorithm**: LayoutLM embedding similarity (template documents)
...
**Algorithm**: LightGBM rerank · template fit + signing history
