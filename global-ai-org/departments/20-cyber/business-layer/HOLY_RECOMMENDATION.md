# HOLY_RECOMMENDATION.md · Dept 20 · cyber
...
Recommendation system for Dept 20 (cyber). All 3 classical flavors covered per §64.22.
...
**Algorithm**: Threat embedding (TTP + indicator)
...
**Algorithm**: Rerank · severity + asset criticality blend
