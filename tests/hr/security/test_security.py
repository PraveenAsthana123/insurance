"""Tier 11-12 — Security tests for hr.
...
def test_hr_owasp_zap_scan():
    """REPLACE — invoke OWASP ZAP CLI against hr surface (auth env only)."""
    pass


@pytest.mark.skip(reason="placeholder — requires Garak install + AI endpoint")
def test_hr_garak_prompt_injection():
