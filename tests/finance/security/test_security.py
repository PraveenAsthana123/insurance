"""Tier 11-12 — Security tests for finance.
...
def test_finance_owasp_zap_scan():
    """REPLACE — invoke OWASP ZAP CLI against finance surface (auth env only)."""
    pass


@pytest.mark.skip(reason="placeholder — requires Garak install + AI endpoint")
def test_finance_garak_prompt_injection():
