# Fraud / Special Investigations Unit (SIU) — system-architect Dashboard

Per global §64.37 — role-scoped dashboard.

## Persona
**system-architect** in Fraud / Special Investigations Unit (SIU).
...
## API
```
GET /api/v1/insur/dashboards/fraud-siu/system-architect
```
