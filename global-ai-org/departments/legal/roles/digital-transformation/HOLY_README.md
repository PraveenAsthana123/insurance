# Legal — Digital Transformation (HOLY)
...
## How this role uses HOLY's Legal platform

- **Navigates** via `HOLY_NAV.json` (left-sidebar process picker; see `/holy/legal` in frontend)
...
- OpenAI / Claude for redlining
- Snowflake (matter analytics)
