# HOLY Beverage — Digital Marketing — Data Owner Dashboard

> Per global CLAUDE.md §64.37 — every (dept, role) pair MUST have a
> role-scoped dashboard. This is the dashboard for **data-owner** in **digital-marketing**.

## Persona

The **data-owner** at Digital Marketing. They use this dashboard
...
returned by backend `GET /api/v1/holy/dashboards/digital-marketing/data-owner/charts/<chart_id>`.
...
```
GET /api/v1/holy/dashboards/digital-marketing/data-owner
  → {tiles: [...], charts: [...], filters: {...}, refreshed_at}

GET /api/v1/holy/dashboards/digital-marketing/data-owner/charts/<chart_id>
...
- Frontend route: `/holy/digital-marketing/dashboard?role=data-owner`
