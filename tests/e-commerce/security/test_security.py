"""Tier 11-12 — Security tests for e-commerce.
...
def test_e_commerce_owasp_zap_scan():
    """REPLACE — invoke OWASP ZAP CLI against e-commerce surface (auth env only)."""
    pass


@pytest.mark.skip(reason="placeholder — requires Garak install + AI endpoint")
def test_e_commerce_garak_prompt_injection():
