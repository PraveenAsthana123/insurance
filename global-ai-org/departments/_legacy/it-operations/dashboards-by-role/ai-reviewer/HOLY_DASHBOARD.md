# HOLY Beverage — It Operations — Ai Reviewer Dashboard

> Per global CLAUDE.md §64.37 — every (dept, role) pair MUST have a
> role-scoped dashboard. This is the dashboard for **ai-reviewer** in **it-operations**.

## Persona

The **ai-reviewer** at It Operations. They use this dashboard
...
returned by backend `GET /api/v1/holy/dashboards/it-operations/ai-reviewer/charts/<chart_id>`.
...
```
GET /api/v1/holy/dashboards/it-operations/ai-reviewer
  → {tiles: [...], charts: [...], filters: {...}, refreshed_at}

GET /api/v1/holy/dashboards/it-operations/ai-reviewer/charts/<chart_id>
...
- Frontend route: `/holy/it-operations/dashboard?role=ai-reviewer`
