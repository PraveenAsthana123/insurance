# HOLY Beverage — E Commerce — Input Data Mgmt + Before/After Viz
...
For every process AND sub-process in this dept (e-commerce), populate the 6
surfaces below. clickstream + orders + sessions is the primary data class for e-commerce.
...
Plots land in: `data/eval/e-commerce/<pipeline>/<run_id>/plots/before_*.png`
...
Plots land in: `data/eval/e-commerce/<pipeline>/<run_id>/plots/after_*.png`
