# HOLY Beverage — Operations — Database Architect Dashboard

> Per global CLAUDE.md §64.37 — every (dept, role) pair MUST have a
> role-scoped dashboard. This is the dashboard for **database-architect** in **operations**.

## Persona

The **database-architect** at Operations. They use this dashboard
...
returned by backend `GET /api/v1/holy/dashboards/operations/database-architect/charts/<chart_id>`.
...
```
GET /api/v1/holy/dashboards/operations/database-architect
  → {tiles: [...], charts: [...], filters: {...}, refreshed_at}

GET /api/v1/holy/dashboards/operations/database-architect/charts/<chart_id>
...
- Frontend route: `/holy/operations/dashboard?role=database-architect`
