# HOLY Beverage — Engineering — AS-IS Process Assessment
...
This document is the **input to the AI strategy planning** for Engineering.
...
|---|---|---|---|---|---|---|---|---|
| 1 | Manual code review | 12 hrs/wk | Med | $1M/yr | Eng overhead | Bottleneck | Slow merge | PR comments |
| 2 | Manual incident triage | 6 hrs/wk | High | $500K/yr | On-call burnout | Tribal | Slow MTTR | PagerDuty + manual |
| 3 | Manual deployment | 8 hrs/wk | High | $2M/yr risk | Release-engineer overload | Off-hours | Risky | Jenkins UI |
| 4 | Manual capacity planning | 20 hrs/wk | Med | $200K/yr | SRE overload | Annual | Over/under-provisioned | Excel + Datadog |
| 5 | Manual post-mortem authoring | 8 hrs/wk | Low | $80K/yr | IC overhead | Slow | Lost learning | Wiki templates |
...
4. **Measure** via the persona's main KPI: DORA metrics — DF, LT, MTTR, CFR
