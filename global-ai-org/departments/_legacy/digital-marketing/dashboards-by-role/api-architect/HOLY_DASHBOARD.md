# HOLY Beverage — Digital Marketing — Api Architect Dashboard

> Per global CLAUDE.md §64.37 — every (dept, role) pair MUST have a
> role-scoped dashboard. This is the dashboard for **api-architect** in **digital-marketing**.

## Persona

The **api-architect** at Digital Marketing. They use this dashboard
...
returned by backend `GET /api/v1/holy/dashboards/digital-marketing/api-architect/charts/<chart_id>`.
...
```
GET /api/v1/holy/dashboards/digital-marketing/api-architect
  → {tiles: [...], charts: [...], filters: {...}, refreshed_at}

GET /api/v1/holy/dashboards/digital-marketing/api-architect/charts/<chart_id>
...
- Frontend route: `/holy/digital-marketing/dashboard?role=api-architect`
