# HOLY Beverage — Executive Leadership — Incident Management (L1/L2/L3 + RAG)
...
|---|---|---|---|---|
| 1 | _stub: replace with real L1 issue for executive-leadership_ | runbook URL | < 1 min | < 5 min |
...
- RAG corpus: `data/executive-leadership/runbooks/` + `data/executive-leadership/past-incidents/`
