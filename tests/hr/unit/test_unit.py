...
def test_dept_module_imports():
    ...
    assert "hr" in "hr", "dept name must match"
...
@pytest.mark.skip(reason="placeholder — replace with real hr unit test")
def test_real_dept_logic():
    """REPLACE — real unit test for hr business logic."""
    pass
