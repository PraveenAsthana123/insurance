// Tier 9-10 — Performance + load test for executive-leadership.
//
// Recommended: k6 (per global §64.42).
//
// Run with:  k6 run tests/executive-leadership/perf/load_test.js
//
...
export default function () {
  ...
  check(res, {
    ...
    'has executive-leadership': (r) => r.body.includes('executive-leadership'),
  });
  sleep(1);
}
