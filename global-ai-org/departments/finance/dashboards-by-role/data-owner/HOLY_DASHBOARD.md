# HOLY Beverage — Finance — Data Owner Dashboard

> Per global CLAUDE.md §64.37 — every (dept, role) pair MUST have a
> role-scoped dashboard. This is the dashboard for **data-owner** in **finance**.

## Persona

The **data-owner** at Finance. They use this dashboard
...
returned by backend `GET /api/v1/holy/dashboards/finance/data-owner/charts/<chart_id>`.
...
```
GET /api/v1/holy/dashboards/finance/data-owner
  → {tiles: [...], charts: [...], filters: {...}, refreshed_at}

GET /api/v1/holy/dashboards/finance/data-owner/charts/<chart_id>
...
- Frontend route: `/holy/finance/dashboard?role=data-owner`
