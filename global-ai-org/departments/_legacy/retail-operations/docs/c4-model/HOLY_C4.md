# HOLY Beverage — Retail Operations C4 Model
...
graph TB
    ...
    holy[HOLY Retail Operations Platform]
...
graph LR
    ...
    features --> model[Computer Vision, Spatial AI, Forecasting AI, Causal ML]
...
- Decision lineage: every API call writes a row to `retail_operations_audit` (see LLD §2)

## L6 — Observability

- Logs: structured JSON with `correlation_id`, `tenant_id`, `user_id`, `model_version`, `prompt_version`
- Metrics: `retail-operations_request_count`, `retail-operations_latency_p95`, `retail-operations_model_confidence`, `retail-operations_hallucination_rate`
