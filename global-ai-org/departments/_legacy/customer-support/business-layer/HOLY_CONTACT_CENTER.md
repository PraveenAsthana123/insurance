# HOLY Beverage — Customer Support — Contact Center Automation
...
**Manager** + **CX role** (dept = customer-support). For non-CX depts this covers
...
|---|---|---|---|---|
| 1 | _stub: replace with real intent for customer-support_ | _ | yes/no | DistilBERT |
| … | (20 total minimum) | | | |
...
- LLM model: `gemma3:4b` (default for customer-support) — adjust per latency/cost SLO
- RAG corpus: `data/customer-support/kb/` + `data/customer-support/sops/`
