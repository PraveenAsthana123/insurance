# HOLY Beverage — Digital Marketing — AS-IS Process Assessment
...
This document is the **input to the AI strategy planning** for Digital Marketing.
...
|---|---|---|---|---|---|---|---|---|
| 1 | Manual campaign brief intake | 8 hrs/wk | High | $2K/mo | Brand mgrs frustrated | Bottleneck at strategy | −15% throughput | Email-driven |
| 2 | Excel-based audience segmentation | 12 hrs/wk | Med | $5K/mo | Analysts overloaded | Stale segments | −25% precision | Spreadsheet sprawl |
| 3 | Manual A/B test setup | 6 hrs/wk | Med | $3K/mo | Long iteration cycles | Underused | Slow learning | GUI-only |
| 4 | Static creative production | 10 hrs/wk | Low | $15K/mo | Designer queue | Non-personalized | 1× output | Adobe-only |
| 5 | Quarterly channel-mix review | 4 hrs/wk | Med | $8K/qtr | Exec-only | Reactive | Lagging | Tableau-only |
...
4. **Measure** via the persona's main KPI: Cost per acquisition (CPA) below $18, ROAS ≥ 4.2
