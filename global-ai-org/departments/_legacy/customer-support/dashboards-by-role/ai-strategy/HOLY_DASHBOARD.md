# HOLY Beverage — Customer Support — Ai Strategy Dashboard

> Per global CLAUDE.md §64.37 — every (dept, role) pair MUST have a
> role-scoped dashboard. This is the dashboard for **ai-strategy** in **customer-support**.

## Persona

The **ai-strategy** at Customer Support. They use this dashboard
...
returned by backend `GET /api/v1/holy/dashboards/customer-support/ai-strategy/charts/<chart_id>`.
...
```
GET /api/v1/holy/dashboards/customer-support/ai-strategy
  → {tiles: [...], charts: [...], filters: {...}, refreshed_at}

GET /api/v1/holy/dashboards/customer-support/ai-strategy/charts/<chart_id>
...
- Frontend route: `/holy/customer-support/dashboard?role=ai-strategy`
