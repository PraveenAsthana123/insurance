# Manufacturing AI · Comprehensive README · §137

**Effective**: 2026-06-11 · **Slug**: `manufacturing-ai` · **Kind**: `vertical_spec`
**Accuracy**: 0.9617 · **Algorithm**: GradientBoostingClassifier (per-type baseline)

---

## 1. BRD · Business Requirements Document

**Business goal**: Reduce manual effort + improve accuracy for manufacturing ai tasks in
...
**FR-1**: System MUST accept input matching `manufacturing-ai` schema
...
Caller (frontend/agent)
        │
        ▼
  /api/v1/ai-types/manufacturing-ai/predict
        │
        ▼
...
- `predictions_manufacturing-ai`: id · input_jsonb · output · confidence · timestamp

**Endpoints**:
- `POST /api/v1/ai-types/manufacturing-ai/predict` · body: features → prediction
- `GET /api/v1/ai-types/manufacturing-ai/metrics` → live metrics.json
- `GET /api/v1/ai-types/manufacturing-ai/explain/{prediction_id}` → SHAP
...
```
[router.py] → [model_loader.py] → [/models/manufacturing-ai/model.joblib]
            ↘ [preprocessor.py]
...
- collection: `manufacturing-ai_embeddings`
...
**Fairness metrics** (from data/fairness/manufacturing-ai.json):
