# HOLY Beverage — Hr — Manager Dashboard

> Per global CLAUDE.md §64.37 — every (dept, role) pair MUST have a
> role-scoped dashboard. This is the dashboard for **manager** in **hr**.

## Persona

The **manager** at Hr. They use this dashboard
...
returned by backend `GET /api/v1/holy/dashboards/hr/manager/charts/<chart_id>`.
...
```
GET /api/v1/holy/dashboards/hr/manager
  → {tiles: [...], charts: [...], filters: {...}, refreshed_at}

GET /api/v1/holy/dashboards/hr/manager/charts/<chart_id>
...
- Frontend route: `/holy/hr/dashboard?role=manager`
