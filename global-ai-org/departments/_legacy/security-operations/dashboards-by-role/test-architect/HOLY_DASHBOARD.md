# HOLY Beverage — Security Operations — Test Architect Dashboard

> Per global CLAUDE.md §64.37 — every (dept, role) pair MUST have a
> role-scoped dashboard. This is the dashboard for **test-architect** in **security-operations**.

## Persona

The **test-architect** at Security Operations. They use this dashboard
...
returned by backend `GET /api/v1/holy/dashboards/security-operations/test-architect/charts/<chart_id>`.
...
```
GET /api/v1/holy/dashboards/security-operations/test-architect
  → {tiles: [...], charts: [...], filters: {...}, refreshed_at}

GET /api/v1/holy/dashboards/security-operations/test-architect/charts/<chart_id>
...
- Frontend route: `/holy/security-operations/dashboard?role=test-architect`
