# §140 · fraud-investigation × rlhf · Use Case Spec

## Purpose
Cross-cutting fit · Train technique applied to fraud-investigation domain.
...
## Example use case
Fraud Investigation use case applying rlhf to preferences.
