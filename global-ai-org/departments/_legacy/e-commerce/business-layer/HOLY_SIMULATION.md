# HOLY Beverage — E Commerce — Simulation Tab
...
under `REFERENCE_PROCESSES[("e-commerce", "<process>")]`.
...
| Endpoint | Purpose |
|---|---|
| POST /api/v1/holy/sim/e-commerce/{process}/run | Trigger simulation |
| GET /api/v1/holy/sim/e-commerce/{process}/runs | List past runs |
| GET /api/v1/holy/sim/e-commerce/{process}/runs/{sim_id}/manifest | Per-run summary |
| GET /api/v1/holy/sim/e-commerce/{process}/runs/{sim_id}/events | Event stream |

## TODO

- [ ] Define ≥ 1 process for e-commerce in `REFERENCE_PROCESSES` dict
