// Tier 9-10 — Performance + load test for retail-operations.
//
// Recommended: k6 (per global §64.42).
//
// Run with:  k6 run tests/retail-operations/perf/load_test.js
//
...
export default function () {
  ...
  check(res, {
    ...
    'has retail-operations': (r) => r.body.includes('retail-operations'),
  });
  sleep(1);
}
