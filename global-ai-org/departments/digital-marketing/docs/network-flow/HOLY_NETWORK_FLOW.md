# HOLY Beverage — Digital Marketing Network Flow
...
```
Digital Marketing API ──HTTP──► Auth Service           (RBAC + ABAC checks)
...
```
Digital Marketing API ──HTTPS──► Vendor APIs            (Salesforce / SAP / etc.)
...
─────────────                  ───────────────          ──────────
Frontend UI       ──►          digital-marketing_user_events       analytics-svc
Backend API       ──►          digital-marketing_audit              audit-store
ML Worker         ──►          digital-marketing_predictions        prediction-store
Drift detector    ──►          digital-marketing_alerts             on-call PagerDuty
...
|---|---|---|---|
| digital-marketing-api | postgresql | 5432 | TCP |
| digital-marketing-api | redis | 6379 | TCP |
| digital-marketing-api | ollama | 11434 | TCP |
| digital-marketing-api | otel-collector | 4317 | gRPC |
| digital-marketing-api | (other dept APIs) | 8000 | HTTP via service mesh |
