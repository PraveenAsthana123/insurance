# Customer Service / Contact Center — data-owner Reports

Per global §64.37 — role-scoped reports (≥ 3 standard per role).

## Standard reports

### R1 — Customer Service / Contact Center data-owner digest
...
## API
```
GET  /api/v1/insur/reports/customer-service/data-owner
POST /api/v1/insur/reports/customer-service/data-owner/{report_id}/run
```
