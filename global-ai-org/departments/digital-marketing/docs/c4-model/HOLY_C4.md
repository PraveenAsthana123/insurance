# HOLY Beverage — Digital Marketing C4 Model
...
graph TB
    ...
    holy[HOLY Digital Marketing Platform]
...
graph LR
    ...
    features --> model[NLP, Recommendation AI, GenAI, Reinforcement Learning]
...
- Decision lineage: every API call writes a row to `digital_marketing_audit` (see LLD §2)

## L6 — Observability

- Logs: structured JSON with `correlation_id`, `tenant_id`, `user_id`, `model_version`, `prompt_version`
- Metrics: `digital-marketing_request_count`, `digital-marketing_latency_p95`, `digital-marketing_model_confidence`, `digital-marketing_hallucination_rate`
