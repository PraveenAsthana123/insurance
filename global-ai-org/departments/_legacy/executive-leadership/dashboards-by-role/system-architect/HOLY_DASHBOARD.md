# HOLY Beverage — Executive Leadership — System Architect Dashboard

> Per global CLAUDE.md §64.37 — every (dept, role) pair MUST have a
> role-scoped dashboard. This is the dashboard for **system-architect** in **executive-leadership**.

## Persona

The **system-architect** at Executive Leadership. They use this dashboard
...
returned by backend `GET /api/v1/holy/dashboards/executive-leadership/system-architect/charts/<chart_id>`.
...
```
GET /api/v1/holy/dashboards/executive-leadership/system-architect
  → {tiles: [...], charts: [...], filters: {...}, refreshed_at}

GET /api/v1/holy/dashboards/executive-leadership/system-architect/charts/<chart_id>
...
- Frontend route: `/holy/executive-leadership/dashboard?role=system-architect`
