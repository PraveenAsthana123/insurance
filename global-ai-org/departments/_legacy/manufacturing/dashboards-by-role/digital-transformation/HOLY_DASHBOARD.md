# HOLY Beverage — Manufacturing — Digital Transformation Dashboard

> Per global CLAUDE.md §64.37 — every (dept, role) pair MUST have a
> role-scoped dashboard. This is the dashboard for **digital-transformation** in **manufacturing**.

## Persona

The **digital-transformation** at Manufacturing. They use this dashboard
...
returned by backend `GET /api/v1/holy/dashboards/manufacturing/digital-transformation/charts/<chart_id>`.
...
```
GET /api/v1/holy/dashboards/manufacturing/digital-transformation
  → {tiles: [...], charts: [...], filters: {...}, refreshed_at}

GET /api/v1/holy/dashboards/manufacturing/digital-transformation/charts/<chart_id>
...
- Frontend route: `/holy/manufacturing/dashboard?role=digital-transformation`
