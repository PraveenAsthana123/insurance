...
GOVERNANCE_GATES = [
    ...
    {"id": 3,  "name": "Human-in-the-Loop (HITL)",
     ...
     "this_project_status": "used",
     "this_project": "/api/v1/hitl/* · HITLPanel · 2 governance tabs · gate #3 (this commit)"},
    {"id": 4,  "name": "Human Feedback (explicit + implicit)",
     "explicit": ["good", "bad", "correct", "incorrect"],
     "implicit": ["accepted", "modified", "rejected", "ignored"],
     "this_project_status": "used",
     "this_project": "/api/v1/feedback/* + decision_feedback table (mig 062) · FeedbackPanel in 2 governance tabs"},
    {"id": 5,  "name": "AI Correction Layer",
     "this_project_status": "used",
     "this_project": "decision_corrections table + /api/v1/corrections/* · T7.10"},
    {"id": 6,  "name": "RLHF",
     "this_project_status": "planned"},
    ...
    {"id": 13, "name": "Self-Healing AI · fallback chain",
     ...
     "this_project_status": "used",
     "this_project": "backend/services/self_healing.py · LLMFallbackChain · T7.13"},
