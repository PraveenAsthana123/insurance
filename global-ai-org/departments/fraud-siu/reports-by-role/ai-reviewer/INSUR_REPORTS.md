# Fraud / Special Investigations Unit (SIU) — ai-reviewer Reports

Per global §64.37 — role-scoped reports (≥ 3 standard per role).

## Standard reports

### R1 — Fraud / Special Investigations Unit (SIU) ai-reviewer digest
...
## API
```
GET  /api/v1/insur/reports/fraud-siu/ai-reviewer
POST /api/v1/insur/reports/fraud-siu/ai-reviewer/{report_id}/run
```
