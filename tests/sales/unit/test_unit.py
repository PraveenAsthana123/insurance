...
def test_dept_module_imports():
    ...
    assert "sales" in "sales", "dept name must match"
...
@pytest.mark.skip(reason="placeholder — replace with real sales unit test")
def test_real_dept_logic():
    """REPLACE — real unit test for sales business logic."""
    pass
