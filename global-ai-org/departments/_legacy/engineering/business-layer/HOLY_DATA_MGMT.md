# HOLY Beverage — Engineering — Input Data Mgmt + Before/After Viz
...
For every process AND sub-process in this dept (engineering), populate the 6
surfaces below. git + CI + incidents is the primary data class for engineering.
...
Plots land in: `data/eval/engineering/<pipeline>/<run_id>/plots/before_*.png`
...
Plots land in: `data/eval/engineering/<pipeline>/<run_id>/plots/after_*.png`
