# Engineering — Digital Transformation (HOLY)
...
## How this role uses HOLY's Engineering platform

- **Navigates** via `HOLY_NAV.json` (left-sidebar process picker; see `/holy/engineering` in frontend)
...
Code AI, Predictive ML, GenAI, Reliability AI

## Tech stack this role touches

- GitHub / GitLab + Jira
- Python + LangGraph
- OpenAI / Anthropic for codegen
- DataDog / Grafana
