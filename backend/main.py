...
def create_app() -> FastAPI:
    ...
    from chatgroup.router import router as chatgroup_router  # /api/v1/chatgroup — operator 2026-06-12
    ...
    from multi_agent_orchestra.router import router as orch_router  # Iter 96 · 5-agent
    ...
    from request_tracker.router import router as req_track_router  # Iter 107 · §125 request tracker
    ...
    from agent_tools.router import router as tools_router  # Iter 123 · §135 primitives
    ...
    from langfuse_adapter.router import router as lfuse_router
    from presidio_adapter.router import router as pres_router
    from nemoguardrails_adapter.router import router as nemo_router
    from opensearch_adapter.router import router as os_router  # Iter 89 · 6 adapters (§110)
    from jaeger_adapter.router import router as jg_router
    from tempo_adapter.router import router as tp_router
    from vllm_adapter.router import router as vl_router  # Iter 90 · 3 obs adapters (§110)  # /api/v1/vulnerabilities — Iter 25  # /api/v1/alerts/* — Iter 21  # /api/v1/comments/* — P1 #18  # /api/v1/test-status/* — §64.30 12-tier  # /api/v1/data-pipeline/* — 5-phase  # /api/v1/responsible-ai/* — 12-lens  # /api/v1/use-cases/* — §94  # /api/v1/pipeline/* — §93 Manual + Automatic  # /api/v1/feedback/* — gate #4  # /api/v1/hitl/* — gate #3  # /api/v1/ml/* — model registry · SHAP · eval  # /api/v1/corrections/* — T7.10 RLHF DB  # /api/v1/autonomous-dept/*  # /api/v1/attribution/* — T5.9 multi-touch  # /api/v1/ai-tools/* — tool landscape  # /api/v1/marketing-kpis/* — KPI registry  # /api/v1/content-ops/* — job+blog postings · contacts · schedules  # /api/v1/marketing-campaigns/* — 4 channels (email/banner/survey/form)
    ...
    app.include_router(chatgroup_router)           # /api/v1/chatgroup — operator 2026-06-12
    ...
    app.include_router(orch_router)                # Iter 96 · multi-agent-orchestra
    ...
    app.include_router(req_track_router)           # Iter 107 · §125 request tracker
    ...
    app.include_router(tools_router)               # Iter 123 · §135 agent tools
    ...
    app.include_router(lfuse_router)
    app.include_router(pres_router)
    app.include_router(nemo_router)
    app.include_router(os_router)                  # Iter 89 · 6 adapters (§110)
    app.include_router(jg_router)
    app.include_router(tp_router)
    app.include_router(vl_router)                  # Iter 90 · 3 obs adapters (§110)
