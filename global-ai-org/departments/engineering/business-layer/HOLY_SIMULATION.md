# HOLY Beverage — Engineering — Simulation Tab
...
under `REFERENCE_PROCESSES[("engineering", "<process>")]`.
...
| Endpoint | Purpose |
|---|---|
| POST /api/v1/holy/sim/engineering/{process}/run | Trigger simulation |
| GET /api/v1/holy/sim/engineering/{process}/runs | List past runs |
| GET /api/v1/holy/sim/engineering/{process}/runs/{sim_id}/manifest | Per-run summary |
| GET /api/v1/holy/sim/engineering/{process}/runs/{sim_id}/events | Event stream |

## TODO

- [ ] Define ≥ 1 process for engineering in `REFERENCE_PROCESSES` dict
