# HOLY Beverage — E Commerce — Team Member Dashboard

> Per global CLAUDE.md §64.37 — every (dept, role) pair MUST have a
> role-scoped dashboard. This is the dashboard for **team-member** in **e-commerce**.

## Persona

The **team-member** at E Commerce. They use this dashboard
...
returned by backend `GET /api/v1/holy/dashboards/e-commerce/team-member/charts/<chart_id>`.
...
```
GET /api/v1/holy/dashboards/e-commerce/team-member
  → {tiles: [...], charts: [...], filters: {...}, refreshed_at}

GET /api/v1/holy/dashboards/e-commerce/team-member/charts/<chart_id>
...
- Frontend route: `/holy/e-commerce/dashboard?role=team-member`
