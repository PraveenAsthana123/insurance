# HOLY Beverage — Operations — Security Dashboard

> Per global CLAUDE.md §64.37 — every (dept, role) pair MUST have a
> role-scoped dashboard. This is the dashboard for **security** in **operations**.

## Persona

The **security** at Operations. They use this dashboard
...
returned by backend `GET /api/v1/holy/dashboards/operations/security/charts/<chart_id>`.
...
```
GET /api/v1/holy/dashboards/operations/security
  → {tiles: [...], charts: [...], filters: {...}, refreshed_at}

GET /api/v1/holy/dashboards/operations/security/charts/<chart_id>
...
- Frontend route: `/holy/operations/dashboard?role=security`
