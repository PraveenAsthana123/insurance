# HOLY Beverage — Security Operations Network Flow
...
```
Security Operations API ──HTTP──► Auth Service           (RBAC + ABAC checks)
...
```
Security Operations API ──HTTPS──► Vendor APIs            (Salesforce / SAP / etc.)
...
─────────────                  ───────────────          ──────────
Frontend UI       ──►          security-operations_user_events       analytics-svc
Backend API       ──►          security-operations_audit              audit-store
ML Worker         ──►          security-operations_predictions        prediction-store
Drift detector    ──►          security-operations_alerts             on-call PagerDuty
...
|---|---|---|---|
| security-operations-api | postgresql | 5432 | TCP |
| security-operations-api | redis | 6379 | TCP |
| security-operations-api | ollama | 11434 | TCP |
| security-operations-api | otel-collector | 4317 | gRPC |
| security-operations-api | (other dept APIs) | 8000 | HTTP via service mesh |
