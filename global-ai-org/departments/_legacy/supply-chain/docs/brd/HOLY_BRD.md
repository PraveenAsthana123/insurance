# HOLY Beverage — Supply Chain — BRD (Business Requirements Document)

> Per global §47 + §59 + §64 — every functional commitment in HOLY_FRD.md
> traces back to a goal in this document. Owner: **VP Supply Chain**.

## 1. Executive summary

**Strategic goal:** Demand sensing + automated reorder + supplier-risk scoring

**Primary KPI(s):** Forecast MAPE ↓ to 8%, stockout ↓ 50%
...
|---|---|---|---|---|
| Operational efficiency | Forecast MAPE ↓ to 8% | per AS-IS | per AS-IS | 6 months |
...
|---|---|---|
| BRD draft | VP Supply Chain | _pending_ |
