# HOLY Beverage — E Commerce — Data Owner Dashboard

> Per global CLAUDE.md §64.37 — every (dept, role) pair MUST have a
> role-scoped dashboard. This is the dashboard for **data-owner** in **e-commerce**.

## Persona

The **data-owner** at E Commerce. They use this dashboard
...
returned by backend `GET /api/v1/holy/dashboards/e-commerce/data-owner/charts/<chart_id>`.
...
```
GET /api/v1/holy/dashboards/e-commerce/data-owner
  → {tiles: [...], charts: [...], filters: {...}, refreshed_at}

GET /api/v1/holy/dashboards/e-commerce/data-owner/charts/<chart_id>
...
- Frontend route: `/holy/e-commerce/dashboard?role=data-owner`
