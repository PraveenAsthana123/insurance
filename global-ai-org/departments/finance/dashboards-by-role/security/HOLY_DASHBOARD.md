# HOLY Beverage — Finance — Security Dashboard

> Per global CLAUDE.md §64.37 — every (dept, role) pair MUST have a
> role-scoped dashboard. This is the dashboard for **security** in **finance**.

## Persona

The **security** at Finance. They use this dashboard
...
returned by backend `GET /api/v1/holy/dashboards/finance/security/charts/<chart_id>`.
...
```
GET /api/v1/holy/dashboards/finance/security
  → {tiles: [...], charts: [...], filters: {...}, refreshed_at}

GET /api/v1/holy/dashboards/finance/security/charts/<chart_id>
...
- Frontend route: `/holy/finance/dashboard?role=security`
