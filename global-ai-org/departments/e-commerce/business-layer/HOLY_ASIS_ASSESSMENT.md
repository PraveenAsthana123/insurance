# HOLY Beverage — E Commerce — AS-IS Process Assessment
...
This document is the **input to the AI strategy planning** for E Commerce.
...
|---|---|---|---|---|---|---|---|---|
| 1 | Rule-based product recs | 6 hrs/wk | Med | $200K/yr | Merch overhead | Static | −30% click-through | Shopify default |
| 2 | Manual fraud review | 12 hrs/wk | High | $2M/yr chargeback | Risk team overload | Sampling | Missed fraud | Stripe + manual |
| 3 | Manual content tagging | 16 hrs/wk | Med | $150K/yr | Content overload | Inconsistent | Bad search | PIM only |
| 4 | Reactive cart-recovery | 4 hrs/wk | High | $1M/yr lost | Marketing reactive | Generic email | −15% recovery | Klaviyo |
| 5 | Manual visual merchandising | 10 hrs/wk | Med | $100K/yr | Designer overload | Slow refresh | Stale storefront | CMS + manual |
...
4. **Measure** via the persona's main KPI: Conversion rate, cart abandonment, AOV, fraud chargeback rate
