# HOLY_SIMULATION.md · Dept 3 · Sales & Distribution
...
## Backend API
- `POST /api/v1/holy/sim/sales-distribution/{process}/run`
- `GET /api/v1/holy/sim/sales-distribution/{process}/runs/{sim_id}/events` (SSE)
- `GET /api/v1/holy/sim/sales-distribution/{process}/runs/{sim_id}/manifest`
- `GET /api/v1/holy/sim/sales-distribution/{process}/runs/{sim_id}/replay`
