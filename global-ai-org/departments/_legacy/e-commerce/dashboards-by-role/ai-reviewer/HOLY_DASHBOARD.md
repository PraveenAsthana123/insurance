# HOLY Beverage — E Commerce — Ai Reviewer Dashboard

> Per global CLAUDE.md §64.37 — every (dept, role) pair MUST have a
> role-scoped dashboard. This is the dashboard for **ai-reviewer** in **e-commerce**.

## Persona

The **ai-reviewer** at E Commerce. They use this dashboard
...
returned by backend `GET /api/v1/holy/dashboards/e-commerce/ai-reviewer/charts/<chart_id>`.
...
```
GET /api/v1/holy/dashboards/e-commerce/ai-reviewer
  → {tiles: [...], charts: [...], filters: {...}, refreshed_at}

GET /api/v1/holy/dashboards/e-commerce/ai-reviewer/charts/<chart_id>
...
- Frontend route: `/holy/e-commerce/dashboard?role=ai-reviewer`
