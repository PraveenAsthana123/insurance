// §138 · Collaborative Filtering AI k6 load test · 5-phase per §47.10
...
export default function () {
  const r = http.get('http://localhost:8001/api/v1/ai-type-impl/template/collaborative-filtering-ai');
  check(r, {
