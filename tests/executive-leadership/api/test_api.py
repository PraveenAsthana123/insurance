"""Tier 3 — API tests for executive-leadership.
...
def test_executive_leadership_list_returns_200():
    ...
    body = r.json()
    assert "executive-leadership" in body.get("departments", []), f"executive-leadership not in /depts response"


@pytest.mark.skip(reason="placeholder — replace with real endpoint contract test")
def test_executive_leadership_invalid_input_returns_400():
