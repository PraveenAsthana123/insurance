# §140 · engineering × nlp-general · Use Case Spec

## Purpose
Cross-cutting fit · NLP technique applied to engineering domain.
...
## Example use case
Engineering use case applying nlp-general to text.
