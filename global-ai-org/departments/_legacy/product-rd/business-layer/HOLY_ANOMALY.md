# HOLY Beverage — Product Rd — Anomaly Detection
...
## Anomaly catalog (top 20 per product-rd)

| # | Anomaly type | Severity | Tier | Auto-action | Backing data |
|---|---|---|---|---|---|
| 1 | _stub: anomaly for product-rd_ | high | tier 2 | alert + auto-investigate | literature + lab + sensory |
