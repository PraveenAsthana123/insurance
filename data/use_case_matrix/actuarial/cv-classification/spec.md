# §140 · actuarial × cv-classification · Use Case Spec

## Purpose
Cross-cutting fit · CV technique applied to actuarial domain.
...
## Example use case
Actuarial use case applying cv-classification to images.
