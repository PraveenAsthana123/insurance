# HOLY Beverage — Legal — AS-IS Process Assessment
...
This document is the **input to the AI strategy planning** for Legal.
...
|---|---|---|---|---|---|---|---|---|
| 1 | Manual contract redlining | 24 hrs/wk | Med | $1M/yr | Lawyer overload | Slow | +10-day cycle | Word track-changes |
| 2 | Manual clause search | 8 hrs/wk | High | $300K/yr | Paralegal burden | Inconsistent | Risk | iManage search |
| 3 | Manual matter intake | 6 hrs/wk | Med | $200K/yr | Lawyer overhead | Email-driven | Slow | Email + DMS |
| 4 | Manual e-discovery review | 80 hrs/wk | High | $2M/case | Doc-review fatigue | Sampling | +30d cycle | Relativity |
| 5 | Manual NDA processing | 4 hrs/wk | Low | $80K/yr | Lawyer overhead | Repetitive | Slow | DocuSign + email |
...
4. **Measure** via the persona's main KPI: Contract turnaround time, clause compliance, outside-counsel spend
