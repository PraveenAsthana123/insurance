# HOLY Beverage — Manufacturing — Devops Dashboard

> Per global CLAUDE.md §64.37 — every (dept, role) pair MUST have a
> role-scoped dashboard. This is the dashboard for **devops** in **manufacturing**.

## Persona

The **devops** at Manufacturing. They use this dashboard
...
returned by backend `GET /api/v1/holy/dashboards/manufacturing/devops/charts/<chart_id>`.
...
```
GET /api/v1/holy/dashboards/manufacturing/devops
  → {tiles: [...], charts: [...], filters: {...}, refreshed_at}

GET /api/v1/holy/dashboards/manufacturing/devops/charts/<chart_id>
...
- Frontend route: `/holy/manufacturing/dashboard?role=devops`
