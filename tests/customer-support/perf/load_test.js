// Tier 9-10 — Performance + load test for customer-support.
//
// Recommended: k6 (per global §64.42).
//
// Run with:  k6 run tests/customer-support/perf/load_test.js
//
...
export default function () {
  ...
  check(res, {
    ...
    'has customer-support': (r) => r.body.includes('customer-support'),
  });
  sleep(1);
}
