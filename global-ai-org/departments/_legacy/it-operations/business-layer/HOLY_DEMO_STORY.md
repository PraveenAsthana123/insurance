# HOLY Beverage — It Operations — Demo User Story
...
**Sandra, Director of IT Operations**
...
The persona needs to: **raise infra uptime to 99.95%, cut ticket volume 50%, generate $5M cloud-cost savings**

Main KPI being moved: **Uptime, MTTD, MTTR, ticket volume, cloud-cost-per-active-user**

## 3. Walkthrough (what they see + do)

1. Persona lands on `/holy/it-operations` (the HOLY navigation page for this dept).
...
> "Today Sandra spends 80% of their week on manual data
...
> counterfactual. We don't replace Sandra — we replace
...
|---|---|---|---|
| 1 | Open `/holy/it-operations` | Left sidebar with N processes | "Every process this dept owns, surfaced as navigable artifacts" |
...
**Cross-reference**: This story powers the demo at `/holy/it-operations` in the
HOLY frontend. The literal click-by-click in §5 is also the drill
`tests/drills/drill_dept_demo_it_operations.py` (planned).
