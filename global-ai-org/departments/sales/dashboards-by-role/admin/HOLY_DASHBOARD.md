# HOLY Beverage — Sales — Admin Dashboard

> Per global CLAUDE.md §64.37 — every (dept, role) pair MUST have a
> role-scoped dashboard. This is the dashboard for **admin** in **sales**.

## Persona

The **admin** at Sales. They use this dashboard
...
returned by backend `GET /api/v1/holy/dashboards/sales/admin/charts/<chart_id>`.
...
```
GET /api/v1/holy/dashboards/sales/admin
  → {tiles: [...], charts: [...], filters: {...}, refreshed_at}

GET /api/v1/holy/dashboards/sales/admin/charts/<chart_id>
...
- Frontend route: `/holy/sales/dashboard?role=admin`
