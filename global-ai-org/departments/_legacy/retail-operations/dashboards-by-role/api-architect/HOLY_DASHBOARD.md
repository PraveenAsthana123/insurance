# HOLY Beverage — Retail Operations — Api Architect Dashboard

> Per global CLAUDE.md §64.37 — every (dept, role) pair MUST have a
> role-scoped dashboard. This is the dashboard for **api-architect** in **retail-operations**.

## Persona

The **api-architect** at Retail Operations. They use this dashboard
...
returned by backend `GET /api/v1/holy/dashboards/retail-operations/api-architect/charts/<chart_id>`.
...
```
GET /api/v1/holy/dashboards/retail-operations/api-architect
  → {tiles: [...], charts: [...], filters: {...}, refreshed_at}

GET /api/v1/holy/dashboards/retail-operations/api-architect/charts/<chart_id>
...
- Frontend route: `/holy/retail-operations/dashboard?role=api-architect`
