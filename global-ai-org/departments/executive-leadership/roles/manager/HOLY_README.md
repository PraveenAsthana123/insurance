# Executive Leadership — Manager (HOLY)

**Source:** operator brief 2026-05-21.

## Role focus in this department

KPI ownership + decision approval + team coaching

## What this role owns

department KPIs, ROI, approval queue, team performance
...
- `../dashboards-by-role/manager/` — role-scoped dashboards (when authored)
- `../reports-by-role/manager/` — role-scoped reports (when authored)
