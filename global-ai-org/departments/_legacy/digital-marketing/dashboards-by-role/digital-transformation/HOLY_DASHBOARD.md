# HOLY Beverage — Digital Marketing — Digital Transformation Dashboard

> Per global CLAUDE.md §64.37 — every (dept, role) pair MUST have a
> role-scoped dashboard. This is the dashboard for **digital-transformation** in **digital-marketing**.

## Persona

The **digital-transformation** at Digital Marketing. They use this dashboard
...
returned by backend `GET /api/v1/holy/dashboards/digital-marketing/digital-transformation/charts/<chart_id>`.
...
```
GET /api/v1/holy/dashboards/digital-marketing/digital-transformation
  → {tiles: [...], charts: [...], filters: {...}, refreshed_at}

GET /api/v1/holy/dashboards/digital-marketing/digital-transformation/charts/<chart_id>
...
- Frontend route: `/holy/digital-marketing/dashboard?role=digital-transformation`
