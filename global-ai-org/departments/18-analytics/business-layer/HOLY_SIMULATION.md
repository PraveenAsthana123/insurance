# HOLY_SIMULATION.md · Dept 18 · Data & Analytics
...
## Backend API
- `POST /api/v1/holy/sim/analytics/{process}/run`
- `GET /api/v1/holy/sim/analytics/{process}/runs/{sim_id}/events` (SSE)
- `GET /api/v1/holy/sim/analytics/{process}/runs/{sim_id}/manifest`
- `GET /api/v1/holy/sim/analytics/{process}/runs/{sim_id}/replay`
