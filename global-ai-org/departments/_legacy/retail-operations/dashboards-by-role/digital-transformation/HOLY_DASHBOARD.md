# HOLY Beverage — Retail Operations — Digital Transformation Dashboard

> Per global CLAUDE.md §64.37 — every (dept, role) pair MUST have a
> role-scoped dashboard. This is the dashboard for **digital-transformation** in **retail-operations**.

## Persona

The **digital-transformation** at Retail Operations. They use this dashboard
...
returned by backend `GET /api/v1/holy/dashboards/retail-operations/digital-transformation/charts/<chart_id>`.
...
```
GET /api/v1/holy/dashboards/retail-operations/digital-transformation
  → {tiles: [...], charts: [...], filters: {...}, refreshed_at}

GET /api/v1/holy/dashboards/retail-operations/digital-transformation/charts/<chart_id>
...
- Frontend route: `/holy/retail-operations/dashboard?role=digital-transformation`
