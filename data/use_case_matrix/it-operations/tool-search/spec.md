# §140 · it-operations × tool-search · Use Case Spec

## Purpose
PRIMARY fit · Ops technique applied to it-operations domain.
...
## Example use case
It Operations use case applying tool-search to tool catalog.
