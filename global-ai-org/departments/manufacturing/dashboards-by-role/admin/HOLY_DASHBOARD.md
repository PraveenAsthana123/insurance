# HOLY Beverage — Manufacturing — Admin Dashboard

> Per global CLAUDE.md §64.37 — every (dept, role) pair MUST have a
> role-scoped dashboard. This is the dashboard for **admin** in **manufacturing**.

## Persona

The **admin** at Manufacturing. They use this dashboard
...
returned by backend `GET /api/v1/holy/dashboards/manufacturing/admin/charts/<chart_id>`.
...
```
GET /api/v1/holy/dashboards/manufacturing/admin
  → {tiles: [...], charts: [...], filters: {...}, refreshed_at}

GET /api/v1/holy/dashboards/manufacturing/admin/charts/<chart_id>
...
- Frontend route: `/holy/manufacturing/dashboard?role=admin`
