# HOLY_RECOMMENDATION.md · Dept 14 · finance
...
Recommendation system for Dept 14 (finance). All 3 classical flavors covered per §64.22.

## Item-based (collaborative filter)

**Algorithm**: RL DDPG (allocation policy)
...
**Algorithm**: Bond/asset attribute embedding (sector + duration + risk)
...
**Algorithm**: DDPG + risk-attribute · constrained portfolio optimization
