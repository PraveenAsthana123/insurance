# HOLY Beverage — Executive Leadership — Anomaly Detection
...
## Anomaly catalog (top 20 per executive-leadership)

| # | Anomaly type | Severity | Tier | Auto-action | Backing data |
|---|---|---|---|---|---|
| 1 | _stub: anomaly for executive-leadership_ | high | tier 2 | alert + auto-investigate | consolidated KPIs + market intel |
