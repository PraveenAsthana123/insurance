...
P1_FEATURES = [
    ...
    ("F04", "Audit Log Explorer UI",
        ["GET /api/v1/audit-search/recent"], "AuditExplorerPage.jsx", "/audit-explorer"),
    ("F05", "Cost Optimizer UI",
        ["GET /api/v1/eai-os/cost"], "CostOptimizerPage.jsx", "/cost"),
    ...
    ("F08", "Vector DB Browser UI",
        ["GET /api/v1/agent-kernel/memory"], "VectorBrowserPage.jsx", "/vectors"),
    ...
    ("F14", "Embedding Playground UI",
        ["GET /api/v1/agent-kernel/memory"], "EmbeddingPlayground.jsx", "/embeddings"),
