# HOLY Beverage — Executive Leadership — Data Owner Dashboard

> Per global CLAUDE.md §64.37 — every (dept, role) pair MUST have a
> role-scoped dashboard. This is the dashboard for **data-owner** in **executive-leadership**.

## Persona

The **data-owner** at Executive Leadership. They use this dashboard
...
returned by backend `GET /api/v1/holy/dashboards/executive-leadership/data-owner/charts/<chart_id>`.
...
```
GET /api/v1/holy/dashboards/executive-leadership/data-owner
  → {tiles: [...], charts: [...], filters: {...}, refreshed_at}

GET /api/v1/holy/dashboards/executive-leadership/data-owner/charts/<chart_id>
...
- Frontend route: `/holy/executive-leadership/dashboard?role=data-owner`
