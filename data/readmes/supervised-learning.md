# Supervised Learning · Comprehensive README · §137

**Effective**: 2026-06-11 · **Slug**: `supervised-learning` · **Kind**: `tabular_ml`
**Accuracy**: 0.973 · **Algorithm**: GradientBoostingClassifier

---

## 1. BRD · Business Requirements Document

**Business goal**: Reduce manual effort + improve accuracy for supervised learning tasks in
...
**FR-1**: System MUST accept input matching `supervised-learning` schema
...
Caller (frontend/agent)
        │
        ▼
  /api/v1/ai-types/supervised-learning/predict
        │
        ▼
...
- `predictions_supervised-learning`: id · input_jsonb · output · confidence · timestamp

**Endpoints**:
- `POST /api/v1/ai-types/supervised-learning/predict` · body: features → prediction
- `GET /api/v1/ai-types/supervised-learning/metrics` → live metrics.json
- `GET /api/v1/ai-types/supervised-learning/explain/{prediction_id}` → SHAP
...
```
[router.py] → [model_loader.py] → [/models/supervised-learning/model.joblib]
            ↘ [preprocessor.py]
...
- collection: `supervised-learning_embeddings`
...
**Fairness metrics** (from data/fairness/supervised-learning.json):
