# HOLY Beverage — Retail Operations — Contact Management (customer + vendor + internal)
...
- Sync: scheduled inbound from retail-operations's CRM / ERP / HRIS
...
|---|---|---|
| GET /api/v1/holy/contacts/retail-operations/customers | list | manager / data-owner |
| GET /api/v1/holy/contacts/retail-operations/vendors | list | manager / procurement |
| GET /api/v1/holy/contacts/retail-operations/internal | list | any dept role |
| POST /api/v1/holy/contacts/retail-operations/customers | create | admin / manager |
| PUT /api/v1/holy/contacts/retail-operations/customers/{id} | update | admin / data-owner |
| DELETE /api/v1/holy/contacts/retail-operations/customers/{id} | soft-delete | admin |
