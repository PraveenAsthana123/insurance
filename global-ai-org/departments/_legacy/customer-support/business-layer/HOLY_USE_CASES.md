# HOLY Beverage — Customer Support — AI Use-Case Catalog
...
> use cases for **customer-support**. Implementation status tracked per current
> codebase state.
...
## 2. Customer Support-Specific Use Cases

| Use Case | Category | Data Types | AI Area | Business Value | Status |
|---|---|---|---|---|---|
| AI Chat Assistant | Support | tickets/chat | Conversational AI | Less support tickets | 🟡 council_agent.py applies |
| Intelligent Ticket Routing | Support | ticket text | NLP Classification | Faster handling | 🟡 nlp_lifecycle.py applies |
| Knowledge Base AI (RAG) | Support | KB articles | RAG | Self-service deflection | ✅ rag_lifecycle.py |
| Voice AI Assistant | Support | audio | Speech AI | 24x7 support | ❌ deferred (Whisper + TTS) |
| Sentiment + Escalation AI | Support | tickets/chat | Sentiment + Rules | Higher CSAT | 🟡 nlp_lifecycle.py + agentic_stack |
