"""Tier 3 — API tests for operations.
...
def test_operations_list_returns_200():
    ...
    body = r.json()
    assert "operations" in body.get("departments", []), f"operations not in /depts response"


@pytest.mark.skip(reason="placeholder — replace with real endpoint contract test")
def test_operations_invalid_input_returns_400():
