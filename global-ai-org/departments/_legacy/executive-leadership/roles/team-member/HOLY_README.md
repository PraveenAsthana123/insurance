# Executive Leadership — Team Member (HOLY)

**Source:** operator brief 2026-05-21.

## Role focus in this department

day-to-day execution using the AI tools

## What this role owns

tasks completed, AI recommendations accepted/overridden, feedback
...
- `../dashboards-by-role/team-member/` — role-scoped dashboards (when authored)
- `../reports-by-role/team-member/` — role-scoped reports (when authored)
