# HOLY Beverage — Product Rd — Incident Management (L1/L2/L3 + RAG)
...
|---|---|---|---|---|
| 1 | _stub: replace with real L1 issue for product-rd_ | runbook URL | < 1 min | < 5 min |
...
- RAG corpus: `data/product-rd/runbooks/` + `data/product-rd/past-incidents/`
