# Underwriting — digital-transformation Reports

Per global §64.37 — role-scoped reports (≥ 3 standard per role).

## Standard reports

### R1 — Underwriting digital-transformation digest
...
## API
```
GET  /api/v1/insur/reports/underwriting/digital-transformation
POST /api/v1/insur/reports/underwriting/digital-transformation/{report_id}/run
```
