# HOLY Beverage — Marketing — Data Downloads
...
|---|---|---|---|---|---|
| 1 | `marketing_primary_sample` | Marketing primary use-case sample | tabular | 5 | 5 |
...
### 3.x `marketing_primary_sample`

- **Title:** Marketing primary use-case sample
- **Lifecycle:** tabular
...
| Endpoint | Returns |
|---|---|
| `GET /api/v1/holy/downloads/marketing` | Catalog (datasets + URLs) |
| `GET /api/v1/holy/downloads/marketing/<dataset_id>.csv` | CSV file |
| `GET /api/v1/holy/downloads/marketing/<dataset_id>.json` | JSON file |
| `GET /api/v1/holy/downloads/marketing/<dataset_id>.before.svg` | Pre-process viz |
| `GET /api/v1/holy/downloads/marketing/<dataset_id>.after.svg` | Post-process viz |
