# HOLY Beverage — Supply Chain — Incident Management (L1/L2/L3 + RAG)
...
|---|---|---|---|---|
| 1 | _stub: replace with real L1 issue for supply-chain_ | runbook URL | < 1 min | < 5 min |
...
- RAG corpus: `data/supply-chain/runbooks/` + `data/supply-chain/past-incidents/`
