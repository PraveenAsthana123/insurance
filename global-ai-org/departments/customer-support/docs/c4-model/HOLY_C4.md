# HOLY Beverage — Customer Support C4 Model
...
graph TB
    ...
    holy[HOLY Customer Support Platform]
...
graph LR
    ...
    features --> model[NLP, RAG, Conversational AI, Sentiment AI, Routing AI]
...
- Decision lineage: every API call writes a row to `customer_support_audit` (see LLD §2)

## L6 — Observability

- Logs: structured JSON with `correlation_id`, `tenant_id`, `user_id`, `model_version`, `prompt_version`
- Metrics: `customer-support_request_count`, `customer-support_latency_p95`, `customer-support_model_confidence`, `customer-support_hallucination_rate`
