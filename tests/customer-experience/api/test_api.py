"""Tier 3 — API tests for customer-experience.
...
def test_customer_experience_list_returns_200():
    ...
    body = r.json()
    assert "customer-experience" in body.get("departments", []), f"customer-experience not in /depts response"


@pytest.mark.skip(reason="placeholder — replace with real endpoint contract test")
def test_customer_experience_invalid_input_returns_400():
