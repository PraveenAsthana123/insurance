# HOLY Beverage — Manufacturing — Manager Dashboard

> Per global CLAUDE.md §64.37 — every (dept, role) pair MUST have a
> role-scoped dashboard. This is the dashboard for **manager** in **manufacturing**.

## Persona

The **manager** at Manufacturing. They use this dashboard
...
returned by backend `GET /api/v1/holy/dashboards/manufacturing/manager/charts/<chart_id>`.
...
```
GET /api/v1/holy/dashboards/manufacturing/manager
  → {tiles: [...], charts: [...], filters: {...}, refreshed_at}

GET /api/v1/holy/dashboards/manufacturing/manager/charts/<chart_id>
...
- Frontend route: `/holy/manufacturing/dashboard?role=manager`
