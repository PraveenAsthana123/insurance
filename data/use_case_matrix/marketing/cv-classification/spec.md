# §140 · marketing × cv-classification · Use Case Spec

## Purpose
Cross-cutting fit · CV technique applied to marketing domain.
...
## Example use case
Marketing use case applying cv-classification to images.
