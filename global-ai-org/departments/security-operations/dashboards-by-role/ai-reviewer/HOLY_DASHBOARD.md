# HOLY Beverage — Security Operations — Ai Reviewer Dashboard

> Per global CLAUDE.md §64.37 — every (dept, role) pair MUST have a
> role-scoped dashboard. This is the dashboard for **ai-reviewer** in **security-operations**.

## Persona

The **ai-reviewer** at Security Operations. They use this dashboard
...
returned by backend `GET /api/v1/holy/dashboards/security-operations/ai-reviewer/charts/<chart_id>`.
...
```
GET /api/v1/holy/dashboards/security-operations/ai-reviewer
  → {tiles: [...], charts: [...], filters: {...}, refreshed_at}

GET /api/v1/holy/dashboards/security-operations/ai-reviewer/charts/<chart_id>
...
- Frontend route: `/holy/security-operations/dashboard?role=ai-reviewer`
