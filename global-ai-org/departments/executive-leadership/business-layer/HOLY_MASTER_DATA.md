# HOLY Beverage — Executive Leadership — Master Data

> Per operator 2026-05-24 — every dept publishes its master + reference
> data here. Focus: **org-structure + KPI-tree + decision-rights matrix**.
...
This dept (**executive-leadership**) operates against the slice of the structure
...
| Endpoint | Returns |
|---|---|
| `GET /api/v1/holy/master-data/executive-leadership` | Schema catalog + per-entity owner |
| `GET /api/v1/holy/master-data/executive-leadership/customer?limit=20` | Customer master sample |
| `GET /api/v1/holy/master-data/executive-leadership/vendor?limit=20` | Vendor master sample |
| `GET /api/v1/holy/master-data/executive-leadership/product?limit=20` | Product master sample |
| `GET /api/v1/holy/master-data/executive-leadership/org-structure` | Org tree slice for this dept |
...
1. (+) `/api/v1/holy/master-data/executive-leadership` returns 200 + entity catalog
