# HOLY Beverage — Procurement — Demo User Story
...
**David, Chief Procurement Officer**
...
The persona needs to: **cut maverick spend 50%, raise contract compliance 95%, generate $20M annual savings**

Main KPI being moved: **Maverick spend %, contract compliance %, annual savings, supplier risk score**

## 3. Walkthrough (what they see + do)

1. Persona lands on `/holy/procurement` (the HOLY navigation page for this dept).
...
> "Today David spends 80% of their week on manual data
...
> counterfactual. We don't replace David — we replace
...
|---|---|---|---|
| 1 | Open `/holy/procurement` | Left sidebar with N processes | "Every process this dept owns, surfaced as navigable artifacts" |
...
**Cross-reference**: This story powers the demo at `/holy/procurement` in the
HOLY frontend. The literal click-by-click in §5 is also the drill
`tests/drills/drill_dept_demo_procurement.py` (planned).
