"""Tier 3 — API tests for it-operations.
...
def test_it_operations_list_returns_200():
    ...
    body = r.json()
    assert "it-operations" in body.get("departments", []), f"it-operations not in /depts response"


@pytest.mark.skip(reason="placeholder — replace with real endpoint contract test")
def test_it_operations_invalid_input_returns_400():
