# HOLY Beverage — Hr — AS-IS Process Assessment
...
This document is the **input to the AI strategy planning** for Hr.
...
|---|---|---|---|---|---|---|---|---|
| 1 | Manual resume screening | 30 hrs/wk | High | $300K/yr | Recruiter overload | Subjective | −40% quality | ATS only |
| 2 | Manual interview scheduling | 20 hrs/wk | Med | $150K/yr | Coord overhead | Slow | +15-day cycle | Email + Calendly |
| 3 | Manual onboarding | 24 hrs/wk | Med | $250K/yr | HR + new-hire frustration | Inconsistent | −20% productivity D30 | Paper + ATS |
| 4 | Annual performance review | 80 hrs/wk | High | $2M/yr | Mgr burnout | Stale feedback | −30% growth | Workday forms |
| 5 | Reactive attrition response | 0 hrs/wk | High | $5M/yr backfill | Exec firefighting | Post-exit | Lost talent | Exit interview |
...
4. **Measure** via the persona's main KPI: Time-to-fill, attrition rate, employee NPS, internal mobility rate
