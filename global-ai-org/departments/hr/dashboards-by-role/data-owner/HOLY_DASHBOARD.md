# HOLY Beverage — Hr — Data Owner Dashboard

> Per global CLAUDE.md §64.37 — every (dept, role) pair MUST have a
> role-scoped dashboard. This is the dashboard for **data-owner** in **hr**.

## Persona

The **data-owner** at Hr. They use this dashboard
...
returned by backend `GET /api/v1/holy/dashboards/hr/data-owner/charts/<chart_id>`.
...
```
GET /api/v1/holy/dashboards/hr/data-owner
  → {tiles: [...], charts: [...], filters: {...}, refreshed_at}

GET /api/v1/holy/dashboards/hr/data-owner/charts/<chart_id>
...
- Frontend route: `/holy/hr/dashboard?role=data-owner`
