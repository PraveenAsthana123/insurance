# Executive Leadership — Api Architect (HOLY)

**Source:** operator brief 2026-05-21.

## Role focus in this department

API design + versioning + integration with other depts

## What this role owns

OpenAPI specs, contract tests, deprecation, rate limits
...
- `../dashboards-by-role/api-architect/` — role-scoped dashboards (when authored)
- `../reports-by-role/api-architect/` — role-scoped reports (when authored)
