# HOLY Beverage — Digital Marketing — Contact Management (customer + vendor + internal)
...
- Sync: scheduled inbound from digital-marketing's CRM / ERP / HRIS
...
|---|---|---|
| GET /api/v1/holy/contacts/digital-marketing/customers | list | manager / data-owner |
| GET /api/v1/holy/contacts/digital-marketing/vendors | list | manager / procurement |
| GET /api/v1/holy/contacts/digital-marketing/internal | list | any dept role |
| POST /api/v1/holy/contacts/digital-marketing/customers | create | admin / manager |
| PUT /api/v1/holy/contacts/digital-marketing/customers/{id} | update | admin / data-owner |
| DELETE /api/v1/holy/contacts/digital-marketing/customers/{id} | soft-delete | admin |
