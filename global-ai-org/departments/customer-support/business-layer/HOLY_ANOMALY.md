# HOLY Beverage — Customer Support — Anomaly Detection
...
## Anomaly catalog (top 20 per customer-support)

| # | Anomaly type | Severity | Tier | Auto-action | Backing data |
|---|---|---|---|---|---|
| 1 | _stub: anomaly for customer-support_ | high | tier 2 | alert + auto-investigate | tickets + KB + chat |
