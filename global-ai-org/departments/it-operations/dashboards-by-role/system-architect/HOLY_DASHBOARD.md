# HOLY Beverage — It Operations — System Architect Dashboard

> Per global CLAUDE.md §64.37 — every (dept, role) pair MUST have a
> role-scoped dashboard. This is the dashboard for **system-architect** in **it-operations**.

## Persona

The **system-architect** at It Operations. They use this dashboard
...
returned by backend `GET /api/v1/holy/dashboards/it-operations/system-architect/charts/<chart_id>`.
...
```
GET /api/v1/holy/dashboards/it-operations/system-architect
  → {tiles: [...], charts: [...], filters: {...}, refreshed_at}

GET /api/v1/holy/dashboards/it-operations/system-architect/charts/<chart_id>
...
- Frontend route: `/holy/it-operations/dashboard?role=system-architect`
