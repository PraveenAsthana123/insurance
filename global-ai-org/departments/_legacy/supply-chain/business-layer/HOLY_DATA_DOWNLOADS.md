# HOLY Beverage — Supply Chain — Data Downloads
...
|---|---|---|---|---|---|
| 1 | `supply_chain_primary_sample` | Supply Chain primary use-case sample | tabular | 5 | 5 |
...
### 3.x `supply_chain_primary_sample`

- **Title:** Supply Chain primary use-case sample
- **Lifecycle:** tabular
...
| Endpoint | Returns |
|---|---|
| `GET /api/v1/holy/downloads/supply-chain` | Catalog (datasets + URLs) |
| `GET /api/v1/holy/downloads/supply-chain/<dataset_id>.csv` | CSV file |
| `GET /api/v1/holy/downloads/supply-chain/<dataset_id>.json` | JSON file |
| `GET /api/v1/holy/downloads/supply-chain/<dataset_id>.before.svg` | Pre-process viz |
| `GET /api/v1/holy/downloads/supply-chain/<dataset_id>.after.svg` | Post-process viz |
