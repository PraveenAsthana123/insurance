# HOLY Beverage — Security Operations — Incident Management (L1/L2/L3 + RAG)
...
|---|---|---|---|---|
| 1 | _stub: replace with real L1 issue for security-operations_ | runbook URL | < 1 min | < 5 min |
...
- RAG corpus: `data/security-operations/runbooks/` + `data/security-operations/past-incidents/`
