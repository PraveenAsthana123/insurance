# HOLY Beverage — Retail Operations — Team Member Dashboard

> Per global CLAUDE.md §64.37 — every (dept, role) pair MUST have a
> role-scoped dashboard. This is the dashboard for **team-member** in **retail-operations**.

## Persona

The **team-member** at Retail Operations. They use this dashboard
...
returned by backend `GET /api/v1/holy/dashboards/retail-operations/team-member/charts/<chart_id>`.
...
```
GET /api/v1/holy/dashboards/retail-operations/team-member
  → {tiles: [...], charts: [...], filters: {...}, refreshed_at}

GET /api/v1/holy/dashboards/retail-operations/team-member/charts/<chart_id>
...
- Frontend route: `/holy/retail-operations/dashboard?role=team-member`
