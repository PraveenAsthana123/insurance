# HOLY Beverage — Marketing — Simulation Tab
...
under `REFERENCE_PROCESSES[("marketing", "<process>")]`.
...
| Endpoint | Purpose |
|---|---|
| POST /api/v1/holy/sim/marketing/{process}/run | Trigger simulation |
| GET /api/v1/holy/sim/marketing/{process}/runs | List past runs |
| GET /api/v1/holy/sim/marketing/{process}/runs/{sim_id}/manifest | Per-run summary |
| GET /api/v1/holy/sim/marketing/{process}/runs/{sim_id}/events | Event stream |

## TODO

- [ ] Define ≥ 1 process for marketing in `REFERENCE_PROCESSES` dict
