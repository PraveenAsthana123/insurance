# HOLY Beverage — E Commerce — Test Architect Dashboard

> Per global CLAUDE.md §64.37 — every (dept, role) pair MUST have a
> role-scoped dashboard. This is the dashboard for **test-architect** in **e-commerce**.

## Persona

The **test-architect** at E Commerce. They use this dashboard
...
returned by backend `GET /api/v1/holy/dashboards/e-commerce/test-architect/charts/<chart_id>`.
...
```
GET /api/v1/holy/dashboards/e-commerce/test-architect
  → {tiles: [...], charts: [...], filters: {...}, refreshed_at}

GET /api/v1/holy/dashboards/e-commerce/test-architect/charts/<chart_id>
...
- Frontend route: `/holy/e-commerce/dashboard?role=test-architect`
