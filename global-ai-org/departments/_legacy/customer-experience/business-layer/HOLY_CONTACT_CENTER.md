# HOLY Beverage — Customer Experience — Contact Center Automation
...
**Manager** + **CX role** (dept = customer-experience). For non-CX depts this covers
...
|---|---|---|---|---|
| 1 | _stub: replace with real intent for customer-experience_ | _ | yes/no | DistilBERT |
| … | (20 total minimum) | | | |
...
- LLM model: `gemma3:4b` (default for customer-experience) — adjust per latency/cost SLO
- RAG corpus: `data/customer-experience/kb/` + `data/customer-experience/sops/`
