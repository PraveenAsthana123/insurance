# Operations — Digital Transformation (HOLY)
...
## How this role uses HOLY's Operations platform

- **Navigates** via `HOLY_NAV.json` (left-sidebar process picker; see `/holy/operations` in frontend)
...
Process Mining AI, Forecasting ML, Optimization AI, Anomaly Detection
