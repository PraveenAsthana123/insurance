# HOLY Beverage — Finance — Incident Management (L1/L2/L3 + RAG)
...
|---|---|---|---|---|
| 1 | _stub: replace with real L1 issue for finance_ | runbook URL | < 1 min | < 5 min |
...
- RAG corpus: `data/finance/runbooks/` + `data/finance/past-incidents/`
