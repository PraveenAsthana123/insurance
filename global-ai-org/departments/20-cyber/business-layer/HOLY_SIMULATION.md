# HOLY_SIMULATION.md · Dept 20 · Cybersecurity / Fraud Defense
...
## Backend API
- `POST /api/v1/holy/sim/cyber/{process}/run`
- `GET /api/v1/holy/sim/cyber/{process}/runs/{sim_id}/events` (SSE)
- `GET /api/v1/holy/sim/cyber/{process}/runs/{sim_id}/manifest`
- `GET /api/v1/holy/sim/cyber/{process}/runs/{sim_id}/replay`
