# Customer Service / Contact Center — security Reports

Per global §64.37 — role-scoped reports (≥ 3 standard per role).

## Standard reports

### R1 — Customer Service / Contact Center security digest
...
## API
```
GET  /api/v1/insur/reports/customer-service/security
POST /api/v1/insur/reports/customer-service/security/{report_id}/run
```
