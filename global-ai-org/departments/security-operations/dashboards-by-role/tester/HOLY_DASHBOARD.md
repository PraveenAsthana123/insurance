# HOLY Beverage — Security Operations — Tester Dashboard

> Per global CLAUDE.md §64.37 — every (dept, role) pair MUST have a
> role-scoped dashboard. This is the dashboard for **tester** in **security-operations**.

## Persona

The **tester** at Security Operations. They use this dashboard
...
returned by backend `GET /api/v1/holy/dashboards/security-operations/tester/charts/<chart_id>`.
...
```
GET /api/v1/holy/dashboards/security-operations/tester
  → {tiles: [...], charts: [...], filters: {...}, refreshed_at}

GET /api/v1/holy/dashboards/security-operations/tester/charts/<chart_id>
...
- Frontend route: `/holy/security-operations/dashboard?role=tester`
