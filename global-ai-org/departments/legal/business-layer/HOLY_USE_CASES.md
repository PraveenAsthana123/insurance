# HOLY Beverage — Legal — AI Use-Case Catalog
...
> use cases for **legal**. Implementation status tracked per current
> codebase state.
...
## 2. Legal-Specific Use Cases

| Use Case | Category | Data Types | AI Area | Business Value | Status |
|---|---|---|---|---|---|
| Contract Intelligence AI | Legal | DOCX/PDF | NLP + Extraction | Faster review | 🟡 simulation_engine.py REFERENCE_PROCESSES[legal,contract_review] |
| AI Legal Research | Legal | legal text | RAG + NLP | Faster research | ✅ rag_lifecycle.py |
| Litigation Prediction AI | Legal | court records | Predictive | Better strategy | ❌ deferred (specialized data) |
| Clause Extraction AI | Legal | contracts | LayoutLM/NER | Less manual review | 🟡 nlp_lifecycle.py partial |
