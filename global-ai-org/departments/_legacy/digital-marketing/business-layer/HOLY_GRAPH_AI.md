# HOLY Beverage — Digital Marketing — Graph AI
...
> Anchor flow: **customer_segment ─ touches campaign ─ touches lead**.
...
```
customer_segment ─ touches campaign ─ touches lead
       │
       ▼
...
2. **Onboarding** — "Show me everything a `manager` in digital-marketing touches."
...
| Endpoint | Returns |
|---|---|
| `GET /api/v1/holy/graph/digital-marketing` | Full graph (nodes + edges) as JSON |
| `GET /api/v1/holy/graph/digital-marketing/nodes?type=role` | Filtered node list |
| `GET /api/v1/holy/graph/digital-marketing/neighbors/<node_id>` | 1-hop neighbors of a node |
