# HOLY Beverage — Hr — AI Use-Case Catalog
...
> use cases for **hr**. Implementation status tracked per current
> codebase state.
...
## 2. Hr-Specific Use Cases

| Use Case | Category | Data Types | AI Area | Business Value | Status |
|---|---|---|---|---|---|
| Resume Screening AI | HR | PDF resume/text | NLP Ranking | Faster hiring | ✅ simulation_engine.py REFERENCE_PROCESSES[hr,resume_screening] |
| Workforce Analytics AI | HR | employee data | Predictive HR | Better workforce planning | 🟡 full_lifecycle.py + role_dashboard catalog |
| Learning Assistant AI | HR/L&D | LMS data | Personalized AI | Higher training completion | ❌ deferred |
| Attrition Prediction AI | HR | employee data | Classification | Less attrition | ✅ full_lifecycle.py (churn-style task) |
| Employee Sentiment AI | HR | survey/chat | Sentiment | Higher engagement | 🟡 nlp_lifecycle.py applies |
