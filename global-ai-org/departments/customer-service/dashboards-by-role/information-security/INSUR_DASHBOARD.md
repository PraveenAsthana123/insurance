# Customer Service / Contact Center — information-security Dashboard

Per global §64.37 — role-scoped dashboard.

## Persona
**information-security** in Customer Service / Contact Center.
...
## API
```
GET /api/v1/insur/dashboards/customer-service/information-security
```
