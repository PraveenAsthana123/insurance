# HOLY Beverage — Digital Marketing — Information Security Dashboard

> Per global CLAUDE.md §64.37 — every (dept, role) pair MUST have a
> role-scoped dashboard. This is the dashboard for **information-security** in **digital-marketing**.

## Persona

The **information-security** at Digital Marketing. They use this dashboard
...
returned by backend `GET /api/v1/holy/dashboards/digital-marketing/information-security/charts/<chart_id>`.
...
```
GET /api/v1/holy/dashboards/digital-marketing/information-security
  → {tiles: [...], charts: [...], filters: {...}, refreshed_at}

GET /api/v1/holy/dashboards/digital-marketing/information-security/charts/<chart_id>
...
- Frontend route: `/holy/digital-marketing/dashboard?role=information-security`
