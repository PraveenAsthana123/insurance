# HOLY Beverage — E Commerce — Digital Transformation Dashboard

> Per global CLAUDE.md §64.37 — every (dept, role) pair MUST have a
> role-scoped dashboard. This is the dashboard for **digital-transformation** in **e-commerce**.

## Persona

The **digital-transformation** at E Commerce. They use this dashboard
...
returned by backend `GET /api/v1/holy/dashboards/e-commerce/digital-transformation/charts/<chart_id>`.
...
```
GET /api/v1/holy/dashboards/e-commerce/digital-transformation
  → {tiles: [...], charts: [...], filters: {...}, refreshed_at}

GET /api/v1/holy/dashboards/e-commerce/digital-transformation/charts/<chart_id>
...
- Frontend route: `/holy/e-commerce/dashboard?role=digital-transformation`
