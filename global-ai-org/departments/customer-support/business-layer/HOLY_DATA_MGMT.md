# HOLY Beverage — Customer Support — Input Data Mgmt + Before/After Viz
...
For every process AND sub-process in this dept (customer-support), populate the 6
surfaces below. tickets + KB + chat is the primary data class for customer-support.
...
Plots land in: `data/eval/customer-support/<pipeline>/<run_id>/plots/before_*.png`
...
Plots land in: `data/eval/customer-support/<pipeline>/<run_id>/plots/after_*.png`
