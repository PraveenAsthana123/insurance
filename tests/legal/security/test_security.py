"""Tier 11-12 — Security tests for legal.
...
def test_legal_owasp_zap_scan():
    """REPLACE — invoke OWASP ZAP CLI against legal surface (auth env only)."""
    pass


@pytest.mark.skip(reason="placeholder — requires Garak install + AI endpoint")
def test_legal_garak_prompt_injection():
