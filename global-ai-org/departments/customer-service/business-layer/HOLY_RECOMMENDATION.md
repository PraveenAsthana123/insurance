# HOLY_RECOMMENDATION.md · Dept 9 · customer-service
...
Recommendation system for Dept 9 (customer-service). All 3 classical flavors covered per §64.22.

## Item-based (collaborative filter)

**Algorithm**: Skill-based collaborative + workload bandit
...
**Algorithm**: BM25 + DPR over knowledge base
...
**Algorithm**: RAG + cross-encoder rerank (per §79)
