# HOLY Beverage — Operations — Api Architect Dashboard

> Per global CLAUDE.md §64.37 — every (dept, role) pair MUST have a
> role-scoped dashboard. This is the dashboard for **api-architect** in **operations**.

## Persona

The **api-architect** at Operations. They use this dashboard
...
returned by backend `GET /api/v1/holy/dashboards/operations/api-architect/charts/<chart_id>`.
...
```
GET /api/v1/holy/dashboards/operations/api-architect
  → {tiles: [...], charts: [...], filters: {...}, refreshed_at}

GET /api/v1/holy/dashboards/operations/api-architect/charts/<chart_id>
...
- Frontend route: `/holy/operations/dashboard?role=api-architect`
