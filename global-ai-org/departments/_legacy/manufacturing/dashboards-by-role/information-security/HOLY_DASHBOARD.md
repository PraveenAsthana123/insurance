# HOLY Beverage — Manufacturing — Information Security Dashboard

> Per global CLAUDE.md §64.37 — every (dept, role) pair MUST have a
> role-scoped dashboard. This is the dashboard for **information-security** in **manufacturing**.

## Persona

The **information-security** at Manufacturing. They use this dashboard
...
returned by backend `GET /api/v1/holy/dashboards/manufacturing/information-security/charts/<chart_id>`.
...
```
GET /api/v1/holy/dashboards/manufacturing/information-security
  → {tiles: [...], charts: [...], filters: {...}, refreshed_at}

GET /api/v1/holy/dashboards/manufacturing/information-security/charts/<chart_id>
...
- Frontend route: `/holy/manufacturing/dashboard?role=information-security`
