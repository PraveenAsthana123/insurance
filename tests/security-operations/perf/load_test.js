// Tier 9-10 — Performance + load test for security-operations.
//
// Recommended: k6 (per global §64.42).
//
// Run with:  k6 run tests/security-operations/perf/load_test.js
//
...
export default function () {
  ...
  check(res, {
    ...
    'has security-operations': (r) => r.body.includes('security-operations'),
  });
  sleep(1);
}
