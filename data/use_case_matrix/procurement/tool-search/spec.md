# §140 · procurement × tool-search · Use Case Spec

## Purpose
PRIMARY fit · Ops technique applied to procurement domain.
...
## Example use case
Procurement use case applying tool-search to tool catalog.
