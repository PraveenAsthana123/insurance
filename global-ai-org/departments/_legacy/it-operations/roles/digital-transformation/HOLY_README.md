# It Operations — Digital Transformation (HOLY)
...
## How this role uses HOLY's It Operations platform

- **Navigates** via `HOLY_NAV.json` (left-sidebar process picker; see `/holy/it-operations` in frontend)
