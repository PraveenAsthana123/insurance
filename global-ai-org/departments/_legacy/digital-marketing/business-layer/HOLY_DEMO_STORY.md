# HOLY Beverage — Digital Marketing — Demo User Story
...
**Sarah, VP of Digital Marketing at HOLY Beverage**
...
The persona needs to: **launch a new sparkling-energy SKU and decide channel-mix for $250K Q3 spend**

Main KPI being moved: **Cost per acquisition (CPA) below $18, ROAS ≥ 4.2**

## 3. Walkthrough (what they see + do)

1. Persona lands on `/holy/digital-marketing` (the HOLY navigation page for this dept).
...
> "Today Sarah spends 80% of their week on manual data
...
> counterfactual. We don't replace Sarah — we replace
...
|---|---|---|---|
| 1 | Open `/holy/digital-marketing` | Left sidebar with N processes | "Every process this dept owns, surfaced as navigable artifacts" |
...
**Cross-reference**: This story powers the demo at `/holy/digital-marketing` in the
HOLY frontend. The literal click-by-click in §5 is also the drill
`tests/drills/drill_dept_demo_digital_marketing.py` (planned).
