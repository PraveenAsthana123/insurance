# HOLY Beverage — Sales — Contact Center Automation
...
**Manager** + **CX role** (dept = sales). For non-CX depts this covers
...
|---|---|---|---|---|
| 1 | _stub: replace with real intent for sales_ | _ | yes/no | DistilBERT |
| … | (20 total minimum) | | | |
...
- LLM model: `gemma3:4b` (default for sales) — adjust per latency/cost SLO
- RAG corpus: `data/sales/kb/` + `data/sales/sops/`
