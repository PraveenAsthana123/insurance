# Customer Service / Contact Center — data-owner Dashboard

Per global §64.37 — role-scoped dashboard.

## Persona
**data-owner** in Customer Service / Contact Center.
...
## API
```
GET /api/v1/insur/dashboards/customer-service/data-owner
```
