# HOLY Beverage — Security Operations — Data Owner Dashboard

> Per global CLAUDE.md §64.37 — every (dept, role) pair MUST have a
> role-scoped dashboard. This is the dashboard for **data-owner** in **security-operations**.

## Persona

The **data-owner** at Security Operations. They use this dashboard
...
returned by backend `GET /api/v1/holy/dashboards/security-operations/data-owner/charts/<chart_id>`.
...
```
GET /api/v1/holy/dashboards/security-operations/data-owner
  → {tiles: [...], charts: [...], filters: {...}, refreshed_at}

GET /api/v1/holy/dashboards/security-operations/data-owner/charts/<chart_id>
...
- Frontend route: `/holy/security-operations/dashboard?role=data-owner`
