"""Tier 1 — Unit tests for customer-support.
...
def test_dept_module_imports():
    ...
    assert "customer-support" in "customer-support", "dept name must match"
...
@pytest.mark.skip(reason="placeholder — replace with real customer-support unit test")
def test_real_dept_logic():
    """REPLACE — real unit test for customer-support business logic."""
    pass
