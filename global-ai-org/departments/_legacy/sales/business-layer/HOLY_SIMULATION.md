# HOLY Beverage — Sales — Simulation Tab
...
under `REFERENCE_PROCESSES[("sales", "<process>")]`.
...
| Endpoint | Purpose |
|---|---|
| POST /api/v1/holy/sim/sales/{process}/run | Trigger simulation |
| GET /api/v1/holy/sim/sales/{process}/runs | List past runs |
| GET /api/v1/holy/sim/sales/{process}/runs/{sim_id}/manifest | Per-run summary |
| GET /api/v1/holy/sim/sales/{process}/runs/{sim_id}/events | Event stream |

## TODO

- [ ] Define ≥ 1 process for sales in `REFERENCE_PROCESSES` dict
