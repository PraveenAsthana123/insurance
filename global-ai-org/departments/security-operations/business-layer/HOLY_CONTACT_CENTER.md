# HOLY Beverage — Security Operations — Contact Center Automation
...
**Manager** + **CX role** (dept = security-operations). For non-CX depts this covers
...
|---|---|---|---|---|
| 1 | _stub: replace with real intent for security-operations_ | _ | yes/no | DistilBERT |
| … | (20 total minimum) | | | |
...
- LLM model: `gemma3:4b` (default for security-operations) — adjust per latency/cost SLO
- RAG corpus: `data/security-operations/kb/` + `data/security-operations/sops/`
