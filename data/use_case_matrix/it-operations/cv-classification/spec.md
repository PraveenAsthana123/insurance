# §140 · it-operations × cv-classification · Use Case Spec

## Purpose
Cross-cutting fit · CV technique applied to it-operations domain.
...
## Example use case
It Operations use case applying cv-classification to images.
