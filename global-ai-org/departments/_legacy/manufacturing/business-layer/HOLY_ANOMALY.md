# HOLY Beverage — Manufacturing — Anomaly Detection
...
## Anomaly catalog (top 20 per manufacturing)

| # | Anomaly type | Severity | Tier | Auto-action | Backing data |
|---|---|---|---|---|---|
| 1 | _stub: anomaly for manufacturing_ | high | tier 2 | alert + auto-investigate | sensor + image + batch |
