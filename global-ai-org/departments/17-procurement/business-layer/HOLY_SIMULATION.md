# HOLY_SIMULATION.md · Dept 17 · Procurement & Vendor Management
...
## Backend API
- `POST /api/v1/holy/sim/procurement/{process}/run`
- `GET /api/v1/holy/sim/procurement/{process}/runs/{sim_id}/events` (SSE)
- `GET /api/v1/holy/sim/procurement/{process}/runs/{sim_id}/manifest`
- `GET /api/v1/holy/sim/procurement/{process}/runs/{sim_id}/replay`
