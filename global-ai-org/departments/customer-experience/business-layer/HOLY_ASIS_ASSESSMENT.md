# HOLY Beverage — Customer Experience — AS-IS Process Assessment
...
This document is the **input to the AI strategy planning** for Customer Experience.
...
|---|---|---|---|---|---|---|---|---|
| 1 | Agent ticket triage (manual) | 5 hrs/wk | Med | $120K/yr | Agent burnout | Random routing | −40% FCR | Genesys-only |
| 2 | Knowledge-base search (keyword) | 4 hrs/wk | High | $60K/yr | Wrong answers | Outdated KB | −20% accuracy | Confluence search |
| 3 | Manual sentiment review | 8 hrs/wk | High | $200K/yr | Sampling-only | Reactive | Missed signals | Spreadsheet |
| 4 | Quality assurance audits | 6 hrs/wk | Med | $80K/yr | Sampling 2% | Slow feedback | Stale coaching | Excel forms |
| 5 | Voice transcription | 10 hrs/wk | Low | $150K/yr | Outsourced | 48h SLA | Slow analytics | Vendor |
...
4. **Measure** via the persona's main KPI: Average handle time (AHT) and first-contact resolution (FCR)
