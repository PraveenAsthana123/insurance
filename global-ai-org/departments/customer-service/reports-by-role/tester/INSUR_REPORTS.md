# Customer Service / Contact Center — tester Reports

Per global §64.37 — role-scoped reports (≥ 3 standard per role).

## Standard reports

### R1 — Customer Service / Contact Center tester digest
...
## API
```
GET  /api/v1/insur/reports/customer-service/tester
POST /api/v1/insur/reports/customer-service/tester/{report_id}/run
```
