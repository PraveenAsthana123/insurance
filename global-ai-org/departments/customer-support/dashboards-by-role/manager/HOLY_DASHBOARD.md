# HOLY Beverage — Customer Support — Manager Dashboard

> Per global CLAUDE.md §64.37 — every (dept, role) pair MUST have a
> role-scoped dashboard. This is the dashboard for **manager** in **customer-support**.

## Persona

The **manager** at Customer Support. They use this dashboard
...
returned by backend `GET /api/v1/holy/dashboards/customer-support/manager/charts/<chart_id>`.
...
```
GET /api/v1/holy/dashboards/customer-support/manager
  → {tiles: [...], charts: [...], filters: {...}, refreshed_at}

GET /api/v1/holy/dashboards/customer-support/manager/charts/<chart_id>
...
- Frontend route: `/holy/customer-support/dashboard?role=manager`
