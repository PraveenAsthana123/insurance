# Executive Leadership — System Architect (HOLY)

**Source:** operator brief 2026-05-21.

## Role focus in this department

end-to-end system design for this department

## What this role owns

HLD, LLD, integration patterns, tech-stack decisions
...
- `../dashboards-by-role/system-architect/` — role-scoped dashboards (when authored)
- `../reports-by-role/system-architect/` — role-scoped reports (when authored)
