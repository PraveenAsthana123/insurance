# Underwriting — test-architect Reports

Per global §64.37 — role-scoped reports (≥ 3 standard per role).

## Standard reports

### R1 — Underwriting test-architect digest
...
## API
```
GET  /api/v1/insur/reports/underwriting/test-architect
POST /api/v1/insur/reports/underwriting/test-architect/{report_id}/run
```
