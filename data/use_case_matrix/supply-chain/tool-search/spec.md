# §140 · supply-chain × tool-search · Use Case Spec

## Purpose
PRIMARY fit · Ops technique applied to supply-chain domain.
...
## Example use case
Supply Chain use case applying tool-search to tool catalog.
