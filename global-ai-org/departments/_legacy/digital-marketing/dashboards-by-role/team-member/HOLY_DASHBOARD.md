# HOLY Beverage — Digital Marketing — Team Member Dashboard

> Per global CLAUDE.md §64.37 — every (dept, role) pair MUST have a
> role-scoped dashboard. This is the dashboard for **team-member** in **digital-marketing**.

## Persona

The **team-member** at Digital Marketing. They use this dashboard
...
returned by backend `GET /api/v1/holy/dashboards/digital-marketing/team-member/charts/<chart_id>`.
...
```
GET /api/v1/holy/dashboards/digital-marketing/team-member
  → {tiles: [...], charts: [...], filters: {...}, refreshed_at}

GET /api/v1/holy/dashboards/digital-marketing/team-member/charts/<chart_id>
...
- Frontend route: `/holy/digital-marketing/dashboard?role=team-member`
