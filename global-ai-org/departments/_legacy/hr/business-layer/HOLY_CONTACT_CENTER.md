# HOLY Beverage — Hr — Contact Center Automation
...
**Manager** + **CX role** (dept = hr). For non-CX depts this covers
...
|---|---|---|---|---|
| 1 | _stub: replace with real intent for hr_ | _ | yes/no | DistilBERT |
| … | (20 total minimum) | | | |
...
- LLM model: `gemma3:4b` (default for hr) — adjust per latency/cost SLO
- RAG corpus: `data/hr/kb/` + `data/hr/sops/`
