# HOLY Beverage — Digital Marketing — Simulation Tab
...
under `REFERENCE_PROCESSES[("digital-marketing", "<process>")]`.
...
| Endpoint | Purpose |
|---|---|
| POST /api/v1/holy/sim/digital-marketing/{process}/run | Trigger simulation |
| GET /api/v1/holy/sim/digital-marketing/{process}/runs | List past runs |
| GET /api/v1/holy/sim/digital-marketing/{process}/runs/{sim_id}/manifest | Per-run summary |
| GET /api/v1/holy/sim/digital-marketing/{process}/runs/{sim_id}/events | Event stream |

## TODO

- [ ] Define ≥ 1 process for digital-marketing in `REFERENCE_PROCESSES` dict
