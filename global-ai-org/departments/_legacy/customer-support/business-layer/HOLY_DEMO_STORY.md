# HOLY Beverage — Customer Support — Demo User Story
...
**Carla, Director of Customer Support**
...
The persona needs to: **cut median resolution time from 24h to 6h, raise CSAT to 4.7, deflect 40% via self-service**

Main KPI being moved: **Median time-to-resolution, CSAT, self-service deflection rate**

## 3. Walkthrough (what they see + do)

1. Persona lands on `/holy/customer-support` (the HOLY navigation page for this dept).
...
> "Today Carla spends 80% of their week on manual data
...
> counterfactual. We don't replace Carla — we replace
...
|---|---|---|---|
| 1 | Open `/holy/customer-support` | Left sidebar with N processes | "Every process this dept owns, surfaced as navigable artifacts" |
...
**Cross-reference**: This story powers the demo at `/holy/customer-support` in the
HOLY frontend. The literal click-by-click in §5 is also the drill
`tests/drills/drill_dept_demo_customer_support.py` (planned).
