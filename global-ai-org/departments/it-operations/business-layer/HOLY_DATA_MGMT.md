# HOLY Beverage — It Operations — Input Data Mgmt + Before/After Viz
...
For every process AND sub-process in this dept (it-operations), populate the 6
surfaces below. CMDB + logs + metrics is the primary data class for it-operations.
...
Plots land in: `data/eval/it-operations/<pipeline>/<run_id>/plots/before_*.png`
...
Plots land in: `data/eval/it-operations/<pipeline>/<run_id>/plots/after_*.png`
