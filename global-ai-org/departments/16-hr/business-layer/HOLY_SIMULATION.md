# HOLY_SIMULATION.md · Dept 16 · Human Resources
...
## Backend API
- `POST /api/v1/holy/sim/hr/{process}/run`
- `GET /api/v1/holy/sim/hr/{process}/runs/{sim_id}/events` (SSE)
- `GET /api/v1/holy/sim/hr/{process}/runs/{sim_id}/manifest`
- `GET /api/v1/holy/sim/hr/{process}/runs/{sim_id}/replay`
