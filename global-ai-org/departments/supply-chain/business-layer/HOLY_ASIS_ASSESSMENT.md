# HOLY Beverage — Supply Chain — AS-IS Process Assessment
...
This document is the **input to the AI strategy planning** for Supply Chain.
...
|---|---|---|---|---|---|---|---|---|
| 1 | Manual demand forecast (Excel) | 16 hrs/wk | High | $300K/yr | Planner overload | Slow refresh | −30% accuracy | Excel + macros |
| 2 | Reactive replenishment | 8 hrs/wk | High | $500K/yr | Buyer firefighting | Stockout-driven | Reactive | Email-driven |
| 3 | Manual route planning | 12 hrs/wk | Med | $200K/yr | Logistics overload | Single route | −20% utilization | Static tools |
| 4 | Vendor scorecard review (quarterly) | 6 hrs/wk | Med | $50K/qtr | Lagging indicators | Stale data | Reactive supplier mgmt | Excel template |
| 5 | Manual IoT sensor monitoring | 24 hrs/wk | High | $100K/yr | Ops on-call burnout | Threshold-only | Missed anomalies | Vendor dashboard |
...
4. **Measure** via the persona's main KPI: Stock-out rate, inventory turns, on-time-in-full (OTIF)
