# §140 · procurement × dl-pytorch · Use Case Spec

## Purpose
Cross-cutting fit · DL technique applied to procurement domain.
...
## Example use case
Procurement use case applying dl-pytorch to tabular/imgs.
