# Fraud / Special Investigations Unit (SIU) — ai-strategy Dashboard

Per global §64.37 — role-scoped dashboard.

## Persona
**ai-strategy** in Fraud / Special Investigations Unit (SIU).
...
## API
```
GET /api/v1/insur/dashboards/fraud-siu/ai-strategy
```
