# HOLY Beverage — Marketing — Demo User Story
...
The persona needs to: **lift attributable revenue 30%, cut waste-spend 40%, raise brand NPS by 10 pts**

Main KPI being moved: **Attributable revenue, waste-spend %, brand NPS, MQL→SQL conversion**

## 3. Walkthrough (what they see + do)

1. Persona lands on `/holy/marketing` (the HOLY navigation page for this dept).
...
> "Today Jenna spends 80% of their week on manual data
...
> counterfactual. We don't replace Jenna — we replace
...
|---|---|---|---|
| 1 | Open `/holy/marketing` | Left sidebar with N processes | "Every process this dept owns, surfaced as navigable artifacts" |
...
**Cross-reference**: This story powers the demo at `/holy/marketing` in the
HOLY frontend. The literal click-by-click in §5 is also the drill
`tests/drills/drill_dept_demo_marketing.py` (planned).
