# HOLY Beverage — E Commerce Network Flow
...
```
E Commerce API ──HTTP──► Auth Service           (RBAC + ABAC checks)
...
```
E Commerce API ──HTTPS──► Vendor APIs            (Salesforce / SAP / etc.)
...
─────────────                  ───────────────          ──────────
Frontend UI       ──►          e-commerce_user_events       analytics-svc
Backend API       ──►          e-commerce_audit              audit-store
ML Worker         ──►          e-commerce_predictions        prediction-store
Drift detector    ──►          e-commerce_alerts             on-call PagerDuty
...
|---|---|---|---|
| e-commerce-api | postgresql | 5432 | TCP |
| e-commerce-api | redis | 6379 | TCP |
| e-commerce-api | ollama | 11434 | TCP |
| e-commerce-api | otel-collector | 4317 | gRPC |
| e-commerce-api | (other dept APIs) | 8000 | HTTP via service mesh |
