# §140 · operations × cv-classification · Use Case Spec

## Purpose
Cross-cutting fit · CV technique applied to operations domain.
...
## Example use case
Operations use case applying cv-classification to images.
