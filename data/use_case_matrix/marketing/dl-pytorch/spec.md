# §140 · marketing × dl-pytorch · Use Case Spec

## Purpose
Cross-cutting fit · DL technique applied to marketing domain.
...
## Example use case
Marketing use case applying dl-pytorch to tabular/imgs.
