# HOLY Beverage — Digital Marketing — Security Dashboard

> Per global CLAUDE.md §64.37 — every (dept, role) pair MUST have a
> role-scoped dashboard. This is the dashboard for **security** in **digital-marketing**.

## Persona

The **security** at Digital Marketing. They use this dashboard
...
returned by backend `GET /api/v1/holy/dashboards/digital-marketing/security/charts/<chart_id>`.
...
```
GET /api/v1/holy/dashboards/digital-marketing/security
  → {tiles: [...], charts: [...], filters: {...}, refreshed_at}

GET /api/v1/holy/dashboards/digital-marketing/security/charts/<chart_id>
...
- Frontend route: `/holy/digital-marketing/dashboard?role=security`
