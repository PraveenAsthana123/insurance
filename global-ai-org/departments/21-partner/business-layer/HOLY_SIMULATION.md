# HOLY_SIMULATION.md · Dept 21 · Sales / Broker / Agency Partner
...
## Backend API
- `POST /api/v1/holy/sim/partner/{process}/run`
- `GET /api/v1/holy/sim/partner/{process}/runs/{sim_id}/events` (SSE)
- `GET /api/v1/holy/sim/partner/{process}/runs/{sim_id}/manifest`
- `GET /api/v1/holy/sim/partner/{process}/runs/{sim_id}/replay`
