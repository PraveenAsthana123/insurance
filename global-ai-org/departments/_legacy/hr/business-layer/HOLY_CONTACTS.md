# HOLY Beverage — Hr — Contact Management (customer + vendor + internal)
...
- Sync: scheduled inbound from hr's CRM / ERP / HRIS
...
|---|---|---|
| GET /api/v1/holy/contacts/hr/customers | list | manager / data-owner |
| GET /api/v1/holy/contacts/hr/vendors | list | manager / procurement |
| GET /api/v1/holy/contacts/hr/internal | list | any dept role |
| POST /api/v1/holy/contacts/hr/customers | create | admin / manager |
| PUT /api/v1/holy/contacts/hr/customers/{id} | update | admin / data-owner |
| DELETE /api/v1/holy/contacts/hr/customers/{id} | soft-delete | admin |
