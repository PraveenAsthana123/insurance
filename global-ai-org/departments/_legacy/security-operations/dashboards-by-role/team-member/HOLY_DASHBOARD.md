# HOLY Beverage — Security Operations — Team Member Dashboard

> Per global CLAUDE.md §64.37 — every (dept, role) pair MUST have a
> role-scoped dashboard. This is the dashboard for **team-member** in **security-operations**.

## Persona

The **team-member** at Security Operations. They use this dashboard
...
returned by backend `GET /api/v1/holy/dashboards/security-operations/team-member/charts/<chart_id>`.
...
```
GET /api/v1/holy/dashboards/security-operations/team-member
  → {tiles: [...], charts: [...], filters: {...}, refreshed_at}

GET /api/v1/holy/dashboards/security-operations/team-member/charts/<chart_id>
...
- Frontend route: `/holy/security-operations/dashboard?role=team-member`
