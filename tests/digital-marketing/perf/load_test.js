// Tier 9-10 — Performance + load test for digital-marketing.
//
// Recommended: k6 (per global §64.42).
//
// Run with:  k6 run tests/digital-marketing/perf/load_test.js
//
...
export default function () {
  ...
  check(res, {
    ...
    'has digital-marketing': (r) => r.body.includes('digital-marketing'),
  });
  sleep(1);
}
