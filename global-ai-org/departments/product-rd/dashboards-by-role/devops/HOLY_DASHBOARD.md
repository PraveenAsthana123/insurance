# HOLY Beverage — Product Rd — Devops Dashboard

> Per global CLAUDE.md §64.37 — every (dept, role) pair MUST have a
> role-scoped dashboard. This is the dashboard for **devops** in **product-rd**.

## Persona

The **devops** at Product Rd. They use this dashboard
...
returned by backend `GET /api/v1/holy/dashboards/product-rd/devops/charts/<chart_id>`.
...
```
GET /api/v1/holy/dashboards/product-rd/devops
  → {tiles: [...], charts: [...], filters: {...}, refreshed_at}

GET /api/v1/holy/dashboards/product-rd/devops/charts/<chart_id>
...
- Frontend route: `/holy/product-rd/dashboard?role=devops`
