# §140 · fraud-investigation × small-data-fewshot · Use Case Spec

## Purpose
Cross-cutting fit · ML technique applied to fraud-investigation domain.
...
## Example use case
Fraud Investigation use case applying small-data-fewshot to few labels.
