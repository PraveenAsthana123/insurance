# HOLY Beverage — Operations — Anomaly Detection
...
## Anomaly catalog (top 20 per operations)

| # | Anomaly type | Severity | Tier | Auto-action | Backing data |
|---|---|---|---|---|---|
| 1 | _stub: anomaly for operations_ | high | tier 2 | alert + auto-investigate | process telemetry + ERP |
