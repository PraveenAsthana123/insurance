# HOLY Beverage — It Operations — Ai Strategy Dashboard

> Per global CLAUDE.md §64.37 — every (dept, role) pair MUST have a
> role-scoped dashboard. This is the dashboard for **ai-strategy** in **it-operations**.

## Persona

The **ai-strategy** at It Operations. They use this dashboard
...
returned by backend `GET /api/v1/holy/dashboards/it-operations/ai-strategy/charts/<chart_id>`.
...
```
GET /api/v1/holy/dashboards/it-operations/ai-strategy
  → {tiles: [...], charts: [...], filters: {...}, refreshed_at}

GET /api/v1/holy/dashboards/it-operations/ai-strategy/charts/<chart_id>
...
- Frontend route: `/holy/it-operations/dashboard?role=ai-strategy`
