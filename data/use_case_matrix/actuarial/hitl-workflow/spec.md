# §140 · actuarial × hitl-workflow · Use Case Spec

## Purpose
Cross-cutting fit · Ops technique applied to actuarial domain.
...
## Example use case
Actuarial use case applying hitl-workflow to review queue.
