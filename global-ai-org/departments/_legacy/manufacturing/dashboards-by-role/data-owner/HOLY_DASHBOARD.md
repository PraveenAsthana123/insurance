# HOLY Beverage — Manufacturing — Data Owner Dashboard

> Per global CLAUDE.md §64.37 — every (dept, role) pair MUST have a
> role-scoped dashboard. This is the dashboard for **data-owner** in **manufacturing**.

## Persona

The **data-owner** at Manufacturing. They use this dashboard
...
returned by backend `GET /api/v1/holy/dashboards/manufacturing/data-owner/charts/<chart_id>`.
...
```
GET /api/v1/holy/dashboards/manufacturing/data-owner
  → {tiles: [...], charts: [...], filters: {...}, refreshed_at}

GET /api/v1/holy/dashboards/manufacturing/data-owner/charts/<chart_id>
...
- Frontend route: `/holy/manufacturing/dashboard?role=data-owner`
