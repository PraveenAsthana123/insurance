# HOLY_SIMULATION.md · Dept 5 · Policy Administration
...
## Backend API
- `POST /api/v1/holy/sim/policy-admin/{process}/run`
- `GET /api/v1/holy/sim/policy-admin/{process}/runs/{sim_id}/events` (SSE)
- `GET /api/v1/holy/sim/policy-admin/{process}/runs/{sim_id}/manifest`
- `GET /api/v1/holy/sim/policy-admin/{process}/runs/{sim_id}/replay`
