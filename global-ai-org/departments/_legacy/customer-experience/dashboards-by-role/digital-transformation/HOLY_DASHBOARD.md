# HOLY Beverage — Customer Experience — Digital Transformation Dashboard

> Per global CLAUDE.md §64.37 — every (dept, role) pair MUST have a
> role-scoped dashboard. This is the dashboard for **digital-transformation** in **customer-experience**.

## Persona

The **digital-transformation** at Customer Experience. They use this dashboard
...
returned by backend `GET /api/v1/holy/dashboards/customer-experience/digital-transformation/charts/<chart_id>`.
...
```
GET /api/v1/holy/dashboards/customer-experience/digital-transformation
  → {tiles: [...], charts: [...], filters: {...}, refreshed_at}

GET /api/v1/holy/dashboards/customer-experience/digital-transformation/charts/<chart_id>
...
- Frontend route: `/holy/customer-experience/dashboard?role=digital-transformation`
