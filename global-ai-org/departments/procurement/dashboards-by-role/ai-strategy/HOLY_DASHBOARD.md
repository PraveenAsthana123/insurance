# HOLY Beverage — Procurement — Ai Strategy Dashboard

> Per global CLAUDE.md §64.37 — every (dept, role) pair MUST have a
> role-scoped dashboard. This is the dashboard for **ai-strategy** in **procurement**.

## Persona

The **ai-strategy** at Procurement. They use this dashboard
...
returned by backend `GET /api/v1/holy/dashboards/procurement/ai-strategy/charts/<chart_id>`.
...
```
GET /api/v1/holy/dashboards/procurement/ai-strategy
  → {tiles: [...], charts: [...], filters: {...}, refreshed_at}

GET /api/v1/holy/dashboards/procurement/ai-strategy/charts/<chart_id>
...
- Frontend route: `/holy/procurement/dashboard?role=ai-strategy`
