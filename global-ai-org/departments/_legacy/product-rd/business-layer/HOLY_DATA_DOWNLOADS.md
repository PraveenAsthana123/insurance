# HOLY Beverage — Product Rd — Data Downloads
...
|---|---|---|---|---|---|
| 1 | `product_rd_primary_sample` | Product Rd primary use-case sample | tabular | 5 | 5 |
...
### 3.x `product_rd_primary_sample`

- **Title:** Product Rd primary use-case sample
- **Lifecycle:** tabular
...
| Endpoint | Returns |
|---|---|
| `GET /api/v1/holy/downloads/product-rd` | Catalog (datasets + URLs) |
| `GET /api/v1/holy/downloads/product-rd/<dataset_id>.csv` | CSV file |
| `GET /api/v1/holy/downloads/product-rd/<dataset_id>.json` | JSON file |
| `GET /api/v1/holy/downloads/product-rd/<dataset_id>.before.svg` | Pre-process viz |
| `GET /api/v1/holy/downloads/product-rd/<dataset_id>.after.svg` | Post-process viz |
