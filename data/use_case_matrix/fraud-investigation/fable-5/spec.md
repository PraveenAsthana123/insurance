# §140 · fraud-investigation × fable-5 · Use Case Spec

## Purpose
Cross-cutting fit · Sim technique applied to fraud-investigation domain.
...
## Example use case
Fraud Investigation use case applying fable-5 to n/a.
