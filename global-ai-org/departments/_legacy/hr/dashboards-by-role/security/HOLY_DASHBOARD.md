# HOLY Beverage — Hr — Security Dashboard

> Per global CLAUDE.md §64.37 — every (dept, role) pair MUST have a
> role-scoped dashboard. This is the dashboard for **security** in **hr**.

## Persona

The **security** at Hr. They use this dashboard
...
returned by backend `GET /api/v1/holy/dashboards/hr/security/charts/<chart_id>`.
...
```
GET /api/v1/holy/dashboards/hr/security
  → {tiles: [...], charts: [...], filters: {...}, refreshed_at}

GET /api/v1/holy/dashboards/hr/security/charts/<chart_id>
...
- Frontend route: `/holy/hr/dashboard?role=security`
