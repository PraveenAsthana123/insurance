# HOLY Beverage — Manufacturing — AI Use-Case Catalog
...
> use cases for **manufacturing**. Implementation status tracked per current
> codebase state.
...
## 2. Manufacturing-Specific Use Cases

| Use Case | Category | Data Types | AI Area | Business Value | Status |
|---|---|---|---|---|---|
| Predictive Maintenance | Manufacturing | sensor IoT | Time-Series AI | Less downtime | 🟡 timeseries + anomaly applies; vibration-specific deferred |
| Quality Inspection AI (Vision) | Manufacturing | images/video | Computer Vision | Higher quality | ✅ cv_lifecycle.py (MNIST proves CNN works on factory images) |
| Smart Factory AI | Manufacturing | IoT streams | Edge AI | Connected ops | ❌ deferred (needs PLC/MQTT) |
| Digital Twin AI | Manufacturing | telemetry | Simulation | Better planning | 🟡 simulation_engine.py is the partial twin |
