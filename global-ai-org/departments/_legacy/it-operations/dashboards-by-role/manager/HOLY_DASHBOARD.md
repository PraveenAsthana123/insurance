# HOLY Beverage — It Operations — Manager Dashboard

> Per global CLAUDE.md §64.37 — every (dept, role) pair MUST have a
> role-scoped dashboard. This is the dashboard for **manager** in **it-operations**.

## Persona

The **manager** at It Operations. They use this dashboard
...
returned by backend `GET /api/v1/holy/dashboards/it-operations/manager/charts/<chart_id>`.
...
```
GET /api/v1/holy/dashboards/it-operations/manager
  → {tiles: [...], charts: [...], filters: {...}, refreshed_at}

GET /api/v1/holy/dashboards/it-operations/manager/charts/<chart_id>
...
- Frontend route: `/holy/it-operations/dashboard?role=manager`
