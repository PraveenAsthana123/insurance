...
> Department 10 · Actuarial · slug `data-collection` · AI items: 4
...
- **One-liner**: TODO
- **Demo URL**: `http://192.168.1.88:3210/insurance/10/<domain>/data-collection?tab=user-demo`
- **Recording**: TODO
...
Simulation URL: `http://192.168.1.88:3210/insurance/10/<domain>/data-collection?tab=simulation`
...
Release summary: auto-gen `docs/processes/actuarial/data-collection/release-summary-vX.Y.md` covering §1 problem · §4 impact deltas · §10 phase scorecard · §11 test pass/fail · top 3 failure modes · sign-off · git SHA + image digest.
...
Gold set: `data/eval/actuarial/data-collection/gold_set.jsonl` (100-500 queries · stratified · monthly refresh).
...
→ Tab: `?tab=resai` · evidence files: `data/eval/actuarial/data-collection/resai/`
...
→ Tab: `?tab=expai` · artifacts: `data/eval/actuarial/data-collection/expai/`
...
→ Tab: `?tab=analysis` · evidence: `data/eval/actuarial/data-collection/stats/`
