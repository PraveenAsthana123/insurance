# HOLY Beverage — Customer Experience — Information Security Dashboard

> Per global CLAUDE.md §64.37 — every (dept, role) pair MUST have a
> role-scoped dashboard. This is the dashboard for **information-security** in **customer-experience**.

## Persona

The **information-security** at Customer Experience. They use this dashboard
...
returned by backend `GET /api/v1/holy/dashboards/customer-experience/information-security/charts/<chart_id>`.
...
```
GET /api/v1/holy/dashboards/customer-experience/information-security
  → {tiles: [...], charts: [...], filters: {...}, refreshed_at}

GET /api/v1/holy/dashboards/customer-experience/information-security/charts/<chart_id>
...
- Frontend route: `/holy/customer-experience/dashboard?role=information-security`
