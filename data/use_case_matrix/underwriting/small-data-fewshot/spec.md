# §140 · underwriting × small-data-fewshot · Use Case Spec

## Purpose
PRIMARY fit · ML technique applied to underwriting domain.
...
## Example use case
Few-shot risk profile clustering on emerging segment.
