"""Tier 11-12 — Security tests for security-operations.
...
def test_security_operations_owasp_zap_scan():
    """REPLACE — invoke OWASP ZAP CLI against security-operations surface (auth env only)."""
    pass


@pytest.mark.skip(reason="placeholder — requires Garak install + AI endpoint")
def test_security_operations_garak_prompt_injection():
