# HOLY Beverage — Engineering — Admin Dashboard

> Per global CLAUDE.md §64.37 — every (dept, role) pair MUST have a
> role-scoped dashboard. This is the dashboard for **admin** in **engineering**.

## Persona

The **admin** at Engineering. They use this dashboard
...
returned by backend `GET /api/v1/holy/dashboards/engineering/admin/charts/<chart_id>`.
...
```
GET /api/v1/holy/dashboards/engineering/admin
  → {tiles: [...], charts: [...], filters: {...}, refreshed_at}

GET /api/v1/holy/dashboards/engineering/admin/charts/<chart_id>
...
- Frontend route: `/holy/engineering/dashboard?role=admin`
