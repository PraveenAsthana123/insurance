# HOLY Beverage — Retail Operations — Input Data Mgmt + Before/After Viz
...
For every process AND sub-process in this dept (retail-operations), populate the 6
surfaces below. POS + CCTV + planogram is the primary data class for retail-operations.
...
Plots land in: `data/eval/retail-operations/<pipeline>/<run_id>/plots/before_*.png`
...
Plots land in: `data/eval/retail-operations/<pipeline>/<run_id>/plots/after_*.png`
