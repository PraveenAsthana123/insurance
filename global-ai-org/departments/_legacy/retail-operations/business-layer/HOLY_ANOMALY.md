# HOLY Beverage — Retail Operations — Anomaly Detection
...
## Anomaly catalog (top 20 per retail-operations)

| # | Anomaly type | Severity | Tier | Auto-action | Backing data |
|---|---|---|---|---|---|
| 1 | _stub: anomaly for retail-operations_ | high | tier 2 | alert + auto-investigate | POS + CCTV + planogram |
