"""Tier 2 — Integration tests for sales.
...
def test_sales_db_roundtrip():
    """REPLACE — verify sales table CRUD round-trips against real Postgres."""
    pass


@pytest.mark.skip(reason="placeholder — requires Redis + queue fixtures")
def test_sales_queue_dispatch():
    """REPLACE — verify sales task enqueue + consume via Redis."""
    pass
