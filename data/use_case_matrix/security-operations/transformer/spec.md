# §140 · security-operations × transformer · Use Case Spec

## Purpose
Cross-cutting fit · NLP technique applied to security-operations domain.
...
## Example use case
Security Operations use case applying transformer to text.
