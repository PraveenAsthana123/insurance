# HOLY Beverage — Product Rd — Information Security Dashboard

> Per global CLAUDE.md §64.37 — every (dept, role) pair MUST have a
> role-scoped dashboard. This is the dashboard for **information-security** in **product-rd**.

## Persona

The **information-security** at Product Rd. They use this dashboard
...
returned by backend `GET /api/v1/holy/dashboards/product-rd/information-security/charts/<chart_id>`.
...
```
GET /api/v1/holy/dashboards/product-rd/information-security
  → {tiles: [...], charts: [...], filters: {...}, refreshed_at}

GET /api/v1/holy/dashboards/product-rd/information-security/charts/<chart_id>
...
- Frontend route: `/holy/product-rd/dashboard?role=information-security`
