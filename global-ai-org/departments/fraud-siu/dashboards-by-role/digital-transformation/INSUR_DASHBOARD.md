# Fraud / Special Investigations Unit (SIU) — digital-transformation Dashboard

Per global §64.37 — role-scoped dashboard.

## Persona
**digital-transformation** in Fraud / Special Investigations Unit (SIU).
...
## API
```
GET /api/v1/insur/dashboards/fraud-siu/digital-transformation
```
