# HOLY_SIMULATION.md · Dept 22 · Product Innovation & Digital
...
## Backend API
- `POST /api/v1/holy/sim/product-innovation/{process}/run`
- `GET /api/v1/holy/sim/product-innovation/{process}/runs/{sim_id}/events` (SSE)
- `GET /api/v1/holy/sim/product-innovation/{process}/runs/{sim_id}/manifest`
- `GET /api/v1/holy/sim/product-innovation/{process}/runs/{sim_id}/replay`
