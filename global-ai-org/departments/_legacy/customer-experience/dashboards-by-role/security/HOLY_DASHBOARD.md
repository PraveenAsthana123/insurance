# HOLY Beverage — Customer Experience — Security Dashboard

> Per global CLAUDE.md §64.37 — every (dept, role) pair MUST have a
> role-scoped dashboard. This is the dashboard for **security** in **customer-experience**.

## Persona

The **security** at Customer Experience. They use this dashboard
...
returned by backend `GET /api/v1/holy/dashboards/customer-experience/security/charts/<chart_id>`.
...
```
GET /api/v1/holy/dashboards/customer-experience/security
  → {tiles: [...], charts: [...], filters: {...}, refreshed_at}

GET /api/v1/holy/dashboards/customer-experience/security/charts/<chart_id>
...
- Frontend route: `/holy/customer-experience/dashboard?role=security`
