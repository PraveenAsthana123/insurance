# Customer Service / Contact Center — api-architect Dashboard

Per global §64.37 — role-scoped dashboard.

## Persona
**api-architect** in Customer Service / Contact Center.
...
## API
```
GET /api/v1/insur/dashboards/customer-service/api-architect
```
