# Translation AI · Comprehensive README · §137

**Effective**: 2026-06-11 · **Slug**: `translation-ai` · **Kind**: `nlp_baseline`
...
**Business goal**: Reduce manual effort + improve accuracy for translation ai tasks in
...
**FR-1**: System MUST accept input matching `translation-ai` schema
...
Caller (frontend/agent)
        │
        ▼
  /api/v1/ai-types/translation-ai/predict
        │
        ▼
...
- `predictions_translation-ai`: id · input_jsonb · output · confidence · timestamp

**Endpoints**:
- `POST /api/v1/ai-types/translation-ai/predict` · body: features → prediction
- `GET /api/v1/ai-types/translation-ai/metrics` → live metrics.json
- `GET /api/v1/ai-types/translation-ai/explain/{prediction_id}` → SHAP
...
```
[router.py] → [model_loader.py] → [/models/translation-ai/model.joblib]
            ↘ [preprocessor.py]
...
- collection: `translation-ai_embeddings`
...
**Fairness metrics** (from data/fairness/translation-ai.json):
