# HOLY Beverage — Operations — AS-IS Process Assessment
...
This document is the **input to the AI strategy planning** for Operations.
...
|---|---|---|---|---|---|---|---|---|
| 1 | Manual process discovery | 80 hrs/wk | Med | $500K/yr | BPM team overload | Interview-based | Stale | Visio |
| 2 | Manual bottleneck analysis | 40 hrs/wk | High | $300K/yr | Lean team burnout | Quarterly | Reactive | Excel |
| 3 | Manual capacity scheduling | 24 hrs/wk | Med | $200K/yr | Planner overhead | Weekly | Sub-optimal | Excel grids |
| 4 | Reactive quality investigation | 16 hrs/wk | High | $800K/yr | QA reactive | Sampling | Missed defects | SPC charts |
| 5 | Manual KPI rollup | 32 hrs/wk | Med | $300K/yr | Analyst overload | Weekly | Lagging | PowerBI |
...
4. **Measure** via the persona's main KPI: Process cycle time, defect rate, operational cost-per-unit
