# HOLY Beverage — Finance — Anomaly Detection
...
## Anomaly catalog (top 20 per finance)

| # | Anomaly type | Severity | Tier | Auto-action | Backing data |
|---|---|---|---|---|---|
| 1 | _stub: anomaly for finance_ | high | tier 2 | alert + auto-investigate | GL + AR + AP + cash |
