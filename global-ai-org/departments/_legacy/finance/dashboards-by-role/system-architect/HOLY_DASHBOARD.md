# HOLY Beverage — Finance — System Architect Dashboard

> Per global CLAUDE.md §64.37 — every (dept, role) pair MUST have a
> role-scoped dashboard. This is the dashboard for **system-architect** in **finance**.

## Persona

The **system-architect** at Finance. They use this dashboard
...
returned by backend `GET /api/v1/holy/dashboards/finance/system-architect/charts/<chart_id>`.
...
```
GET /api/v1/holy/dashboards/finance/system-architect
  → {tiles: [...], charts: [...], filters: {...}, refreshed_at}

GET /api/v1/holy/dashboards/finance/system-architect/charts/<chart_id>
...
- Frontend route: `/holy/finance/dashboard?role=system-architect`
