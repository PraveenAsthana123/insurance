# System Design — Customer Service / Contact Center

Per operator 2026-06-01: "technical architect, flow internal flow, system design".

Consolidated technical architecture for the Customer Service / Contact Center dept. Pairs with
...
| Domain agents | 14 | Python + Ollama / LLM-router |
...
- L2 processes: 8
- L3 sub-processes: 34
- Total addressable for automation: 34
...
| Mean time to recover P1 (MTTR) | 30 min |
...
- ADR — Ollama vs OpenAI for Customer Service / Contact Center (cost + latency + data residency)
- ADR — Chunking strategy for Customer Service / Contact Center RAG corpus (fixed / sentence / semantic-paragraph)
- ADR — Tenant isolation: row-level vs column-level
- ADR — Decision audit retention (7y regulated vs 1y default)
- ADR — Idempotency key TTL (Customer Service / Contact Center retry storm pattern)
