# HOLY Beverage — Executive Leadership — Security Dashboard

> Per global CLAUDE.md §64.37 — every (dept, role) pair MUST have a
> role-scoped dashboard. This is the dashboard for **security** in **executive-leadership**.

## Persona

The **security** at Executive Leadership. They use this dashboard
...
returned by backend `GET /api/v1/holy/dashboards/executive-leadership/security/charts/<chart_id>`.
...
```
GET /api/v1/holy/dashboards/executive-leadership/security
  → {tiles: [...], charts: [...], filters: {...}, refreshed_at}

GET /api/v1/holy/dashboards/executive-leadership/security/charts/<chart_id>
...
- Frontend route: `/holy/executive-leadership/dashboard?role=security`
