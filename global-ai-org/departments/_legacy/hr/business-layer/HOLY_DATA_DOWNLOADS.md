# HOLY Beverage — Hr — Data Downloads
...
|---|---|---|---|---|---|
| 1 | `hr_primary_sample` | Hr primary use-case sample | tabular | 5 | 5 |
...
### 3.x `hr_primary_sample`

- **Title:** Hr primary use-case sample
- **Lifecycle:** tabular
...
| Endpoint | Returns |
|---|---|
| `GET /api/v1/holy/downloads/hr` | Catalog (datasets + URLs) |
| `GET /api/v1/holy/downloads/hr/<dataset_id>.csv` | CSV file |
| `GET /api/v1/holy/downloads/hr/<dataset_id>.json` | JSON file |
| `GET /api/v1/holy/downloads/hr/<dataset_id>.before.svg` | Pre-process viz |
| `GET /api/v1/holy/downloads/hr/<dataset_id>.after.svg` | Post-process viz |
