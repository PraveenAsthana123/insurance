# HOLY Beverage — Supply Chain — Input Data Mgmt + Before/After Viz
...
For every process AND sub-process in this dept (supply-chain), populate the 6
surfaces below. orders + IoT telemetry is the primary data class for supply-chain.
...
Plots land in: `data/eval/supply-chain/<pipeline>/<run_id>/plots/before_*.png`
...
Plots land in: `data/eval/supply-chain/<pipeline>/<run_id>/plots/after_*.png`
