# HOLY Beverage — Hr — Team Member Dashboard

> Per global CLAUDE.md §64.37 — every (dept, role) pair MUST have a
> role-scoped dashboard. This is the dashboard for **team-member** in **hr**.

## Persona

The **team-member** at Hr. They use this dashboard
...
returned by backend `GET /api/v1/holy/dashboards/hr/team-member/charts/<chart_id>`.
...
```
GET /api/v1/holy/dashboards/hr/team-member
  → {tiles: [...], charts: [...], filters: {...}, refreshed_at}

GET /api/v1/holy/dashboards/hr/team-member/charts/<chart_id>
...
- Frontend route: `/holy/hr/dashboard?role=team-member`
