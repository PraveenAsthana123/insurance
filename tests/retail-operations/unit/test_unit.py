"""Tier 1 — Unit tests for retail-operations.
...
def test_dept_module_imports():
    ...
    assert "retail-operations" in "retail-operations", "dept name must match"
...
@pytest.mark.skip(reason="placeholder — replace with real retail-operations unit test")
def test_real_dept_logic():
    """REPLACE — real unit test for retail-operations business logic."""
    pass
