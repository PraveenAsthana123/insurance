# HOLY Beverage — It Operations — Digital Transformation Dashboard

> Per global CLAUDE.md §64.37 — every (dept, role) pair MUST have a
> role-scoped dashboard. This is the dashboard for **digital-transformation** in **it-operations**.

## Persona

The **digital-transformation** at It Operations. They use this dashboard
...
returned by backend `GET /api/v1/holy/dashboards/it-operations/digital-transformation/charts/<chart_id>`.
...
```
GET /api/v1/holy/dashboards/it-operations/digital-transformation
  → {tiles: [...], charts: [...], filters: {...}, refreshed_at}

GET /api/v1/holy/dashboards/it-operations/digital-transformation/charts/<chart_id>
...
- Frontend route: `/holy/it-operations/dashboard?role=digital-transformation`
