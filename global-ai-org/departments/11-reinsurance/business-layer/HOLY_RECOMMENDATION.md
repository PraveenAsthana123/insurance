# HOLY_RECOMMENDATION.md · Dept 11 · reinsurance
...
Recommendation system for Dept 11 (reinsurance). All 3 classical flavors covered per §64.22.

## Item-based (collaborative filter)

**Algorithm**: NSGA-II multi-objective recommendation
...
**Algorithm**: Treaty-term text embedding (E5)
...
**Algorithm**: NSGA-II + content score · risk-adjusted Pareto
