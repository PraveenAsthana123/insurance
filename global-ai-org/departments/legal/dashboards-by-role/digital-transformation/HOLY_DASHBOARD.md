# HOLY Beverage — Legal — Digital Transformation Dashboard

> Per global CLAUDE.md §64.37 — every (dept, role) pair MUST have a
> role-scoped dashboard. This is the dashboard for **digital-transformation** in **legal**.

## Persona

The **digital-transformation** at Legal. They use this dashboard
...
returned by backend `GET /api/v1/holy/dashboards/legal/digital-transformation/charts/<chart_id>`.
...
```
GET /api/v1/holy/dashboards/legal/digital-transformation
  → {tiles: [...], charts: [...], filters: {...}, refreshed_at}

GET /api/v1/holy/dashboards/legal/digital-transformation/charts/<chart_id>
...
- Frontend route: `/holy/legal/dashboard?role=digital-transformation`
