# HOLY_RECOMMENDATION.md · Dept 17 · procurement
...
Recommendation system for Dept 17 (procurement). All 3 classical flavors covered per §64.22.

## Item-based (collaborative filter)

**Algorithm**: Multi-armed bandit (Thompson sampling per vendor)
...
**Algorithm**: Vendor catalog embedding (CLIP for equipment)
...
**Algorithm**: MAB + content + SLA · cost-quality Pareto
