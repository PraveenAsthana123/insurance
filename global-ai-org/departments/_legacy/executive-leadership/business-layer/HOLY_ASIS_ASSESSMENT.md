# HOLY Beverage — Executive Leadership — AS-IS Process Assessment
...
This document is the **input to the AI strategy planning** for Executive Leadership.
...
|---|---|---|---|---|---|---|---|---|
| 1 | Manual KPI dashboard prep | 40 hrs/wk | Med | $500K/yr | Analyst overload | Weekly | Lagging | Excel + PPT |
| 2 | Manual board pre-read | 60 hrs/wk | Med | $300K/qtr | Exec time-drain | Backward-looking | Slow alignment | PPT |
| 3 | Reactive scenario planning | 80 hrs/wk | High | $800K/yr | Strategy team burnout | Sparse | Reactive | Excel models |
| 4 | Manual competitive intelligence | 20 hrs/wk | Med | $200K/yr | Strategy overload | Stale | Missed moves | News + manual |
| 5 | Manual risk register review | 16 hrs/wk | Med | $150K/qtr | Risk team overhead | Quarterly | Stale | Excel registry |
...
4. **Measure** via the persona's main KPI: Decision cycle time, decision quality (post-hoc), board-meeting prep hours
