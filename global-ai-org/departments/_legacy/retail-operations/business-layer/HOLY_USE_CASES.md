# HOLY Beverage — Retail Operations — AI Use-Case Catalog
...
> use cases for **retail-operations**. Implementation status tracked per current
> codebase state.
...
## 2. Retail Operations-Specific Use Cases

| Use Case | Category | Data Types | AI Area | Business Value | Status |
|---|---|---|---|---|---|
| Dynamic Pricing AI | Retail | POS/inventory | Optimization | Higher margin | ❌ deferred |
| Recommendation Engine | Retail | purchase history | Recommendation | Higher AOV | ✅ recommendation_lifecycle.py |
| Store Traffic Prediction | Retail | IoT/video | Forecasting | Better staffing | 🟡 timeseries_lifecycle.py applies |
| AI Checkout Monitoring | Retail | video | Vision AI | Less shrink | 🟡 cv_lifecycle.py applies |
