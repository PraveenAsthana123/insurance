"""
INSUR Beverage — task seeder for the 100-agent demo.

Pushes N tasks into Redis 'tasks' queue. Each task is a department-themed
prompt drawn from INSUR's 12-department scope.
...
DEPT_PROMPTS: list[tuple[str, str]] = [
    ("digital-marketing", "In ONE sentence, suggest a viral hashtag for a new INSUR insurerage launch."),
    ("digital-marketing", "Name ONE customer segment INSUR should target for a sugar-free energy drink."),
    ...
    ("supply-chain", "Name ONE risk that could disrupt INSUR's bottle supply this quarter."),
    ...
    ("sales", "Write a ONE-sentence pitch to a regional grocery distributor for INSUR insurerages."),
    ("sales", "Name ONE cross-sell opportunity when a retailer buys INSUR sparkling water."),
