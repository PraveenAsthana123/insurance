# HOLY_RECOMMENDATION.md · Dept 18 · analytics
...
Recommendation system for Dept 18 (analytics). All 3 classical flavors covered per §64.22.

## Item-based (collaborative filter)

**Algorithm**: Item-item collaborative (dashboard × user)
...
**Algorithm**: Saved-view embedding (query + visualization spec)
...
**Algorithm**: Hybrid · CF + content + cohort recency
