# §140 · finance × cv-classification · Use Case Spec

## Purpose
Cross-cutting fit · CV technique applied to finance domain.
...
## Example use case
Finance use case applying cv-classification to images.
