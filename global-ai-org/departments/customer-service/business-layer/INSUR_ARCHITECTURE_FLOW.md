# Architecture Flow — Customer Service / Contact Center
...
flowchart TB
    ...
    subgraph "Domain Agents — Customer Service / Contact Center"
        A0[Insurance Chatbot Agent]
        A1[Voice Virtual Agent]
        A2[Authentication Agent]
        A3[Intent Classification Agent]
        A4[Sentiment Analysis Agent]
        A5[Knowledge Search Agent]
        A6[FAQ Generator Agent]
        A7[Article Generator Agent]
    end
    ...
    Orchestration --> "Domain Agents — Customer Service / Contact Center"
    "Domain Agents — Customer Service / Contact Center" --> Models
    "Domain Agents — Customer Service / Contact Center" --> Memory
    "Domain Agents — Customer Service / Contact Center" --> Insurance Core
    "Domain Agents — Customer Service / Contact Center" --> Observability
```
...
| Domain | 14 agents | Customer Service / Contact Center business logic | Domain |
