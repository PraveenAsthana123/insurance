# HOLY Beverage — Security Operations — Data Type: WORD
...
Policy / SOP / contract docs → RAG / clause analysis
...
Recommended role: `legal / hr / compliance`
(see `../../roles/legal/HOLY_README.md`)

## Reference pipeline

`backend/ml/reference/rag_lifecycle.py (after .docx parse)`

Common libraries: python-docx, unstructured, mammoth
...
- parsed sections (H1/H2 tree) + chunk count + first-N chunks preview
