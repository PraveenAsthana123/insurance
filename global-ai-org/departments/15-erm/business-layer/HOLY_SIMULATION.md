# HOLY_SIMULATION.md · Dept 15 · Enterprise Risk Management
...
## Backend API
- `POST /api/v1/holy/sim/erm/{process}/run`
- `GET /api/v1/holy/sim/erm/{process}/runs/{sim_id}/events` (SSE)
- `GET /api/v1/holy/sim/erm/{process}/runs/{sim_id}/manifest`
- `GET /api/v1/holy/sim/erm/{process}/runs/{sim_id}/replay`
