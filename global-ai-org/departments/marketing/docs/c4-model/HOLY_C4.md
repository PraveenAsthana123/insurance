# HOLY Beverage — Marketing C4 Model
...
graph LR
    ...
    features --> model[NLP, GenAI, Recommendation AI, Attribution ML, Brand-safety AI]
...
- Decision lineage: every API call writes a row to `marketing_audit` (see LLD §2)

## L6 — Observability

- Logs: structured JSON with `correlation_id`, `tenant_id`, `user_id`, `model_version`, `prompt_version`
- Metrics: `marketing_request_count`, `marketing_latency_p95`, `marketing_model_confidence`, `marketing_hallucination_rate`
