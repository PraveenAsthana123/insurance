# HOLY Beverage — Operations — Incident Management (L1/L2/L3 + RAG)
...
|---|---|---|---|---|
| 1 | _stub: replace with real L1 issue for operations_ | runbook URL | < 1 min | < 5 min |
...
- RAG corpus: `data/operations/runbooks/` + `data/operations/past-incidents/`
