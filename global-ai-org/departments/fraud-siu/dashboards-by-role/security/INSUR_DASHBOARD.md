# Fraud / Special Investigations Unit (SIU) — security Dashboard

Per global §64.37 — role-scoped dashboard.

## Persona
**security** in Fraud / Special Investigations Unit (SIU).
...
## API
```
GET /api/v1/insur/dashboards/fraud-siu/security
```
