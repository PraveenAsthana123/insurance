# Oil & Gas AI · Comprehensive README · §137

**Effective**: 2026-06-11 · **Slug**: `oil-and-gas-ai` · **Kind**: `vertical_spec`
...
**Business goal**: Reduce manual effort + improve accuracy for oil & gas ai tasks in
...
**FR-1**: System MUST accept input matching `oil-and-gas-ai` schema
...
Caller (frontend/agent)
        │
        ▼
  /api/v1/ai-types/oil-and-gas-ai/predict
        │
        ▼
...
- `predictions_oil-and-gas-ai`: id · input_jsonb · output · confidence · timestamp

**Endpoints**:
- `POST /api/v1/ai-types/oil-and-gas-ai/predict` · body: features → prediction
- `GET /api/v1/ai-types/oil-and-gas-ai/metrics` → live metrics.json
- `GET /api/v1/ai-types/oil-and-gas-ai/explain/{prediction_id}` → SHAP
...
```
[router.py] → [model_loader.py] → [/models/oil-and-gas-ai/model.joblib]
            ↘ [preprocessor.py]
...
- collection: `oil-and-gas-ai_embeddings`
...
**Fairness metrics** (from data/fairness/oil-and-gas-ai.json):
