# §140 · engineering × time-series · Use Case Spec

## Purpose
Cross-cutting fit · TS technique applied to engineering domain.
...
## Example use case
Engineering use case applying time-series to temporal.
