# HOLY Beverage — Digital Marketing — System Architect Dashboard

> Per global CLAUDE.md §64.37 — every (dept, role) pair MUST have a
> role-scoped dashboard. This is the dashboard for **system-architect** in **digital-marketing**.

## Persona

The **system-architect** at Digital Marketing. They use this dashboard
...
returned by backend `GET /api/v1/holy/dashboards/digital-marketing/system-architect/charts/<chart_id>`.
...
```
GET /api/v1/holy/dashboards/digital-marketing/system-architect
  → {tiles: [...], charts: [...], filters: {...}, refreshed_at}

GET /api/v1/holy/dashboards/digital-marketing/system-architect/charts/<chart_id>
...
- Frontend route: `/holy/digital-marketing/dashboard?role=system-architect`
