# Fraud / Special Investigations Unit (SIU) — api-architect Reports

Per global §64.37 — role-scoped reports (≥ 3 standard per role).

## Standard reports

### R1 — Fraud / Special Investigations Unit (SIU) api-architect digest
...
## API
```
GET  /api/v1/insur/reports/fraud-siu/api-architect
POST /api/v1/insur/reports/fraud-siu/api-architect/{report_id}/run
```
