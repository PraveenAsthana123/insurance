# HOLY Beverage — Engineering — Api Architect Dashboard

> Per global CLAUDE.md §64.37 — every (dept, role) pair MUST have a
> role-scoped dashboard. This is the dashboard for **api-architect** in **engineering**.

## Persona

The **api-architect** at Engineering. They use this dashboard
...
returned by backend `GET /api/v1/holy/dashboards/engineering/api-architect/charts/<chart_id>`.
...
```
GET /api/v1/holy/dashboards/engineering/api-architect
  → {tiles: [...], charts: [...], filters: {...}, refreshed_at}

GET /api/v1/holy/dashboards/engineering/api-architect/charts/<chart_id>
...
- Frontend route: `/holy/engineering/dashboard?role=api-architect`
