# Fraud / Special Investigations Unit (SIU) — devops Dashboard

Per global §64.37 — role-scoped dashboard.

## Persona
**devops** in Fraud / Special Investigations Unit (SIU).

## Focus
Deploy frequency, change-fail rate, MTTR, infra cost
...
## API
```
GET /api/v1/insur/dashboards/fraud-siu/devops
```
