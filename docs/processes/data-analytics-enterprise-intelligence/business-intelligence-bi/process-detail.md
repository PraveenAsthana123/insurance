...
> Department 18 · Data, Analytics & Enterprise Intelligence · slug `business-intelligence-bi` · AI items: 4
...
| Item | What | Where |
|---|---|---|
| Test data | TODO scrubbed sample | `data/demo/business-intelligence-bi/` |
...
- **One-liner**: TODO
- **Demo URL**: `http://192.168.1.88:3210/insurance/18/<domain>/business-intelligence-bi?tab=user-demo`
- **Recording**: TODO
...
Simulation URL: `http://192.168.1.88:3210/insurance/18/<domain>/business-intelligence-bi?tab=simulation`
...
| 2 | Feature schema | data spec | `backend/ml/insurance/schemas/business-intelligence-bi.yaml` | view-only |
...
Release summary: auto-gen `docs/processes/data-analytics-enterprise-intelligence/business-intelligence-bi/release-summary-vX.Y.md` covering §1 problem · §4 impact deltas · §10 phase scorecard · §11 test pass/fail · top 3 failure modes · sign-off · git SHA + image digest.

## 12. Cron jobs + DB writes

| Cron tag | Schedule | Purpose | DB updated |
|---|---|---|---|
| `INSUR-BUSINESS_INTELLIGENCE_BI-DAILY-REFRESH` | daily 02:00 | refresh model on new data | MLflow + audit |
| `INSUR-BUSINESS_INTELLIGENCE_BI-DRIFT-CHECK` | hourly | data + concept drift | drift_metrics |
| `INSUR-BUSINESS_INTELLIGENCE_BI-HITL-AUDIT` | daily 09:00 | sample HITL overrides for retrain | hitl_audit |
| `INSUR-BUSINESS_INTELLIGENCE_BI-RAG-REINDEX` | weekly Mon 03:00 | re-embed source docs | vector_db |
| `INSUR-BUSINESS_INTELLIGENCE_BI-COST-REPORT` | weekly Mon 08:00 | dollar impact reconciliation | cost_report |
| `INSUR-BUSINESS_INTELLIGENCE_BI-EVAL-DEEPEVAL` | weekly Mon 04:00 | Ragas + DeepEval regression | eval_metrics |
| `INSUR-BUSINESS_INTELLIGENCE_BI-VECTOR-INGEST` | */15 * * * * | move new data into vector DB | vector_db |
...
Gold set: `data/eval/data-analytics-enterprise-intelligence/business-intelligence-bi/gold_set.jsonl` (100-500 queries · stratified · monthly refresh).
...
Every data artifact embedded automatically · per `INSUR-BUSINESS_INTELLIGENCE_BI-VECTOR-INGEST` cron above.
...
→ Tab: `?tab=resai` · evidence files: `data/eval/data-analytics-enterprise-intelligence/business-intelligence-bi/resai/`
...
→ Tab: `?tab=expai` · artifacts: `data/eval/data-analytics-enterprise-intelligence/business-intelligence-bi/expai/`
...
→ Tab: `?tab=analysis` · evidence: `data/eval/data-analytics-enterprise-intelligence/business-intelligence-bi/stats/`
