# HOLY Beverage — Security Operations — Ai Strategy Dashboard

> Per global CLAUDE.md §64.37 — every (dept, role) pair MUST have a
> role-scoped dashboard. This is the dashboard for **ai-strategy** in **security-operations**.

## Persona

The **ai-strategy** at Security Operations. They use this dashboard
...
returned by backend `GET /api/v1/holy/dashboards/security-operations/ai-strategy/charts/<chart_id>`.
...
```
GET /api/v1/holy/dashboards/security-operations/ai-strategy
  → {tiles: [...], charts: [...], filters: {...}, refreshed_at}

GET /api/v1/holy/dashboards/security-operations/ai-strategy/charts/<chart_id>
...
- Frontend route: `/holy/security-operations/dashboard?role=ai-strategy`
