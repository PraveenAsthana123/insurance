# HOLY Beverage — Engineering — AI Use-Case Catalog
...
> use cases for **engineering**. Implementation status tracked per current
> codebase state.
...
|---|---|---|
| ✅ Implemented | **14** of 31 | Working module exists in `backend/ml/reference/*.py` (drill-locked) |
| 🟡 Partial | **11** of 31 | Existing module applies; dept-specific stub deferred |
...
## 2. Engineering-Specific Use Cases

| Use Case | Category | Data Types | AI Area | Business Value | Status |
|---|---|---|---|---|---|
| AI Code Assistant | Engineering | source code | Code LLM | Productivity | ❌ external (Copilot/Claude) |
| AI Observability | Engineering | logs/metrics/traces | Observability AI | Faster debug | 🟡 OpenTelemetry stub; full obs layer deferred |
| AI Capacity Planning | Engineering | infra metrics | Forecasting | Better scaling | 🟡 timeseries_lifecycle.py applies |
| Build Failure Prediction | Engineering | CI/CD logs | Predictive ML | Less broken builds | 🟡 full_lifecycle.py applies |
