# Legal AI · Comprehensive README · §137

**Effective**: 2026-06-11 · **Slug**: `legal-ai` · **Kind**: `vertical_spec`
...
**Business goal**: Reduce manual effort + improve accuracy for legal ai tasks in
...
**FR-1**: System MUST accept input matching `legal-ai` schema
...
Caller (frontend/agent)
        │
        ▼
  /api/v1/ai-types/legal-ai/predict
        │
        ▼
...
- `predictions_legal-ai`: id · input_jsonb · output · confidence · timestamp

**Endpoints**:
- `POST /api/v1/ai-types/legal-ai/predict` · body: features → prediction
- `GET /api/v1/ai-types/legal-ai/metrics` → live metrics.json
- `GET /api/v1/ai-types/legal-ai/explain/{prediction_id}` → SHAP
...
```
[router.py] → [model_loader.py] → [/models/legal-ai/model.joblib]
            ↘ [preprocessor.py]
...
- collection: `legal-ai_embeddings`
...
**Fairness metrics** (from data/fairness/legal-ai.json):
